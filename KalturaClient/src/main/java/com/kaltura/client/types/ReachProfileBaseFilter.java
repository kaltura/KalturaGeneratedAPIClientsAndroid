...
public abstract class ReachProfileBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.profileTypeEqual == null ? -1 : this.profileTypeEqual.ordinal());
        dest.writeString(this.profileTypeIn);
    }

    public ReachProfileBaseFilter(Parcel in) {
        super(in);
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : ReachProfileStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpProfileTypeEqual = in.readInt();
        this.profileTypeEqual = tmpProfileTypeEqual == -1 ? null : ReachProfileType.values()[tmpProfileTypeEqual];
        this.profileTypeIn = in.readString();
    }
}
