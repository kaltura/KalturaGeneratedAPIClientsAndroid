...
public class PlayableEntryMatchAttributeCondition extends SearchMatchAttributeCondition {
    ...
    public static final Creator<PlayableEntryMatchAttributeCondition> CREATOR = new Creator<PlayableEntryMatchAttributeCondition>() {
        @Override
        public PlayableEntryMatchAttributeCondition createFromParcel(Parcel source) {
            return new PlayableEntryMatchAttributeCondition(source);
        }

        @Override
        public PlayableEntryMatchAttributeCondition[] newArray(int size) {
            return new PlayableEntryMatchAttributeCondition[size];
        }
    };
    ...
    public PlayableEntryMatchAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : PlayableEntryMatchAttribute.values()[tmpAttribute];
    }
}
