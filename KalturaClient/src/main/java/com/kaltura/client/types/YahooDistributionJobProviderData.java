...
public class YahooDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<YahooDistributionJobProviderData> CREATOR = new Creator<YahooDistributionJobProviderData>() {
        @Override
        public YahooDistributionJobProviderData createFromParcel(Parcel source) {
            return new YahooDistributionJobProviderData(source);
        }

        @Override
        public YahooDistributionJobProviderData[] newArray(int size) {
            return new YahooDistributionJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.smallThumbPath);
        dest.writeString(this.largeThumbPath);
        dest.writeString(this.videoAssetFilePath);
    }

    public YahooDistributionJobProviderData(Parcel in) {
        super(in);
        this.smallThumbPath = in.readString();
        this.largeThumbPath = in.readString();
