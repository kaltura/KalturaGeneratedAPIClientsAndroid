...
public class CompareMetadataCondition extends CompareCondition {
    ...
    public static final Creator<CompareMetadataCondition> CREATOR = new Creator<CompareMetadataCondition>() {
        @Override
        public CompareMetadataCondition createFromParcel(Parcel source) {
            return new CompareMetadataCondition(source);
        }

        @Override
        public CompareMetadataCondition[] newArray(int size) {
            return new CompareMetadataCondition[size];
        }
    };
    ...
    public CompareMetadataCondition(Parcel in) {
        super(in);
