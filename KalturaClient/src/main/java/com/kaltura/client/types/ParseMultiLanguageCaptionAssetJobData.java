...
public class ParseMultiLanguageCaptionAssetJobData extends JobData {
    ...
    public static final Creator<ParseMultiLanguageCaptionAssetJobData> CREATOR = new Creator<ParseMultiLanguageCaptionAssetJobData>() {
        @Override
        public ParseMultiLanguageCaptionAssetJobData createFromParcel(Parcel source) {
            return new ParseMultiLanguageCaptionAssetJobData(source);
        }

        @Override
        public ParseMultiLanguageCaptionAssetJobData[] newArray(int size) {
            return new ParseMultiLanguageCaptionAssetJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.multiLanaguageCaptionAssetId);
        dest.writeString(this.entryId);
        dest.writeString(this.fileLocation);
        dest.writeString(this.fileEncryptionKey);
    }

    public ParseMultiLanguageCaptionAssetJobData(Parcel in) {
        super(in);
        this.multiLanaguageCaptionAssetId = in.readString();
