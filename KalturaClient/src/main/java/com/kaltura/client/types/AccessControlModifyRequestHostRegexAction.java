...
public class AccessControlModifyRequestHostRegexAction extends RuleAction {
    ...
    public static final Creator<AccessControlModifyRequestHostRegexAction> CREATOR = new Creator<AccessControlModifyRequestHostRegexAction>() {
        @Override
        public AccessControlModifyRequestHostRegexAction createFromParcel(Parcel source) {
            return new AccessControlModifyRequestHostRegexAction(source);
        }

        @Override
        public AccessControlModifyRequestHostRegexAction[] newArray(int size) {
            return new AccessControlModifyRequestHostRegexAction[size];
        }
    };
