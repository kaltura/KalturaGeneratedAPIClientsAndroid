...
public class MicrosoftTeamsDropFolder extends RemoteDropFolder {
    ...
    public static final Creator<MicrosoftTeamsDropFolder> CREATOR = new Creator<MicrosoftTeamsDropFolder>() {
        @Override
        public MicrosoftTeamsDropFolder createFromParcel(Parcel source) {
            return new MicrosoftTeamsDropFolder(source);
        }

        @Override
        public MicrosoftTeamsDropFolder[] newArray(int size) {
            return new MicrosoftTeamsDropFolder[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.integrationId);
        dest.writeString(this.tenantId);
        dest.writeString(this.clientSecret);
        dest.writeString(this.clientId);
    }

    public MicrosoftTeamsDropFolder(Parcel in) {
        super(in);
        this.integrationId = (Integer)in.readValue(Integer.class.getClassLoader());
