...
public class SpeechToVideoVendorTaskData extends VendorTaskData {
    ...
    public static final Creator<SpeechToVideoVendorTaskData> CREATOR = new Creator<SpeechToVideoVendorTaskData>() {
        @Override
        public SpeechToVideoVendorTaskData createFromParcel(Parcel source) {
            return new SpeechToVideoVendorTaskData(source);
        }

        @Override
        public SpeechToVideoVendorTaskData[] newArray(int size) {
            return new SpeechToVideoVendorTaskData[size];
        }
    };
    ...
    public SpeechToVideoVendorTaskData(Parcel in) {
        super(in);
