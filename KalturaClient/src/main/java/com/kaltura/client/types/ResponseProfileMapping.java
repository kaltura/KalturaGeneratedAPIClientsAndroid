...
public class ResponseProfileMapping extends ObjectBase {
    ...
    public static final Creator<ResponseProfileMapping> CREATOR = new Creator<ResponseProfileMapping>() {
        @Override
        public ResponseProfileMapping createFromParcel(Parcel source) {
            return new ResponseProfileMapping(source);
        }

        @Override
        public ResponseProfileMapping[] newArray(int size) {
            return new ResponseProfileMapping[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.parentProperty);
        dest.writeString(this.filterProperty);
        dest.writeValue(this.allowNull);
    }

    public ResponseProfileMapping(Parcel in) {
        super(in);
        this.parentProperty = in.readString();
        this.filterProperty = in.readString();
