...
public class MetadataField extends StringField {
    ...
    public static final Creator<MetadataField> CREATOR = new Creator<MetadataField>() {
        @Override
        public MetadataField createFromParcel(Parcel source) {
            return new MetadataField(source);
        }

        @Override
        public MetadataField[] newArray(int size) {
            return new MetadataField[size];
        }
    };
    ...
    public MetadataField(Parcel in) {
        super(in);
