...
public class VerizonVcastDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<VerizonVcastDistributionProfile> CREATOR = new Creator<VerizonVcastDistributionProfile>() {
        @Override
        public VerizonVcastDistributionProfile createFromParcel(Parcel source) {
            return new VerizonVcastDistributionProfile(source);
        }

        @Override
        public VerizonVcastDistributionProfile[] newArray(int size) {
            return new VerizonVcastDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.ftpHost);
        dest.writeString(this.ftpLogin);
        ...
        dest.writeString(this.allowStreaming);
        dest.writeString(this.streamingPriceCode);
        dest.writeString(this.allowDownload);
        dest.writeString(this.downloadPriceCode);
    }

    public VerizonVcastDistributionProfile(Parcel in) {
        super(in);
        this.ftpHost = in.readString();
        this.ftpLogin = in.readString();
        ...
        this.allowStreaming = in.readString();
        this.streamingPriceCode = in.readString();
        this.allowDownload = in.readString();
        this.downloadPriceCode = in.readString();
    }
}
