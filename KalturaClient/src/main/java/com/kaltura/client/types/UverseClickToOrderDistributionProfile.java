...
public class UverseClickToOrderDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<UverseClickToOrderDistributionProfile> CREATOR = new Creator<UverseClickToOrderDistributionProfile>() {
        @Override
        public UverseClickToOrderDistributionProfile createFromParcel(Parcel source) {
            return new UverseClickToOrderDistributionProfile(source);
        }

        @Override
        public UverseClickToOrderDistributionProfile[] newArray(int size) {
            return new UverseClickToOrderDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.backgroundImageWide);
        dest.writeString(this.backgroundImageStandard);
    }

    public UverseClickToOrderDistributionProfile(Parcel in) {
        super(in);
        this.feedUrl = in.readString();
        this.backgroundImageWide = in.readString();
        this.backgroundImageStandard = in.readString();
    }
}
