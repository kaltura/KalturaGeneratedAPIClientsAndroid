...
public class SchedulerStatus extends ObjectBase {
    ...
    public static final Creator<SchedulerStatus> CREATOR = new Creator<SchedulerStatus>() {
        @Override
        public SchedulerStatus createFromParcel(Parcel source) {
            return new SchedulerStatus(source);
        }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.workerType == null ? -1 : this.workerType.ordinal());
    ...
    public SchedulerStatus(Parcel in) {
        super(in);
        ...
        int tmpWorkerType = in.readInt();
        this.workerType = tmpWorkerType == -1 ? null : BatchJobType.values()[tmpWorkerType];
        int tmpType = in.readInt();
        this.type = tmpType == -1 ? null : SchedulerStatusType.values()[tmpType];
