...
public class IdeticDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<IdeticDistributionProfile> CREATOR = new Creator<IdeticDistributionProfile>() {
        @Override
        public IdeticDistributionProfile createFromParcel(Parcel source) {
            return new IdeticDistributionProfile(source);
        }

        @Override
        public IdeticDistributionProfile[] newArray(int size) {
            return new IdeticDistributionProfile[size];
        }
    };
    ...
    public IdeticDistributionProfile(Parcel in) {
        super(in);
