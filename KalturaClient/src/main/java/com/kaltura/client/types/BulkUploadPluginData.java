...
public class BulkUploadPluginData extends ObjectBase {
    ...
    public static final Creator<BulkUploadPluginData> CREATOR = new Creator<BulkUploadPluginData>() {
        @Override
        public BulkUploadPluginData createFromParcel(Parcel source) {
            return new BulkUploadPluginData(source);
        }

        @Override
        public BulkUploadPluginData[] newArray(int size) {
            return new BulkUploadPluginData[size];
        }
    };
    ...
    public BulkUploadPluginData(Parcel in) {
        super(in);
