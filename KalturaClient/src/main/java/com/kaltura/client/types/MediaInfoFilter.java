...
public class MediaInfoFilter extends MediaInfoBaseFilter {
    ...
    public static final Creator<MediaInfoFilter> CREATOR = new Creator<MediaInfoFilter>() {
        @Override
        public MediaInfoFilter createFromParcel(Parcel source) {
            return new MediaInfoFilter(source);
        }

        @Override
        public MediaInfoFilter[] newArray(int size) {
            return new MediaInfoFilter[size];
        }
    };

    public MediaInfoFilter(Parcel in) {
        super(in);
    }
}
