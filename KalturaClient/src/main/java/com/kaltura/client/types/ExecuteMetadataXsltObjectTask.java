...
public class ExecuteMetadataXsltObjectTask extends ObjectTask {
    ...
    public static final Creator<ExecuteMetadataXsltObjectTask> CREATOR = new Creator<ExecuteMetadataXsltObjectTask>() {
        @Override
        public ExecuteMetadataXsltObjectTask createFromParcel(Parcel source) {
            return new ExecuteMetadataXsltObjectTask(source);
        }

        @Override
        public ExecuteMetadataXsltObjectTask[] newArray(int size) {
            return new ExecuteMetadataXsltObjectTask[size];
        }
    };
    ...
    public ExecuteMetadataXsltObjectTask(Parcel in) {
        super(in);
