...
public class ZoomDropFolderFile extends DropFolderFile {
    ...
    public static final Creator<ZoomDropFolderFile> CREATOR = new Creator<ZoomDropFolderFile>() {
        @Override
        public ZoomDropFolderFile createFromParcel(Parcel source) {
            return new ZoomDropFolderFile(source);
        }

        @Override
        public ZoomDropFolderFile[] newArray(int size) {
            return new ZoomDropFolderFile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.meetingMetadata, flags);
        dest.writeParcelable(this.recordingFile, flags);
        dest.writeString(this.parentEntryId);
        dest.writeValue(this.isParentEntry);
    }

    public ZoomDropFolderFile(Parcel in) {
        super(in);
        this.meetingMetadata = in.readParcelable(ZoomMeetingMetadata.class.getClassLoader());
        this.recordingFile = in.readParcelable(ZoomRecordingFile.class.getClassLoader());
        this.parentEntryId = in.readString();
        this.isParentEntry = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
