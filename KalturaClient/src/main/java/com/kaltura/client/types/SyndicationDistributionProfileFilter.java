...
public class SyndicationDistributionProfileFilter extends SyndicationDistributionProfileBaseFilter {
    ...
    public static final Creator<SyndicationDistributionProfileFilter> CREATOR = new Creator<SyndicationDistributionProfileFilter>() {
        @Override
        public SyndicationDistributionProfileFilter createFromParcel(Parcel source) {
            return new SyndicationDistributionProfileFilter(source);
        }

        @Override
        public SyndicationDistributionProfileFilter[] newArray(int size) {
            return new SyndicationDistributionProfileFilter[size];
        }
    };

    public SyndicationDistributionProfileFilter(Parcel in) {
        super(in);
    }
}
