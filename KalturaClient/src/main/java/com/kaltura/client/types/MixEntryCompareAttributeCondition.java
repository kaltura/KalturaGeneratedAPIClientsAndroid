...
public class MixEntryCompareAttributeCondition extends SearchComparableAttributeCondition {
    ...
    public static final Creator<MixEntryCompareAttributeCondition> CREATOR = new Creator<MixEntryCompareAttributeCondition>() {
        @Override
        public MixEntryCompareAttributeCondition createFromParcel(Parcel source) {
            return new MixEntryCompareAttributeCondition(source);
        }

        @Override
        public MixEntryCompareAttributeCondition[] newArray(int size) {
            return new MixEntryCompareAttributeCondition[size];
        }
    };
    ...
    public MixEntryCompareAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : MixEntryCompareAttribute.values()[tmpAttribute];
    }
}
