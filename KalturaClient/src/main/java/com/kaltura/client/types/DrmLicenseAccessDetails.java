...
public class DrmLicenseAccessDetails extends ObjectBase {
    ...
    public static final Creator<DrmLicenseAccessDetails> CREATOR = new Creator<DrmLicenseAccessDetails>() {
        @Override
        public DrmLicenseAccessDetails createFromParcel(Parcel source) {
            return new DrmLicenseAccessDetails(source);
        }

        @Override
        public DrmLicenseAccessDetails[] newArray(int size) {
            return new DrmLicenseAccessDetails[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.absolute_duration);
    ...
    public DrmLicenseAccessDetails(Parcel in) {
        super(in);
        this.policy = in.readString();
        this.duration = (Integer)in.readValue(Integer.class.getClassLoader());
        this.absolute_duration = (Integer)in.readValue(Integer.class.getClassLoader());
