...
public class AlignmentVendorTaskData extends VendorTaskDataCaptionAsset {
    ...
    public static final Creator<AlignmentVendorTaskData> CREATOR = new Creator<AlignmentVendorTaskData>() {
        @Override
        public AlignmentVendorTaskData createFromParcel(Parcel source) {
            return new AlignmentVendorTaskData(source);
        }

        @Override
        public AlignmentVendorTaskData[] newArray(int size) {
            return new AlignmentVendorTaskData[size];
        }
    };
