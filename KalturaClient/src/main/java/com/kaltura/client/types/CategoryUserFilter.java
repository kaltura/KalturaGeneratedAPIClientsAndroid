...
public class CategoryUserFilter extends CategoryUserBaseFilter {
    ...
    public static final Creator<CategoryUserFilter> CREATOR = new Creator<CategoryUserFilter>() {
        @Override
        public CategoryUserFilter createFromParcel(Parcel source) {
            return new CategoryUserFilter(source);
        }

        @Override
        public CategoryUserFilter[] newArray(int size) {
            return new CategoryUserFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.categoryDirectMembers);
        dest.writeString(this.freeText);
        dest.writeString(this.relatedGroupsByUserId);
    }

    public CategoryUserFilter(Parcel in) {
        super(in);
        this.categoryDirectMembers = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.freeText = in.readString();
        this.relatedGroupsByUserId = in.readString();
    }
}
