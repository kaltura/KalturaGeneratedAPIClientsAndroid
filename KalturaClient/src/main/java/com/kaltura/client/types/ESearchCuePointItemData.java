...
public class ESearchCuePointItemData extends ESearchItemData {
    ...
    public static final Creator<ESearchCuePointItemData> CREATOR = new Creator<ESearchCuePointItemData>() {
        @Override
        public ESearchCuePointItemData createFromParcel(Parcel source) {
            return new ESearchCuePointItemData(source);
        }

        @Override
        public ESearchCuePointItemData[] newArray(int size) {
            return new ESearchCuePointItemData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.cuePointType);
    ...
    public ESearchCuePointItemData(Parcel in) {
        super(in);
        this.cuePointType = in.readString();
        ...
        if( tagsSize > -1) {
            ...
            in.readList(this.tags, StringHolder.class.getClassLoader());
        }
        ...
        if( answersSize > -1) {
            ...
            in.readList(this.answers, StringHolder.class.getClassLoader());
        }
