...
public class DeliveryProfileGenericAppleHttp extends DeliveryProfile {
    ...
    public static final Creator<DeliveryProfileGenericAppleHttp> CREATOR = new Creator<DeliveryProfileGenericAppleHttp>() {
        @Override
        public DeliveryProfileGenericAppleHttp createFromParcel(Parcel source) {
            return new DeliveryProfileGenericAppleHttp(source);
        }

        @Override
        public DeliveryProfileGenericAppleHttp[] newArray(int size) {
            return new DeliveryProfileGenericAppleHttp[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.manifestRedirect);
    }
    ...
    public DeliveryProfileGenericAppleHttp(Parcel in) {
        ...
        this.manifestRedirect = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
