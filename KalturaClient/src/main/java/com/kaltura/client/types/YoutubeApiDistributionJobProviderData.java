...
public class YoutubeApiDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<YoutubeApiDistributionJobProviderData> CREATOR = new Creator<YoutubeApiDistributionJobProviderData>() {
        @Override
        public YoutubeApiDistributionJobProviderData createFromParcel(Parcel source) {
            return new YoutubeApiDistributionJobProviderData(source);
        }

        @Override
        public YoutubeApiDistributionJobProviderData[] newArray(int size) {
            return new YoutubeApiDistributionJobProviderData[size];
        }
    };
    ...
    public YoutubeApiDistributionJobProviderData(Parcel in) {
        super(in);
        ...
        if( captionsInfoSize > -1) {
            ...
            in.readList(this.captionsInfo, YouTubeApiCaptionDistributionInfo.class.getClassLoader());
        }
    }
}
