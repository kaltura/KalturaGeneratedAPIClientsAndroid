...
public class SshImportJobData extends ImportJobData {
    ...
    public static final Creator<SshImportJobData> CREATOR = new Creator<SshImportJobData>() {
        @Override
        public SshImportJobData createFromParcel(Parcel source) {
            return new SshImportJobData(source);
        }

        @Override
        public SshImportJobData[] newArray(int size) {
            return new SshImportJobData[size];
        }
    };
    ...
    public SshImportJobData(Parcel in) {
        super(in);
