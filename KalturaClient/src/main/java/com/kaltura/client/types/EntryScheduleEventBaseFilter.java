...
public abstract class EntryScheduleEventBaseFilter extends ScheduleEventFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.templateEntryIdEqual);
        dest.writeString(this.entryIdsLike);
        dest.writeString(this.entryIdsMultiLikeOr);
        dest.writeString(this.entryIdsMultiLikeAnd);
        dest.writeString(this.categoryIdsLike);
        dest.writeString(this.categoryIdsMultiLikeOr);
        dest.writeString(this.categoryIdsMultiLikeAnd);
    }

    public EntryScheduleEventBaseFilter(Parcel in) {
        super(in);
        this.templateEntryIdEqual = in.readString();
        this.entryIdsLike = in.readString();
        this.entryIdsMultiLikeOr = in.readString();
        this.entryIdsMultiLikeAnd = in.readString();
        this.categoryIdsLike = in.readString();
        this.categoryIdsMultiLikeOr = in.readString();
        this.categoryIdsMultiLikeAnd = in.readString();
    }
}
