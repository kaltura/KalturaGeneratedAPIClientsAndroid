...
public class ESearchEntryMetadataItem extends ESearchEntryAbstractNestedItem {
    ...
    public static final Creator<ESearchEntryMetadataItem> CREATOR = new Creator<ESearchEntryMetadataItem>() {
        @Override
        public ESearchEntryMetadataItem createFromParcel(Parcel source) {
            return new ESearchEntryMetadataItem(source);
        }

        @Override
        public ESearchEntryMetadataItem[] newArray(int size) {
            return new ESearchEntryMetadataItem[size];
        }
    };
    ...
    public ESearchEntryMetadataItem(Parcel in) {
        super(in);
