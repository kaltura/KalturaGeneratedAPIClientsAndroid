...
public class PodcastDistributionProfile extends DistributionProfile {
    ...
    public static final Creator<PodcastDistributionProfile> CREATOR = new Creator<PodcastDistributionProfile>() {
        @Override
        public PodcastDistributionProfile createFromParcel(Parcel source) {
            return new PodcastDistributionProfile(source);
        }

        @Override
        public PodcastDistributionProfile[] newArray(int size) {
            return new PodcastDistributionProfile[size];
        }
    };
    ...
    public PodcastDistributionProfile(Parcel in) {
        super(in);
