...
public class ExternalMediaEntryMatchAttributeCondition extends SearchMatchAttributeCondition {
    ...
    public static final Creator<ExternalMediaEntryMatchAttributeCondition> CREATOR = new Creator<ExternalMediaEntryMatchAttributeCondition>() {
        @Override
        public ExternalMediaEntryMatchAttributeCondition createFromParcel(Parcel source) {
            return new ExternalMediaEntryMatchAttributeCondition(source);
        }

        @Override
        public ExternalMediaEntryMatchAttributeCondition[] newArray(int size) {
            return new ExternalMediaEntryMatchAttributeCondition[size];
        }
    };
    ...
    public ExternalMediaEntryMatchAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : ExternalMediaEntryMatchAttribute.values()[tmpAttribute];
    }
}
