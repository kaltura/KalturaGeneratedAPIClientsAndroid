...
public abstract class AnnotationBaseFilter extends CuePointFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.parentIdEqual);
        dest.writeString(this.parentIdIn);
        dest.writeString(this.textLike);
        dest.writeString(this.textMultiLikeOr);
        dest.writeString(this.textMultiLikeAnd);
        ...
        dest.writeInt(this.isPublicEqual == null ? -1 : this.isPublicEqual.ordinal());
    }

    public AnnotationBaseFilter(Parcel in) {
        super(in);
        this.parentIdEqual = in.readString();
        this.parentIdIn = in.readString();
        this.textLike = in.readString();
        this.textMultiLikeOr = in.readString();
        this.textMultiLikeAnd = in.readString();
        ...
        int tmpIsPublicEqual = in.readInt();
        this.isPublicEqual = tmpIsPublicEqual == -1 ? null : Boolean.values()[tmpIsPublicEqual];
    }
}
