...
public class UrlTokenizerKs extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerKs> CREATOR = new Creator<UrlTokenizerKs>() {
        @Override
        public UrlTokenizerKs createFromParcel(Parcel source) {
            return new UrlTokenizerKs(source);
        }

        @Override
        public UrlTokenizerKs[] newArray(int size) {
            return new UrlTokenizerKs[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.usePath);
        dest.writeString(this.additionalUris);
    }

    public UrlTokenizerKs(Parcel in) {
        super(in);
        this.usePath = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.additionalUris = in.readString();
    }
}
