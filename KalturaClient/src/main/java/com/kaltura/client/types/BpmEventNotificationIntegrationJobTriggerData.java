...
public class BpmEventNotificationIntegrationJobTriggerData extends IntegrationJobTriggerData {
    ...
    public static final Creator<BpmEventNotificationIntegrationJobTriggerData> CREATOR = new Creator<BpmEventNotificationIntegrationJobTriggerData>() {
        @Override
        public BpmEventNotificationIntegrationJobTriggerData createFromParcel(Parcel source) {
            return new BpmEventNotificationIntegrationJobTriggerData(source);
        }

        @Override
        public BpmEventNotificationIntegrationJobTriggerData[] newArray(int size) {
            return new BpmEventNotificationIntegrationJobTriggerData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.businessProcessId);
        dest.writeString(this.caseId);
    }

    public BpmEventNotificationIntegrationJobTriggerData(Parcel in) {
        super(in);
        this.templateId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.businessProcessId = in.readString();
