...
public class TransformMetadataJobData extends JobData {
    ...
    public static final Creator<TransformMetadataJobData> CREATOR = new Creator<TransformMetadataJobData>() {
        @Override
        public TransformMetadataJobData createFromParcel(Parcel source) {
            return new TransformMetadataJobData(source);
        }

        @Override
        public TransformMetadataJobData[] newArray(int size) {
            return new TransformMetadataJobData[size];
        }
    };
