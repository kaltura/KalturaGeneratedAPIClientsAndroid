...
public abstract class DeliveryProfileBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.streamerTypeEqual == null ? -1 : this.streamerTypeEqual.ordinal());
        dest.writeInt(this.statusEqual == null ? -1 : this.statusEqual.ordinal());
        dest.writeString(this.statusIn);
    }

    public DeliveryProfileBaseFilter(Parcel in) {
        super(in);
        ...
        int tmpStreamerTypeEqual = in.readInt();
        this.streamerTypeEqual = tmpStreamerTypeEqual == -1 ? null : PlaybackProtocol.values()[tmpStreamerTypeEqual];
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : DeliveryStatus.values()[tmpStatusEqual];
