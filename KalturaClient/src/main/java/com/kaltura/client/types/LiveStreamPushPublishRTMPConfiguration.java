...
public class LiveStreamPushPublishRTMPConfiguration extends LiveStreamPushPublishConfiguration {
    ...
    public static final Creator<LiveStreamPushPublishRTMPConfiguration> CREATOR = new Creator<LiveStreamPushPublishRTMPConfiguration>() {
        @Override
        public LiveStreamPushPublishRTMPConfiguration createFromParcel(Parcel source) {
            return new LiveStreamPushPublishRTMPConfiguration(source);
        }

        @Override
        public LiveStreamPushPublishRTMPConfiguration[] newArray(int size) {
            return new LiveStreamPushPublishRTMPConfiguration[size];
        }
    };
    ...
    public LiveStreamPushPublishRTMPConfiguration(Parcel in) {
        super(in);
