...
public class CategoryFilter extends CategoryBaseFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.membersIn);
        dest.writeString(this.nameOrReferenceIdStartsWith);
        dest.writeString(this.managerEqual);
        dest.writeString(this.memberEqual);
        dest.writeString(this.fullNameStartsWithIn);
        dest.writeString(this.ancestorIdIn);
        dest.writeString(this.idOrInheritedParentIdIn);
    }

    public CategoryFilter(Parcel in) {
        super(in);
        this.freeText = in.readString();
        this.membersIn = in.readString();
        this.nameOrReferenceIdStartsWith = in.readString();
        this.managerEqual = in.readString();
        this.memberEqual = in.readString();
        this.fullNameStartsWithIn = in.readString();
        this.ancestorIdIn = in.readString();
        this.idOrInheritedParentIdIn = in.readString();
    }
}
