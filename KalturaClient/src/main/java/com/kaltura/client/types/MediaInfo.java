...
public class MediaInfo extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.containerProfile);
        dest.writeValue(this.containerDuration);
        dest.writeValue(this.containerBitRate);
        dest.writeString(this.videoFormat);
        dest.writeString(this.videoCodecId);
        dest.writeValue(this.videoDuration);
        dest.writeValue(this.videoBitRate);
        dest.writeInt(this.videoBitRateMode == null ? -1 : this.videoBitRateMode.ordinal());
        dest.writeValue(this.videoWidth);
        dest.writeValue(this.videoHeight);
        dest.writeValue(this.videoFrameRate);
        dest.writeValue(this.videoDar);
        dest.writeValue(this.videoRotation);
        dest.writeString(this.audioFormat);
        dest.writeString(this.audioCodecId);
        dest.writeValue(this.audioDuration);
        dest.writeValue(this.audioBitRate);
        dest.writeInt(this.audioBitRateMode == null ? -1 : this.audioBitRateMode.ordinal());
        dest.writeValue(this.audioChannels);
        dest.writeValue(this.audioSamplingRate);
        dest.writeValue(this.audioResolution);
        dest.writeString(this.writingLib);
        dest.writeString(this.rawData);
        dest.writeString(this.multiStreamInfo);
        dest.writeValue(this.scanType);
        dest.writeString(this.multiStream);
        dest.writeValue(this.isFastStart);
        dest.writeString(this.contentStreams);
        dest.writeValue(this.complexityValue);
        dest.writeValue(this.maxGOP);
        dest.writeString(this.matrixCoefficients);
        dest.writeString(this.colorTransfer);
        dest.writeString(this.colorPrimaries);
        dest.writeString(this.pixelFormat);
        dest.writeString(this.colorSpace);
        dest.writeString(this.chromaSubsampling);
        dest.writeValue(this.bitsDepth);
    }
    ...
    public MediaInfo(Parcel in) {
        ...
        this.containerFormat = in.readString();
        this.containerId = in.readString();
        this.containerProfile = in.readString();
        this.containerDuration = (Integer)in.readValue(Integer.class.getClassLoader());
        this.containerBitRate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.videoFormat = in.readString();
        this.videoCodecId = in.readString();
        this.videoDuration = (Integer)in.readValue(Integer.class.getClassLoader());
        this.videoBitRate = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpVideoBitRateMode = in.readInt();
        this.videoBitRateMode = tmpVideoBitRateMode == -1 ? null : BitRateMode.values()[tmpVideoBitRateMode];
        this.videoWidth = (Integer)in.readValue(Integer.class.getClassLoader());
        this.videoHeight = (Integer)in.readValue(Integer.class.getClassLoader());
        this.videoFrameRate = (Double)in.readValue(Double.class.getClassLoader());
        this.videoDar = (Double)in.readValue(Double.class.getClassLoader());
        this.videoRotation = (Integer)in.readValue(Integer.class.getClassLoader());
        this.audioFormat = in.readString();
        this.audioCodecId = in.readString();
        this.audioDuration = (Integer)in.readValue(Integer.class.getClassLoader());
        this.audioBitRate = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpAudioBitRateMode = in.readInt();
        this.audioBitRateMode = tmpAudioBitRateMode == -1 ? null : BitRateMode.values()[tmpAudioBitRateMode];
        this.audioChannels = (Integer)in.readValue(Integer.class.getClassLoader());
        this.audioSamplingRate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.audioResolution = (Integer)in.readValue(Integer.class.getClassLoader());
        this.writingLib = in.readString();
        this.rawData = in.readString();
        this.multiStreamInfo = in.readString();
        this.scanType = (Integer)in.readValue(Integer.class.getClassLoader());
        this.multiStream = in.readString();
        this.isFastStart = (Integer)in.readValue(Integer.class.getClassLoader());
        this.contentStreams = in.readString();
        this.complexityValue = (Integer)in.readValue(Integer.class.getClassLoader());
        this.maxGOP = (Double)in.readValue(Double.class.getClassLoader());
        this.matrixCoefficients = in.readString();
        this.colorTransfer = in.readString();
        this.colorPrimaries = in.readString();
        this.pixelFormat = in.readString();
        this.colorSpace = in.readString();
        this.chromaSubsampling = in.readString();
        this.bitsDepth = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
