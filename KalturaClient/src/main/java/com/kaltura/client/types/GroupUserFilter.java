...
public class GroupUserFilter extends GroupUserBaseFilter {
    ...
    public static final Creator<GroupUserFilter> CREATOR = new Creator<GroupUserFilter>() {
        @Override
        public GroupUserFilter createFromParcel(Parcel source) {
            return new GroupUserFilter(source);
        }

        @Override
        public GroupUserFilter[] newArray(int size) {
            return new GroupUserFilter[size];
        }
    };
