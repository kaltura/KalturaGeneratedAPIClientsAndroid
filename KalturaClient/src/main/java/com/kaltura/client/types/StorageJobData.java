...
public class StorageJobData extends JobData {
    ...
    public static final Creator<StorageJobData> CREATOR = new Creator<StorageJobData>() {
        @Override
        public StorageJobData createFromParcel(Parcel source) {
            return new StorageJobData(source);
        }

        @Override
        public StorageJobData[] newArray(int size) {
            return new StorageJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.serverUsername);
        dest.writeString(this.serverPassword);
        dest.writeString(this.serverPrivateKey);
        dest.writeString(this.serverPublicKey);
    ...
    public StorageJobData(Parcel in) {
        super(in);
        this.serverUrl = in.readString();
        this.serverUsername = in.readString();
        this.serverPassword = in.readString();
        this.serverPrivateKey = in.readString();
        this.serverPublicKey = in.readString();
