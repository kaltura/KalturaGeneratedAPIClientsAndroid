...
public class YouTubeApiCaptionDistributionInfo extends ObjectBase {
    ...
    public static final Creator<YouTubeApiCaptionDistributionInfo> CREATOR = new Creator<YouTubeApiCaptionDistributionInfo>() {
        @Override
        public YouTubeApiCaptionDistributionInfo createFromParcel(Parcel source) {
            return new YouTubeApiCaptionDistributionInfo(source);
        }

        @Override
        public YouTubeApiCaptionDistributionInfo[] newArray(int size) {
            return new YouTubeApiCaptionDistributionInfo[size];
        }
    };
    ...
    public YouTubeApiCaptionDistributionInfo(Parcel in) {
        super(in);
