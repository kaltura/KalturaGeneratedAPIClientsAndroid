...
public class LiveReportExportJobData extends JobData {
    ...
    public static final Creator<LiveReportExportJobData> CREATOR = new Creator<LiveReportExportJobData>() {
        @Override
        public LiveReportExportJobData createFromParcel(Parcel source) {
            return new LiveReportExportJobData(source);
        }

        @Override
        public LiveReportExportJobData[] newArray(int size) {
            return new LiveReportExportJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.timeReference);
    ...
    public LiveReportExportJobData(Parcel in) {
        super(in);
        this.timeReference = (Integer)in.readValue(Integer.class.getClassLoader());
