...
public class BulkUploadResultJob extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultJob> CREATOR = new Creator<BulkUploadResultJob>() {
        @Override
        public BulkUploadResultJob createFromParcel(Parcel source) {
            return new BulkUploadResultJob(source);
        }

        @Override
        public BulkUploadResultJob[] newArray(int size) {
            return new BulkUploadResultJob[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.jobObjectId);
    }

    public BulkUploadResultJob(Parcel in) {
        super(in);
        this.jobObjectId = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
