...
public class FreewheelDistributionProfile extends DistributionProfile {
    ...
    public static final Creator<FreewheelDistributionProfile> CREATOR = new Creator<FreewheelDistributionProfile>() {
        @Override
        public FreewheelDistributionProfile createFromParcel(Parcel source) {
            return new FreewheelDistributionProfile(source);
        }

        @Override
        public FreewheelDistributionProfile[] newArray(int size) {
            return new FreewheelDistributionProfile[size];
        }
    };
    ...
    public FreewheelDistributionProfile(Parcel in) {
        super(in);
