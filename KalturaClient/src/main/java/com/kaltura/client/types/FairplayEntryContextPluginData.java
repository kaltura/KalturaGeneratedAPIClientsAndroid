...
public class FairplayEntryContextPluginData extends PluginData {
    ...
    public static final Creator<FairplayEntryContextPluginData> CREATOR = new Creator<FairplayEntryContextPluginData>() {
        @Override
        public FairplayEntryContextPluginData createFromParcel(Parcel source) {
            return new FairplayEntryContextPluginData(source);
        }

        @Override
        public FairplayEntryContextPluginData[] newArray(int size) {
            return new FairplayEntryContextPluginData[size];
        }
    };
    ...
    public FairplayEntryContextPluginData(Parcel in) {
        super(in);
