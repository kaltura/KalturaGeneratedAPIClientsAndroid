...
public class EventNotificationDispatchJobData extends JobData {
    ...
    public static final Creator<EventNotificationDispatchJobData> CREATOR = new Creator<EventNotificationDispatchJobData>() {
        @Override
        public EventNotificationDispatchJobData createFromParcel(Parcel source) {
            return new EventNotificationDispatchJobData(source);
        }

        @Override
        public EventNotificationDispatchJobData[] newArray(int size) {
            return new EventNotificationDispatchJobData[size];
        }
    };
    ...
    public EventNotificationDispatchJobData(Parcel in) {
        super(in);
        ...
        if( contentParametersSize > -1) {
            ...
            in.readList(this.contentParameters, KeyValue.class.getClassLoader());
        }
    }
}
