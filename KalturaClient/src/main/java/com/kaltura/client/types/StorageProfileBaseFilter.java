...
public abstract class StorageProfileBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.protocolEqual == null ? -1 : this.protocolEqual.ordinal());
        dest.writeString(this.protocolIn);
    }

    public StorageProfileBaseFilter(Parcel in) {
        super(in);
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : StorageProfileStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpProtocolEqual = in.readInt();
        this.protocolEqual = tmpProtocolEqual == -1 ? null : StorageProfileProtocol.values()[tmpProtocolEqual];
        this.protocolIn = in.readString();
    }
}
