...
public class DeliveryProfileGenericRtmp extends DeliveryProfileRtmp {
    ...
    public static final Creator<DeliveryProfileGenericRtmp> CREATOR = new Creator<DeliveryProfileGenericRtmp>() {
        @Override
        public DeliveryProfileGenericRtmp createFromParcel(Parcel source) {
            return new DeliveryProfileGenericRtmp(source);
        }

        @Override
        public DeliveryProfileGenericRtmp[] newArray(int size) {
            return new DeliveryProfileGenericRtmp[size];
        }
    };
    ...
    public DeliveryProfileGenericRtmp(Parcel in) {
        super(in);
