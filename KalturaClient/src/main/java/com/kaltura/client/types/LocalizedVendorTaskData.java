...
public class LocalizedVendorTaskData extends VendorTaskData {
    ...
    public static final Creator<LocalizedVendorTaskData> CREATOR = new Creator<LocalizedVendorTaskData>() {
        @Override
        public LocalizedVendorTaskData createFromParcel(Parcel source) {
            return new LocalizedVendorTaskData(source);
        }

        @Override
        public LocalizedVendorTaskData[] newArray(int size) {
            return new LocalizedVendorTaskData[size];
        }
    };
