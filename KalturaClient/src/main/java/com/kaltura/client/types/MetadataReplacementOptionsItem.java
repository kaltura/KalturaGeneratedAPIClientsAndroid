...
public class MetadataReplacementOptionsItem extends PluginReplacementOptionsItem {
    ...
    public static final Creator<MetadataReplacementOptionsItem> CREATOR = new Creator<MetadataReplacementOptionsItem>() {
        @Override
        public MetadataReplacementOptionsItem createFromParcel(Parcel source) {
            return new MetadataReplacementOptionsItem(source);
        }

        @Override
        public MetadataReplacementOptionsItem[] newArray(int size) {
            return new MetadataReplacementOptionsItem[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.shouldCopyMetadata);
    }

    public MetadataReplacementOptionsItem(Parcel in) {
        super(in);
        this.shouldCopyMetadata = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
