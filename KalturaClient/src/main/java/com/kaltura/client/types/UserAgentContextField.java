...
public class UserAgentContextField extends StringField {
    ...
    public static final Creator<UserAgentContextField> CREATOR = new Creator<UserAgentContextField>() {
        @Override
        public UserAgentContextField createFromParcel(Parcel source) {
            return new UserAgentContextField(source);
        }

        @Override
        public UserAgentContextField[] newArray(int size) {
            return new UserAgentContextField[size];
        }
    };

    public UserAgentContextField(Parcel in) {
        super(in);
    }
}
