...
public class ConversionAttribute extends ObjectBase {
    ...
    public static final Creator<ConversionAttribute> CREATOR = new Creator<ConversionAttribute>() {
        @Override
        public ConversionAttribute createFromParcel(Parcel source) {
            return new ConversionAttribute(source);
        }

        @Override
        public ConversionAttribute[] newArray(int size) {
            return new ConversionAttribute[size];
        }
    };
    ...
    public ConversionAttribute(Parcel in) {
        super(in);
