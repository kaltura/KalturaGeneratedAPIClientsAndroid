...
public abstract class EmailNotificationRecipientJobData extends ObjectBase {
    ...
    public EmailNotificationRecipientJobData(Parcel in) {
        super(in);
        int tmpProviderType = in.readInt();
        this.providerType = tmpProviderType == -1 ? null : EmailNotificationRecipientProviderType.values()[tmpProviderType];
    }
}
