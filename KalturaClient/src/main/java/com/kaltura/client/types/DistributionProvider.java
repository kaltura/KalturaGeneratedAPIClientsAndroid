...
public abstract class DistributionProvider extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.scheduleUpdateEnabled);
        dest.writeValue(this.availabilityUpdateEnabled);
        dest.writeValue(this.deleteInsteadUpdate);
        dest.writeValue(this.intervalBeforeSunrise);
        dest.writeValue(this.intervalBeforeSunset);
        dest.writeString(this.updateRequiredEntryFields);
        dest.writeString(this.updateRequiredMetadataXPaths);
    }

    public DistributionProvider(Parcel in) {
        super(in);
        int tmpType = in.readInt();
        this.type = tmpType == -1 ? null : DistributionProviderType.values()[tmpType];
        this.name = in.readString();
        this.scheduleUpdateEnabled = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.availabilityUpdateEnabled = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.deleteInsteadUpdate = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.intervalBeforeSunrise = (Integer)in.readValue(Integer.class.getClassLoader());
        this.intervalBeforeSunset = (Integer)in.readValue(Integer.class.getClassLoader());
