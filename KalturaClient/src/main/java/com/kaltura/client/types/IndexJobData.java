...
public class IndexJobData extends JobData {
    ...
    public static final Creator<IndexJobData> CREATOR = new Creator<IndexJobData>() {
        @Override
        public IndexJobData createFromParcel(Parcel source) {
            return new IndexJobData(source);
        }

        @Override
        public IndexJobData[] newArray(int size) {
            return new IndexJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.lastIndexId);
        dest.writeValue(this.lastIndexDepth);
        dest.writeValue(this.shouldUpdate);
    }

    public IndexJobData(Parcel in) {
        super(in);
        this.filter = in.readParcelable(Filter.class.getClassLoader());
        this.lastIndexId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lastIndexDepth = (Integer)in.readValue(Integer.class.getClassLoader());
        this.shouldUpdate = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
