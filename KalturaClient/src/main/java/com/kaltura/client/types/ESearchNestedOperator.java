...
public class ESearchNestedOperator extends ESearchEntryNestedBaseItem {
    ...
    public static final Creator<ESearchNestedOperator> CREATOR = new Creator<ESearchNestedOperator>() {
        @Override
        public ESearchNestedOperator createFromParcel(Parcel source) {
            return new ESearchNestedOperator(source);
        }

        @Override
        public ESearchNestedOperator[] newArray(int size) {
            return new ESearchNestedOperator[size];
        }
    };
    ...
    public ESearchNestedOperator(Parcel in) {
        super(in);
        ...
        if( searchItemsSize > -1) {
            ...
            in.readList(this.searchItems, ESearchEntryNestedBaseItem.class.getClassLoader());
        }
    }
}
