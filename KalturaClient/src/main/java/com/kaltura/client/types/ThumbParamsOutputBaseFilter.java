...
public abstract class ThumbParamsOutputBaseFilter extends ThumbParamsFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.thumbParamsIdEqual);
        dest.writeString(this.thumbParamsVersionEqual);
        dest.writeString(this.thumbAssetIdEqual);
        dest.writeString(this.thumbAssetVersionEqual);
    }

    public ThumbParamsOutputBaseFilter(Parcel in) {
        super(in);
        this.thumbParamsIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.thumbParamsVersionEqual = in.readString();
        this.thumbAssetIdEqual = in.readString();
        this.thumbAssetVersionEqual = in.readString();
    }
}
