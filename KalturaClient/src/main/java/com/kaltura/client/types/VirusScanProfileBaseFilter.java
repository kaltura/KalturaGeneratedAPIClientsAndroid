...
public abstract class VirusScanProfileBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.engineTypeEqual == null ? -1 : this.engineTypeEqual.ordinal());
        dest.writeString(this.engineTypeIn);
    }

    public VirusScanProfileBaseFilter(Parcel in) {
        super(in);
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : VirusScanProfileStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpEngineTypeEqual = in.readInt();
        this.engineTypeEqual = tmpEngineTypeEqual == -1 ? null : VirusScanEngineType.values()[tmpEngineTypeEqual];
        this.engineTypeIn = in.readString();
    }
}
