...
public class ScheduledVendorTaskData extends VendorTaskData {
    ...
    public static final Creator<ScheduledVendorTaskData> CREATOR = new Creator<ScheduledVendorTaskData>() {
        @Override
        public ScheduledVendorTaskData createFromParcel(Parcel source) {
            return new ScheduledVendorTaskData(source);
        }

        @Override
        public ScheduledVendorTaskData[] newArray(int size) {
            return new ScheduledVendorTaskData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.scheduledEventId);
    }

    public ScheduledVendorTaskData(Parcel in) {
        super(in);
        ...
        this.scheduledEventId = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
