...
public class CortexApiDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<CortexApiDistributionJobProviderData> CREATOR = new Creator<CortexApiDistributionJobProviderData>() {
        @Override
        public CortexApiDistributionJobProviderData createFromParcel(Parcel source) {
            return new CortexApiDistributionJobProviderData(source);
        }

        @Override
        public CortexApiDistributionJobProviderData[] newArray(int size) {
            return new CortexApiDistributionJobProviderData[size];
        }
    };
