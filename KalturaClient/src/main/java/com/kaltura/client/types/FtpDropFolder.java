...
public class FtpDropFolder extends RemoteDropFolder {
    ...
    public static final Creator<FtpDropFolder> CREATOR = new Creator<FtpDropFolder>() {
        @Override
        public FtpDropFolder createFromParcel(Parcel source) {
            return new FtpDropFolder(source);
        }

        @Override
        public FtpDropFolder[] newArray(int size) {
            return new FtpDropFolder[size];
        }
    };
    ...
    public FtpDropFolder(Parcel in) {
        super(in);
