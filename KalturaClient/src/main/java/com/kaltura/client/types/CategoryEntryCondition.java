...
public class CategoryEntryCondition extends Condition {
    ...
    public static final Creator<CategoryEntryCondition> CREATOR = new Creator<CategoryEntryCondition>() {
        @Override
        public CategoryEntryCondition createFromParcel(Parcel source) {
            return new CategoryEntryCondition(source);
        }

        @Override
        public CategoryEntryCondition[] newArray(int size) {
            return new CategoryEntryCondition[size];
        }
    };
