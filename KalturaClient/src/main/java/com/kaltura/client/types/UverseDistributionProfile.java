...
public class UverseDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<UverseDistributionProfile> CREATOR = new Creator<UverseDistributionProfile>() {
        @Override
        public UverseDistributionProfile createFromParcel(Parcel source) {
            return new UverseDistributionProfile(source);
        }

        @Override
        public UverseDistributionProfile[] newArray(int size) {
            return new UverseDistributionProfile[size];
        }
    };
    ...
    public UverseDistributionProfile(Parcel in) {
        super(in);
