...
public abstract class BeaconBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.eventTypeIn);
        dest.writeString(this.objectIdIn);
    }

    public BeaconBaseFilter(Parcel in) {
        super(in);
        ...
        this.relatedObjectTypeEqual = tmpRelatedObjectTypeEqual == -1 ? null : BeaconObjectTypes.values()[tmpRelatedObjectTypeEqual];
        this.eventTypeIn = in.readString();
