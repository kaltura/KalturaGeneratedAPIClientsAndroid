...
public class FeedDropFolderFile extends DropFolderFile {
    ...
    public static final Creator<FeedDropFolderFile> CREATOR = new Creator<FeedDropFolderFile>() {
        @Override
        public FeedDropFolderFile createFromParcel(Parcel source) {
            return new FeedDropFolderFile(source);
        }

        @Override
        public FeedDropFolderFile[] newArray(int size) {
            return new FeedDropFolderFile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.feedXmlPath);
    }

    public FeedDropFolderFile(Parcel in) {
        super(in);
        this.hash = in.readString();
        this.feedXmlPath = in.readString();
    }
}
