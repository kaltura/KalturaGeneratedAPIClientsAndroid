...
public class CaptionAssetItem extends ObjectBase {
    ...
    public static final Creator<CaptionAssetItem> CREATOR = new Creator<CaptionAssetItem>() {
        @Override
        public CaptionAssetItem createFromParcel(Parcel source) {
            return new CaptionAssetItem(source);
        }

        @Override
        public CaptionAssetItem[] newArray(int size) {
            return new CaptionAssetItem[size];
        }
    };
    ...
    public CaptionAssetItem(Parcel in) {
        super(in);
        this.asset = in.readParcelable(CaptionAsset.class.getClassLoader());
        this.entry = in.readParcelable(BaseEntry.class.getClassLoader());
