...
public class CortexApiDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<CortexApiDistributionProfile> CREATOR = new Creator<CortexApiDistributionProfile>() {
        @Override
        public CortexApiDistributionProfile createFromParcel(Parcel source) {
            return new CortexApiDistributionProfile(source);
        }

        @Override
        public CortexApiDistributionProfile[] newArray(int size) {
            return new CortexApiDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.folderrecordid);
        dest.writeString(this.metadataprofileid);
        dest.writeString(this.metadataprofileidpushing);
    }

    public CortexApiDistributionProfile(Parcel in) {
        super(in);
        this.username = in.readString();
        this.host = in.readString();
        this.password = in.readString();
        this.folderrecordid = in.readString();
        this.metadataprofileid = in.readString();
        this.metadataprofileidpushing = in.readString();
    }
}
