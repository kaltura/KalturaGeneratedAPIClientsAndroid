...
public class TimeContextField extends IntegerField {
    ...
    public static final Creator<TimeContextField> CREATOR = new Creator<TimeContextField>() {
        @Override
        public TimeContextField createFromParcel(Parcel source) {
            return new TimeContextField(source);
        }

        @Override
        public TimeContextField[] newArray(int size) {
            return new TimeContextField[size];
        }
    };
    ...
    public TimeContextField(Parcel in) {
        super(in);
