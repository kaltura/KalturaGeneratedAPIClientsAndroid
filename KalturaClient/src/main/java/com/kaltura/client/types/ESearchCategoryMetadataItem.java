...
public class ESearchCategoryMetadataItem extends ESearchAbstractCategoryItem {
    ...
    public static final Creator<ESearchCategoryMetadataItem> CREATOR = new Creator<ESearchCategoryMetadataItem>() {
        @Override
        public ESearchCategoryMetadataItem createFromParcel(Parcel source) {
            return new ESearchCategoryMetadataItem(source);
        }

        @Override
        public ESearchCategoryMetadataItem[] newArray(int size) {
            return new ESearchCategoryMetadataItem[size];
        }
    };
    ...
    public ESearchCategoryMetadataItem(Parcel in) {
        super(in);
