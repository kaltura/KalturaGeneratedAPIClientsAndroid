...
public class AuditTrailTextInfo extends AuditTrailInfo {
    ...
    public static final Creator<AuditTrailTextInfo> CREATOR = new Creator<AuditTrailTextInfo>() {
        @Override
        public AuditTrailTextInfo createFromParcel(Parcel source) {
            return new AuditTrailTextInfo(source);
        }

        @Override
        public AuditTrailTextInfo[] newArray(int size) {
            return new AuditTrailTextInfo[size];
        }
    };
    ...
    public AuditTrailTextInfo(Parcel in) {
        super(in);
