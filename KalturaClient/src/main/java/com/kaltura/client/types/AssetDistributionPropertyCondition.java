...
public class AssetDistributionPropertyCondition extends AssetDistributionCondition {
    ...
    public static final Creator<AssetDistributionPropertyCondition> CREATOR = new Creator<AssetDistributionPropertyCondition>() {
        @Override
        public AssetDistributionPropertyCondition createFromParcel(Parcel source) {
            return new AssetDistributionPropertyCondition(source);
        }

        @Override
        public AssetDistributionPropertyCondition[] newArray(int size) {
            return new AssetDistributionPropertyCondition[size];
        }
    };
    ...
    public AssetDistributionPropertyCondition(Parcel in) {
        super(in);
