...
public class MediaEntryFilter extends MediaEntryBaseFilter {
    ...
    public static final Creator<MediaEntryFilter> CREATOR = new Creator<MediaEntryFilter>() {
        @Override
        public MediaEntryFilter createFromParcel(Parcel source) {
            return new MediaEntryFilter(source);
        }

        @Override
        public MediaEntryFilter[] newArray(int size) {
            return new MediaEntryFilter[size];
        }
    };
