...
public class SummaryVendorTaskData extends VendorTaskData {
    ...
    public static final Creator<SummaryVendorTaskData> CREATOR = new Creator<SummaryVendorTaskData>() {
        @Override
        public SummaryVendorTaskData createFromParcel(Parcel source) {
            return new SummaryVendorTaskData(source);
        }

        @Override
        public SummaryVendorTaskData[] newArray(int size) {
            return new SummaryVendorTaskData[size];
        }
    };
    ...
    public SummaryVendorTaskData(Parcel in) {
        super(in);
        int tmpTypeOfSummary = in.readInt();
