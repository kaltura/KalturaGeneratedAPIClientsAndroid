...
public class LiveEntryFilter extends LiveEntryBaseFilter {
    ...
    public static final Creator<LiveEntryFilter> CREATOR = new Creator<LiveEntryFilter>() {
        @Override
        public LiveEntryFilter createFromParcel(Parcel source) {
            return new LiveEntryFilter(source);
        }

        @Override
        public LiveEntryFilter[] newArray(int size) {
            return new LiveEntryFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.isRecordedEntryIdEmpty);
    ...
    public LiveEntryFilter(Parcel in) {
        ...
        this.isRecordedEntryIdEmpty = (Boolean)in.readValue(Boolean.class.getClassLoader());
