...
public class AkamaiProvisionJobData extends ProvisionJobData {
    ...
    public static final Creator<AkamaiProvisionJobData> CREATOR = new Creator<AkamaiProvisionJobData>() {
        @Override
        public AkamaiProvisionJobData createFromParcel(Parcel source) {
            return new AkamaiProvisionJobData(source);
        }

        @Override
        public AkamaiProvisionJobData[] newArray(int size) {
            return new AkamaiProvisionJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.wsdlUsername);
        dest.writeString(this.wsdlPassword);
    ...
    public AkamaiProvisionJobData(Parcel in) {
        super(in);
        this.wsdlUsername = in.readString();
        this.wsdlPassword = in.readString();
