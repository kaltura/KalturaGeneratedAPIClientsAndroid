...
public class BulkUploadJobData extends JobData {
    ...
    public static final Creator<BulkUploadJobData> CREATOR = new Creator<BulkUploadJobData>() {
        @Override
        public BulkUploadJobData createFromParcel(Parcel source) {
            return new BulkUploadJobData(source);
        }

        @Override
        public BulkUploadJobData[] newArray(int size) {
            return new BulkUploadJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.resultsFileLocalPath);
        dest.writeString(this.resultsFileUrl);
        ...
        dest.writeParcelable(this.objectData, flags);
    ...
    public BulkUploadJobData(Parcel in) {
        ...
        this.resultsFileLocalPath = in.readString();
        this.resultsFileUrl = in.readString();
        ...
        this.objectData = in.readParcelable(BulkUploadObjectData.class.getClassLoader());
