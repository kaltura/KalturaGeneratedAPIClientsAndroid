...
public class QuizFilter extends RelatedFilter {
    ...
    public static final Creator<QuizFilter> CREATOR = new Creator<QuizFilter>() {
        @Override
        public QuizFilter createFromParcel(Parcel source) {
            return new QuizFilter(source);
        }

        @Override
        public QuizFilter[] newArray(int size) {
            return new QuizFilter[size];
        }
    };
