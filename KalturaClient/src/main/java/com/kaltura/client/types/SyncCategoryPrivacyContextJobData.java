...
public class SyncCategoryPrivacyContextJobData extends JobData {
    ...
    public static final Creator<SyncCategoryPrivacyContextJobData> CREATOR = new Creator<SyncCategoryPrivacyContextJobData>() {
        @Override
        public SyncCategoryPrivacyContextJobData createFromParcel(Parcel source) {
            return new SyncCategoryPrivacyContextJobData(source);
        }

        @Override
        public SyncCategoryPrivacyContextJobData[] newArray(int size) {
            return new SyncCategoryPrivacyContextJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.lastUpdatedCategoryEntryCreatedAt);
        dest.writeValue(this.lastUpdatedCategoryCreatedAt);
    }

    public SyncCategoryPrivacyContextJobData(Parcel in) {
        super(in);
        this.categoryId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lastUpdatedCategoryEntryCreatedAt = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lastUpdatedCategoryCreatedAt = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
