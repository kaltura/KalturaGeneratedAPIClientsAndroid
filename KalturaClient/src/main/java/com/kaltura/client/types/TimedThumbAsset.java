...
public class TimedThumbAsset extends ThumbAsset {
    ...
    public static final Creator<TimedThumbAsset> CREATOR = new Creator<TimedThumbAsset>() {
        @Override
        public TimedThumbAsset createFromParcel(Parcel source) {
            return new TimedThumbAsset(source);
        }

        @Override
        public TimedThumbAsset[] newArray(int size) {
            return new TimedThumbAsset[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.cuePointId);
    }

    public TimedThumbAsset(Parcel in) {
        super(in);
        this.cuePointId = in.readString();
    }
}
