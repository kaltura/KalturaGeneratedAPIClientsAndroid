...
public class DynamicEmailContents extends ObjectBase {
    ...
    public static final Creator<DynamicEmailContents> CREATOR = new Creator<DynamicEmailContents>() {
        @Override
        public DynamicEmailContents createFromParcel(Parcel source) {
            return new DynamicEmailContents(source);
        }

        @Override
        public DynamicEmailContents[] newArray(int size) {
            return new DynamicEmailContents[size];
        }
    };
    ...
    public DynamicEmailContents(Parcel in) {
        super(in);
