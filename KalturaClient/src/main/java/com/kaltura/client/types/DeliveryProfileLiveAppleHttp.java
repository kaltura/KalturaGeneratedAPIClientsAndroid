...
public class DeliveryProfileLiveAppleHttp extends DeliveryProfile {
    ...
    public static final Creator<DeliveryProfileLiveAppleHttp> CREATOR = new Creator<DeliveryProfileLiveAppleHttp>() {
        @Override
        public DeliveryProfileLiveAppleHttp createFromParcel(Parcel source) {
            return new DeliveryProfileLiveAppleHttp(source);
        }

        @Override
        public DeliveryProfileLiveAppleHttp[] newArray(int size) {
            return new DeliveryProfileLiveAppleHttp[size];
        }
    };
    ...
    public DeliveryProfileLiveAppleHttp(Parcel in) {
        super(in);
