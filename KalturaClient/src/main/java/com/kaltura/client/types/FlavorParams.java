...
public class FlavorParams extends AssetParams {
    ...
    public static final Creator<FlavorParams> CREATOR = new Creator<FlavorParams>() {
        @Override
        public FlavorParams createFromParcel(Parcel source) {
            return new FlavorParams(source);
        }

        @Override
        public FlavorParams[] newArray(int size) {
            return new FlavorParams[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.videoCodec == null ? -1 : this.videoCodec.ordinal());
        dest.writeValue(this.videoBitrate);
        dest.writeInt(this.audioCodec == null ? -1 : this.audioCodec.ordinal());
        dest.writeValue(this.audioBitrate);
        dest.writeValue(this.audioChannels);
        dest.writeValue(this.audioSampleRate);
        dest.writeValue(this.width);
        dest.writeValue(this.height);
        dest.writeValue(this.frameRate);
        dest.writeValue(this.gopSize);
        dest.writeString(this.conversionEngines);
        dest.writeString(this.conversionEnginesExtraParams);
        dest.writeValue(this.twoPass);
        dest.writeValue(this.deinterlice);
        dest.writeValue(this.rotate);
        dest.writeString(this.operators);
        dest.writeValue(this.engineVersion);
        dest.writeInt(this.format == null ? -1 : this.format.ordinal());
        dest.writeValue(this.aspectRatioProcessingMode);
        dest.writeValue(this.forceFrameToMultiplication16);
        dest.writeValue(this.isGopInSec);
        dest.writeValue(this.isAvoidVideoShrinkFramesizeToSource);
        dest.writeValue(this.isAvoidVideoShrinkBitrateToSource);
        dest.writeValue(this.isVideoFrameRateForLowBrAppleHls);
        dest.writeString(this.multiStream);
        dest.writeValue(this.anamorphicPixels);
        dest.writeValue(this.isAvoidForcedKeyFrames);
        dest.writeValue(this.forcedKeyFramesMode);
        dest.writeValue(this.isCropIMX);
        dest.writeValue(this.optimizationPolicy);
        dest.writeValue(this.maxFrameRate);
        dest.writeValue(this.videoConstantBitrate);
    ...
    public FlavorParams(Parcel in) {
        super(in);
        int tmpVideoCodec = in.readInt();
        this.videoCodec = tmpVideoCodec == -1 ? null : VideoCodec.values()[tmpVideoCodec];
        this.videoBitrate = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpAudioCodec = in.readInt();
        this.audioCodec = tmpAudioCodec == -1 ? null : AudioCodec.values()[tmpAudioCodec];
        ...
        this.frameRate = (Double)in.readValue(Double.class.getClassLoader());
        this.gopSize = (Integer)in.readValue(Integer.class.getClassLoader());
        this.conversionEngines = in.readString();
        this.conversionEnginesExtraParams = in.readString();
        this.twoPass = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.deinterlice = (Integer)in.readValue(Integer.class.getClassLoader());
        this.rotate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.operators = in.readString();
        this.engineVersion = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpFormat = in.readInt();
        this.format = tmpFormat == -1 ? null : ContainerFormat.values()[tmpFormat];
        this.aspectRatioProcessingMode = (Integer)in.readValue(Integer.class.getClassLoader());
        this.forceFrameToMultiplication16 = (Integer)in.readValue(Integer.class.getClassLoader());
        this.isGopInSec = (Integer)in.readValue(Integer.class.getClassLoader());
        this.isAvoidVideoShrinkFramesizeToSource = (Integer)in.readValue(Integer.class.getClassLoader());
        this.isAvoidVideoShrinkBitrateToSource = (Integer)in.readValue(Integer.class.getClassLoader());
        this.isVideoFrameRateForLowBrAppleHls = (Integer)in.readValue(Integer.class.getClassLoader());
        this.multiStream = in.readString();
        this.anamorphicPixels = (Double)in.readValue(Double.class.getClassLoader());
        this.isAvoidForcedKeyFrames = (Integer)in.readValue(Integer.class.getClassLoader());
        this.forcedKeyFramesMode = (Integer)in.readValue(Integer.class.getClassLoader());
        this.isCropIMX = (Integer)in.readValue(Integer.class.getClassLoader());
        this.optimizationPolicy = (Integer)in.readValue(Integer.class.getClassLoader());
        this.maxFrameRate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.videoConstantBitrate = (Integer)in.readValue(Integer.class.getClassLoader());
