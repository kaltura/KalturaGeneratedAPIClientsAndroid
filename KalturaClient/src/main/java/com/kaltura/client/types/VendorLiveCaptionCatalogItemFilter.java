...
public class VendorLiveCaptionCatalogItemFilter extends VendorCaptionsCatalogItemBaseFilter {
    ...
    public static final Creator<VendorLiveCaptionCatalogItemFilter> CREATOR = new Creator<VendorLiveCaptionCatalogItemFilter>() {
        @Override
        public VendorLiveCaptionCatalogItemFilter createFromParcel(Parcel source) {
            return new VendorLiveCaptionCatalogItemFilter(source);
        }

        @Override
        public VendorLiveCaptionCatalogItemFilter[] newArray(int size) {
            return new VendorLiveCaptionCatalogItemFilter[size];
        }
    };

    public VendorLiveCaptionCatalogItemFilter(Parcel in) {
        super(in);
    }
}
