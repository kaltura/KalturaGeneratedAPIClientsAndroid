...
public class SipEntryServerNode extends EntryServerNode {
    ...
    public static final Creator<SipEntryServerNode> CREATOR = new Creator<SipEntryServerNode>() {
        @Override
        public SipEntryServerNode createFromParcel(Parcel source) {
            return new SipEntryServerNode(source);
        }

        @Override
        public SipEntryServerNode[] newArray(int size) {
            return new SipEntryServerNode[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.sipRoomId);
        dest.writeString(this.sipPrimaryAdpId);
        dest.writeString(this.sipSecondaryAdpId);
    }

    public SipEntryServerNode(Parcel in) {
        super(in);
        this.sipRoomId = in.readString();
        this.sipPrimaryAdpId = in.readString();
        this.sipSecondaryAdpId = in.readString();
    }
}
