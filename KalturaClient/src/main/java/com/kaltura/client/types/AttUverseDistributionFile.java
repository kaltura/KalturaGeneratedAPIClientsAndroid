...
public class AttUverseDistributionFile extends ObjectBase {
    ...
    public static final Creator<AttUverseDistributionFile> CREATOR = new Creator<AttUverseDistributionFile>() {
        @Override
        public AttUverseDistributionFile createFromParcel(Parcel source) {
            return new AttUverseDistributionFile(source);
        }

        @Override
        public AttUverseDistributionFile[] newArray(int size) {
            return new AttUverseDistributionFile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.remoteFilename);
    ...
    public AttUverseDistributionFile(Parcel in) {
        super(in);
