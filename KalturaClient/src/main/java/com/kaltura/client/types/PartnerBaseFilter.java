...
public abstract class PartnerBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.partnerPackageEqual);
        dest.writeValue(this.partnerPackageGreaterThanOrEqual);
        dest.writeValue(this.partnerPackageLessThanOrEqual);
        ...
        dest.writeValue(this.monitorUsageEqual);
    }
    ...
    public PartnerBaseFilter(Parcel in) {
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : PartnerStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        this.partnerPackageEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.partnerPackageGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.partnerPackageLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.partnerPackageIn = in.readString();
        ...
        this.monitorUsageEqual = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
