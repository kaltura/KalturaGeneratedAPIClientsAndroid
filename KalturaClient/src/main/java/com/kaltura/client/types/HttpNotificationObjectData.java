...
public class HttpNotificationObjectData extends HttpNotificationData {
    ...
    public static final Creator<HttpNotificationObjectData> CREATOR = new Creator<HttpNotificationObjectData>() {
        @Override
        public HttpNotificationObjectData createFromParcel(Parcel source) {
            return new HttpNotificationObjectData(source);
        }

        @Override
        public HttpNotificationObjectData[] newArray(int size) {
            return new HttpNotificationObjectData[size];
        }
    };
