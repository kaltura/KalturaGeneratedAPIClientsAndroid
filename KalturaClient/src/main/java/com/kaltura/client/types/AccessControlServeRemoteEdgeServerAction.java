...
public class AccessControlServeRemoteEdgeServerAction extends RuleAction {
    ...
    public static final Creator<AccessControlServeRemoteEdgeServerAction> CREATOR = new Creator<AccessControlServeRemoteEdgeServerAction>() {
        @Override
        public AccessControlServeRemoteEdgeServerAction createFromParcel(Parcel source) {
            return new AccessControlServeRemoteEdgeServerAction(source);
        }

        @Override
        public AccessControlServeRemoteEdgeServerAction[] newArray(int size) {
            return new AccessControlServeRemoteEdgeServerAction[size];
        }
    };
