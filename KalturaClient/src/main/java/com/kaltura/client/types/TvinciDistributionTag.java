...
public class TvinciDistributionTag extends ObjectBase {
    ...
    public static final Creator<TvinciDistributionTag> CREATOR = new Creator<TvinciDistributionTag>() {
        @Override
        public TvinciDistributionTag createFromParcel(Parcel source) {
            return new TvinciDistributionTag(source);
        }

        @Override
        public TvinciDistributionTag[] newArray(int size) {
            return new TvinciDistributionTag[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.ppvmodule);
    }

    public TvinciDistributionTag(Parcel in) {
        super(in);
