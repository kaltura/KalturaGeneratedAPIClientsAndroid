...
public class PermissionLevelUserEntryFilter extends UserEntryFilter {
    ...
    public static final Creator<PermissionLevelUserEntryFilter> CREATOR = new Creator<PermissionLevelUserEntryFilter>() {
        @Override
        public PermissionLevelUserEntryFilter createFromParcel(Parcel source) {
            return new PermissionLevelUserEntryFilter(source);
        }

        @Override
        public PermissionLevelUserEntryFilter[] newArray(int size) {
            return new PermissionLevelUserEntryFilter[size];
        }
    };
