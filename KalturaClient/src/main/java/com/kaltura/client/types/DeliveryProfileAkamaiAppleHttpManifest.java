...
public class DeliveryProfileAkamaiAppleHttpManifest extends DeliveryProfile {
    ...
    public static final Creator<DeliveryProfileAkamaiAppleHttpManifest> CREATOR = new Creator<DeliveryProfileAkamaiAppleHttpManifest>() {
        @Override
        public DeliveryProfileAkamaiAppleHttpManifest createFromParcel(Parcel source) {
            return new DeliveryProfileAkamaiAppleHttpManifest(source);
        }

        @Override
        public DeliveryProfileAkamaiAppleHttpManifest[] newArray(int size) {
            return new DeliveryProfileAkamaiAppleHttpManifest[size];
        }
    };
    ...
    public DeliveryProfileAkamaiAppleHttpManifest(Parcel in) {
        super(in);
