...
public class ReachProfile extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.defaultSourceLanguage == null ? -1 : this.defaultSourceLanguage.ordinal());
    ...
    public ReachProfile(Parcel in) {
        ...
        int tmpDefaultSourceLanguage = in.readInt();
        this.defaultSourceLanguage = tmpDefaultSourceLanguage == -1 ? null : CatalogItemLanguage.values()[tmpDefaultSourceLanguage];
        ...
        this.usedCredit = (Integer)in.readValue(Integer.class.getClassLoader());
