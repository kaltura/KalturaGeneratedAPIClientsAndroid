...
public class BusinessProcessServerFilter extends BusinessProcessServerBaseFilter {
    ...
    public static final Creator<BusinessProcessServerFilter> CREATOR = new Creator<BusinessProcessServerFilter>() {
        @Override
        public BusinessProcessServerFilter createFromParcel(Parcel source) {
            return new BusinessProcessServerFilter(source);
        }

        @Override
        public BusinessProcessServerFilter[] newArray(int size) {
            return new BusinessProcessServerFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.currentDcOrExternal);
        dest.writeValue(this.currentDc);
    }

    public BusinessProcessServerFilter(Parcel in) {
        super(in);
        this.currentDcOrExternal = (Boolean)in.readValue(Boolean.class.getClassLoader());
