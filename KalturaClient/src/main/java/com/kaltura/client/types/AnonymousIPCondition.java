...
public class AnonymousIPCondition extends MatchCondition {
    ...
    public static final Creator<AnonymousIPCondition> CREATOR = new Creator<AnonymousIPCondition>() {
        @Override
        public AnonymousIPCondition createFromParcel(Parcel source) {
            return new AnonymousIPCondition(source);
        }

        @Override
        public AnonymousIPCondition[] newArray(int size) {
            return new AnonymousIPCondition[size];
        }
    };
    ...
    public AnonymousIPCondition(Parcel in) {
        super(in);
