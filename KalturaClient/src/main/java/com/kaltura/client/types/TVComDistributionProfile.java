...
public class TVComDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<TVComDistributionProfile> CREATOR = new Creator<TVComDistributionProfile>() {
        @Override
        public TVComDistributionProfile createFromParcel(Parcel source) {
            return new TVComDistributionProfile(source);
        }

        @Override
        public TVComDistributionProfile[] newArray(int size) {
            return new TVComDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.feedLanguage);
        dest.writeString(this.feedCopyright);
        dest.writeString(this.feedImageTitle);
        dest.writeString(this.feedImageUrl);
        dest.writeString(this.feedImageLink);
        dest.writeValue(this.feedImageWidth);
        dest.writeValue(this.feedImageHeight);
    }

    public TVComDistributionProfile(Parcel in) {
        super(in);
        ...
        this.feedLanguage = in.readString();
        this.feedCopyright = in.readString();
        this.feedImageTitle = in.readString();
        this.feedImageUrl = in.readString();
        this.feedImageLink = in.readString();
        this.feedImageWidth = (Integer)in.readValue(Integer.class.getClassLoader());
        this.feedImageHeight = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
