...
public abstract class QuestionCuePointBaseFilter extends CuePointFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.questionLike);
        dest.writeString(this.questionMultiLikeOr);
        dest.writeString(this.questionMultiLikeAnd);
    }

    public QuestionCuePointBaseFilter(Parcel in) {
        super(in);
        this.questionLike = in.readString();
        this.questionMultiLikeOr = in.readString();
        this.questionMultiLikeAnd = in.readString();
    }
}
