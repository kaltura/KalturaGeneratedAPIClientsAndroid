...
public class BulkUploadResultCategoryEntry extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultCategoryEntry> CREATOR = new Creator<BulkUploadResultCategoryEntry>() {
        @Override
        public BulkUploadResultCategoryEntry createFromParcel(Parcel source) {
            return new BulkUploadResultCategoryEntry(source);
        }

        @Override
        public BulkUploadResultCategoryEntry[] newArray(int size) {
            return new BulkUploadResultCategoryEntry[size];
        }
    };
    ...
    public BulkUploadResultCategoryEntry(Parcel in) {
        super(in);
