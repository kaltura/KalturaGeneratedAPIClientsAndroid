...
public abstract class BusinessProcessServer extends ObjectBase {
    ...
    public BusinessProcessServer(Parcel in) {
        super(in);
        ...
        this.status = tmpStatus == -1 ? null : BusinessProcessServerStatus.values()[tmpStatus];
        int tmpType = in.readInt();
        this.type = tmpType == -1 ? null : BusinessProcessProvider.values()[tmpType];
