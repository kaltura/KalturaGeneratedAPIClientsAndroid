...
public class LiveParams extends FlavorParams {
    ...
    public static final Creator<LiveParams> CREATOR = new Creator<LiveParams>() {
        @Override
        public LiveParams createFromParcel(Parcel source) {
            return new LiveParams(source);
        }

        @Override
        public LiveParams[] newArray(int size) {
            return new LiveParams[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.streamSuffix);
    }

    public LiveParams(Parcel in) {
        super(in);
        this.streamSuffix = in.readString();
    }
}
