...
public class YouTubeDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<YouTubeDistributionJobProviderData> CREATOR = new Creator<YouTubeDistributionJobProviderData>() {
        @Override
        public YouTubeDistributionJobProviderData createFromParcel(Parcel source) {
            return new YouTubeDistributionJobProviderData(source);
        }

        @Override
        public YouTubeDistributionJobProviderData[] newArray(int size) {
            return new YouTubeDistributionJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.captionAssetIds);
        dest.writeString(this.sftpDirectory);
        dest.writeString(this.sftpMetadataFilename);
        dest.writeString(this.currentPlaylists);
        dest.writeString(this.newPlaylists);
        dest.writeString(this.submitXml);
        dest.writeString(this.updateXml);
        dest.writeString(this.deleteXml);
    ...
    public YouTubeDistributionJobProviderData(Parcel in) {
        ...
        this.captionAssetIds = in.readString();
        this.sftpDirectory = in.readString();
        this.sftpMetadataFilename = in.readString();
        this.currentPlaylists = in.readString();
        this.newPlaylists = in.readString();
        this.submitXml = in.readString();
        this.updateXml = in.readString();
        this.deleteXml = in.readString();
