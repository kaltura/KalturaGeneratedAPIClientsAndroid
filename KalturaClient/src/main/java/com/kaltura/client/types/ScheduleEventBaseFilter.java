...
public abstract class ScheduleEventBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.parentIdNotIn);
        ...
        dest.writeString(this.ownerIdEqual);
        dest.writeString(this.ownerIdIn);
        ...
        dest.writeInt(this.recurrenceTypeEqual == null ? -1 : this.recurrenceTypeEqual.ordinal());
        dest.writeString(this.recurrenceTypeIn);
    ...
    public ScheduleEventBaseFilter(Parcel in) {
        super(in);
        ...
        this.parentIdNotIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : ScheduleEventStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        this.startDateGreaterThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        this.startDateLessThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        ...
        this.ownerIdEqual = in.readString();
        this.ownerIdIn = in.readString();
        ...
        int tmpRecurrenceTypeEqual = in.readInt();
        this.recurrenceTypeEqual = tmpRecurrenceTypeEqual == -1 ? null : ScheduleEventRecurrenceType.values()[tmpRecurrenceTypeEqual];
        this.recurrenceTypeIn = in.readString();
