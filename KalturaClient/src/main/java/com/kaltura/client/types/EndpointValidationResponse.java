...
public class EndpointValidationResponse extends ObjectBase {
    ...
    public static final Creator<EndpointValidationResponse> CREATOR = new Creator<EndpointValidationResponse>() {
        @Override
        public EndpointValidationResponse createFromParcel(Parcel source) {
            return new EndpointValidationResponse(source);
        }

        @Override
        public EndpointValidationResponse[] newArray(int size) {
            return new EndpointValidationResponse[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.plainToken);
        dest.writeString(this.encryptedToken);
    }

    public EndpointValidationResponse(Parcel in) {
        super(in);
        this.plainToken = in.readString();
        this.encryptedToken = in.readString();
    }
}
