...
public class MatchMetadataCondition extends MatchCondition {
    ...
    public static final Creator<MatchMetadataCondition> CREATOR = new Creator<MatchMetadataCondition>() {
        @Override
        public MatchMetadataCondition createFromParcel(Parcel source) {
            return new MatchMetadataCondition(source);
        }

        @Override
        public MatchMetadataCondition[] newArray(int size) {
            return new MatchMetadataCondition[size];
        }
    };
    ...
    public MatchMetadataCondition(Parcel in) {
        super(in);
