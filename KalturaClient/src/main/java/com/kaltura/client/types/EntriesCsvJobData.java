...
public class EntriesCsvJobData extends MappedObjectsCsvJobData {
    ...
    public static final Creator<EntriesCsvJobData> CREATOR = new Creator<EntriesCsvJobData>() {
        @Override
        public EntriesCsvJobData createFromParcel(Parcel source) {
            return new EntriesCsvJobData(source);
        }

        @Override
        public EntriesCsvJobData[] newArray(int size) {
            return new EntriesCsvJobData[size];
        }
    };
    ...
    public EntriesCsvJobData(Parcel in) {
        super(in);
        this.filter = in.readParcelable(BaseEntryFilter.class.getClassLoader());
    }
}
