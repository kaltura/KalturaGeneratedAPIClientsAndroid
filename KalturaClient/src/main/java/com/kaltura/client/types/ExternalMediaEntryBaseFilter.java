...
public abstract class ExternalMediaEntryBaseFilter extends MediaEntryFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.externalSourceTypeEqual == null ? -1 : this.externalSourceTypeEqual.ordinal());
        dest.writeString(this.externalSourceTypeIn);
        dest.writeString(this.assetParamsIdsMatchOr);
        dest.writeString(this.assetParamsIdsMatchAnd);
    }

    public ExternalMediaEntryBaseFilter(Parcel in) {
        super(in);
        int tmpExternalSourceTypeEqual = in.readInt();
        this.externalSourceTypeEqual = tmpExternalSourceTypeEqual == -1 ? null : ExternalMediaSourceType.values()[tmpExternalSourceTypeEqual];
        this.externalSourceTypeIn = in.readString();
        this.assetParamsIdsMatchOr = in.readString();
        this.assetParamsIdsMatchAnd = in.readString();
    }
}
