...
public class EmailNotificationGroupRecipientProvider extends EmailNotificationRecipientProvider {
    ...
    public static final Creator<EmailNotificationGroupRecipientProvider> CREATOR = new Creator<EmailNotificationGroupRecipientProvider>() {
        @Override
        public EmailNotificationGroupRecipientProvider createFromParcel(Parcel source) {
            return new EmailNotificationGroupRecipientProvider(source);
        }

        @Override
        public EmailNotificationGroupRecipientProvider[] newArray(int size) {
            return new EmailNotificationGroupRecipientProvider[size];
        }
    };
    ...
    public EmailNotificationGroupRecipientProvider(Parcel in) {
        super(in);
