...
public class WebexAPIDropFolderFile extends DropFolderFile {
    ...
    public static final Creator<WebexAPIDropFolderFile> CREATOR = new Creator<WebexAPIDropFolderFile>() {
        @Override
        public WebexAPIDropFolderFile createFromParcel(Parcel source) {
            return new WebexAPIDropFolderFile(source);
        }

        @Override
        public WebexAPIDropFolderFile[] newArray(int size) {
            return new WebexAPIDropFolderFile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.urlExpiry);
        dest.writeString(this.fileExtension);
        dest.writeString(this.meetingId);
        dest.writeValue(this.recordingStartTime);
        dest.writeString(this.hostEmail);
    }

    public WebexAPIDropFolderFile(Parcel in) {
        super(in);
        this.recordingId = in.readString();
        this.description = in.readString();
        this.contentUrl = in.readString();
        this.urlExpiry = (Integer)in.readValue(Integer.class.getClassLoader());
        this.fileExtension = in.readString();
        this.meetingId = in.readString();
        this.recordingStartTime = (Integer)in.readValue(Integer.class.getClassLoader());
