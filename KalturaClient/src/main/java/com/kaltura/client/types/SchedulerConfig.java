...
public class SchedulerConfig extends ObjectBase {
    ...
    public static final Creator<SchedulerConfig> CREATOR = new Creator<SchedulerConfig>() {
        @Override
        public SchedulerConfig createFromParcel(Parcel source) {
            return new SchedulerConfig(source);
        }

        @Override
        public SchedulerConfig[] newArray(int size) {
            return new SchedulerConfig[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.commandStatus);
        ...
        dest.writeString(this.variablePart);
        dest.writeString(this.value);
    }

    public SchedulerConfig(Parcel in) {
        super(in);
        this.id = (Integer)in.readValue(Integer.class.getClassLoader());
        this.createdBy = in.readString();
        this.updatedBy = in.readString();
        this.commandId = in.readString();
        this.commandStatus = in.readString();
        ...
        this.variablePart = in.readString();
