...
public class EntryTranscriptAssetSearchItem extends SearchItem {
    ...
    public static final Creator<EntryTranscriptAssetSearchItem> CREATOR = new Creator<EntryTranscriptAssetSearchItem>() {
        @Override
        public EntryTranscriptAssetSearchItem createFromParcel(Parcel source) {
            return new EntryTranscriptAssetSearchItem(source);
        }

        @Override
        public EntryTranscriptAssetSearchItem[] newArray(int size) {
            return new EntryTranscriptAssetSearchItem[size];
        }
    };
    ...
    public EntryTranscriptAssetSearchItem(Parcel in) {
        super(in);
