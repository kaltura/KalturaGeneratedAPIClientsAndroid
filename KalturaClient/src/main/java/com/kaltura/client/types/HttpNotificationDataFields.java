...
public class HttpNotificationDataFields extends HttpNotificationData {
    ...
    public static final Creator<HttpNotificationDataFields> CREATOR = new Creator<HttpNotificationDataFields>() {
        @Override
        public HttpNotificationDataFields createFromParcel(Parcel source) {
            return new HttpNotificationDataFields(source);
        }

        @Override
        public HttpNotificationDataFields[] newArray(int size) {
            return new HttpNotificationDataFields[size];
        }
    };
