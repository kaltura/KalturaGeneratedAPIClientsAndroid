...
public class VendorAudioDescriptionCatalogItemFilter extends VendorCaptionsCatalogItemBaseFilter {
    ...
    public static final Creator<VendorAudioDescriptionCatalogItemFilter> CREATOR = new Creator<VendorAudioDescriptionCatalogItemFilter>() {
        @Override
        public VendorAudioDescriptionCatalogItemFilter createFromParcel(Parcel source) {
            return new VendorAudioDescriptionCatalogItemFilter(source);
        }

        @Override
        public VendorAudioDescriptionCatalogItemFilter[] newArray(int size) {
            return new VendorAudioDescriptionCatalogItemFilter[size];
        }
    };

    public VendorAudioDescriptionCatalogItemFilter(Parcel in) {
        super(in);
    }
}
