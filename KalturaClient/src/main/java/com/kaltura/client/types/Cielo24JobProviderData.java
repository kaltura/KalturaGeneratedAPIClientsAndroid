...
public class Cielo24JobProviderData extends IntegrationJobProviderData {
    ...
    public static final Creator<Cielo24JobProviderData> CREATOR = new Creator<Cielo24JobProviderData>() {
        @Override
        public Cielo24JobProviderData createFromParcel(Parcel source) {
            return new Cielo24JobProviderData(source);
        }

        @Override
        public Cielo24JobProviderData[] newArray(int size) {
            return new Cielo24JobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.captionAssetFormats);
        dest.writeInt(this.priority == null ? -1 : this.priority.ordinal());
        dest.writeInt(this.fidelity == null ? -1 : this.fidelity.ordinal());
    ...
    public Cielo24JobProviderData(Parcel in) {
        super(in);
        this.entryId = in.readString();
        this.flavorAssetId = in.readString();
        this.captionAssetFormats = in.readString();
        int tmpPriority = in.readInt();
        this.priority = tmpPriority == -1 ? null : Cielo24Priority.values()[tmpPriority];
        int tmpFidelity = in.readInt();
        this.fidelity = tmpFidelity == -1 ? null : Cielo24Fidelity.values()[tmpFidelity];
        this.username = in.readString();
        this.password = in.readString();
        this.baseUrl = in.readString();
        int tmpSpokenLanguage = in.readInt();
