...
public class EntryReferrerLiveStats extends EntryLiveStats {
    ...
    public static final Creator<EntryReferrerLiveStats> CREATOR = new Creator<EntryReferrerLiveStats>() {
        @Override
        public EntryReferrerLiveStats createFromParcel(Parcel source) {
            return new EntryReferrerLiveStats(source);
        }

        @Override
        public EntryReferrerLiveStats[] newArray(int size) {
            return new EntryReferrerLiveStats[size];
        }
    };
    ...
    public EntryReferrerLiveStats(Parcel in) {
        super(in);
