...
public class TimeWarnerDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<TimeWarnerDistributionProfile> CREATOR = new Creator<TimeWarnerDistributionProfile>() {
        @Override
        public TimeWarnerDistributionProfile createFromParcel(Parcel source) {
            return new TimeWarnerDistributionProfile(source);
        }

        @Override
        public TimeWarnerDistributionProfile[] newArray(int size) {
            return new TimeWarnerDistributionProfile[size];
        }
    };
    ...
    public TimeWarnerDistributionProfile(Parcel in) {
        super(in);
