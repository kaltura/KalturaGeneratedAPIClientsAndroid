...
public class WidevineProfile extends DrmProfile {
    ...
    public static final Creator<WidevineProfile> CREATOR = new Creator<WidevineProfile>() {
        @Override
        public WidevineProfile createFromParcel(Parcel source) {
            return new WidevineProfile(source);
        }

        @Override
        public WidevineProfile[] newArray(int size) {
            return new WidevineProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.regServerHost);
    }

    public WidevineProfile(Parcel in) {
        super(in);
        this.key = in.readString();
        this.iv = in.readString();
        this.owner = in.readString();
        this.portal = in.readString();
        this.maxGop = (Integer)in.readValue(Integer.class.getClassLoader());
        this.regServerHost = in.readString();
    }
}
