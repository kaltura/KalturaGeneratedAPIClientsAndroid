...
public class MediaEntryCompareAttributeCondition extends SearchComparableAttributeCondition {
    ...
    public static final Creator<MediaEntryCompareAttributeCondition> CREATOR = new Creator<MediaEntryCompareAttributeCondition>() {
        @Override
        public MediaEntryCompareAttributeCondition createFromParcel(Parcel source) {
            return new MediaEntryCompareAttributeCondition(source);
        }

        @Override
        public MediaEntryCompareAttributeCondition[] newArray(int size) {
            return new MediaEntryCompareAttributeCondition[size];
        }
    };
    ...
    public MediaEntryCompareAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : MediaEntryCompareAttribute.values()[tmpAttribute];
    }
}
