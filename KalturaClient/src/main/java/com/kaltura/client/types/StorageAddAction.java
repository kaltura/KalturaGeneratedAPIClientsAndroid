...
public class StorageAddAction extends RuleAction {
    ...
    public static final Creator<StorageAddAction> CREATOR = new Creator<StorageAddAction>() {
        @Override
        public StorageAddAction createFromParcel(Parcel source) {
            return new StorageAddAction(source);
        }

        @Override
        public StorageAddAction[] newArray(int size) {
            return new StorageAddAction[size];
        }
    };

    public StorageAddAction(Parcel in) {
        super(in);
    }
}
