...
public class CatalogItemAdvancedFilter extends SearchItem {
    ...
    public static final Creator<CatalogItemAdvancedFilter> CREATOR = new Creator<CatalogItemAdvancedFilter>() {
        @Override
        public CatalogItemAdvancedFilter createFromParcel(Parcel source) {
            return new CatalogItemAdvancedFilter(source);
        }

        @Override
        public CatalogItemAdvancedFilter[] newArray(int size) {
            return new CatalogItemAdvancedFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.serviceTypeEqual == null ? -1 : this.serviceTypeEqual.ordinal());
        dest.writeString(this.serviceTypeIn);
        dest.writeInt(this.serviceFeatureEqual == null ? -1 : this.serviceFeatureEqual.ordinal());
        dest.writeString(this.serviceFeatureIn);
        dest.writeInt(this.turnAroundTimeEqual == null ? -1 : this.turnAroundTimeEqual.ordinal());
        dest.writeString(this.turnAroundTimeIn);
        dest.writeInt(this.sourceLanguageEqual == null ? -1 : this.sourceLanguageEqual.ordinal());
        dest.writeInt(this.targetLanguageEqual == null ? -1 : this.targetLanguageEqual.ordinal());
    }

    public CatalogItemAdvancedFilter(Parcel in) {
        super(in);
        int tmpServiceTypeEqual = in.readInt();
        this.serviceTypeEqual = tmpServiceTypeEqual == -1 ? null : VendorServiceType.values()[tmpServiceTypeEqual];
        this.serviceTypeIn = in.readString();
        int tmpServiceFeatureEqual = in.readInt();
        this.serviceFeatureEqual = tmpServiceFeatureEqual == -1 ? null : VendorServiceFeature.values()[tmpServiceFeatureEqual];
        this.serviceFeatureIn = in.readString();
        int tmpTurnAroundTimeEqual = in.readInt();
        this.turnAroundTimeEqual = tmpTurnAroundTimeEqual == -1 ? null : VendorServiceTurnAroundTime.values()[tmpTurnAroundTimeEqual];
        this.turnAroundTimeIn = in.readString();
        int tmpSourceLanguageEqual = in.readInt();
        this.sourceLanguageEqual = tmpSourceLanguageEqual == -1 ? null : CatalogItemLanguage.values()[tmpSourceLanguageEqual];
        int tmpTargetLanguageEqual = in.readInt();
        this.targetLanguageEqual = tmpTargetLanguageEqual == -1 ? null : CatalogItemLanguage.values()[tmpTargetLanguageEqual];
    }
}
