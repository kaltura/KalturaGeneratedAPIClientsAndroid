...
public class UrlTokenizerLevel3 extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerLevel3> CREATOR = new Creator<UrlTokenizerLevel3>() {
        @Override
        public UrlTokenizerLevel3 createFromParcel(Parcel source) {
            return new UrlTokenizerLevel3(source);
        }

        @Override
        public UrlTokenizerLevel3[] newArray(int size) {
            return new UrlTokenizerLevel3[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.expiryName);
        dest.writeString(this.gen);
    }

    public UrlTokenizerLevel3(Parcel in) {
        super(in);
        this.paramName = in.readString();
        this.expiryName = in.readString();
