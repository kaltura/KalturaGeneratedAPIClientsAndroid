...
public class ConvertCaptionAssetJobData extends JobData {
    ...
    public static final Creator<ConvertCaptionAssetJobData> CREATOR = new Creator<ConvertCaptionAssetJobData>() {
        @Override
        public ConvertCaptionAssetJobData createFromParcel(Parcel source) {
            return new ConvertCaptionAssetJobData(source);
        }

        @Override
        public ConvertCaptionAssetJobData[] newArray(int size) {
            return new ConvertCaptionAssetJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.toType);
    }

    public ConvertCaptionAssetJobData(Parcel in) {
        super(in);
