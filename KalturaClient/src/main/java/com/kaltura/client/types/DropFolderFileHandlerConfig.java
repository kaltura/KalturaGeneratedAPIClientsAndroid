...
public abstract class DropFolderFileHandlerConfig extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.handlerType == null ? -1 : this.handlerType.ordinal());
    }

    public DropFolderFileHandlerConfig(Parcel in) {
        super(in);
        int tmpHandlerType = in.readInt();
        this.handlerType = tmpHandlerType == -1 ? null : DropFolderFileHandlerType.values()[tmpHandlerType];
    }
}
