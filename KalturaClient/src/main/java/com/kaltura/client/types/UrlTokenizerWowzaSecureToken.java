...
public class UrlTokenizerWowzaSecureToken extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerWowzaSecureToken> CREATOR = new Creator<UrlTokenizerWowzaSecureToken>() {
        @Override
        public UrlTokenizerWowzaSecureToken createFromParcel(Parcel source) {
            return new UrlTokenizerWowzaSecureToken(source);
        }

        @Override
        public UrlTokenizerWowzaSecureToken[] newArray(int size) {
            return new UrlTokenizerWowzaSecureToken[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.paramPrefix);
        dest.writeString(this.hashAlgorithm);
    }

    public UrlTokenizerWowzaSecureToken(Parcel in) {
        super(in);
        this.paramPrefix = in.readString();
        this.hashAlgorithm = in.readString();
    }
}
