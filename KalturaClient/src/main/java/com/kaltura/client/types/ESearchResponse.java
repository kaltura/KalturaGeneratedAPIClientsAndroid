...
public class ESearchResponse extends ObjectBase {
    ...
    public static final Creator<ESearchResponse> CREATOR = new Creator<ESearchResponse>() {
        @Override
        public ESearchResponse createFromParcel(Parcel source) {
            return new ESearchResponse(source);
        }

        @Override
        public ESearchResponse[] newArray(int size) {
            return new ESearchResponse[size];
        }
    };
    ...
    public ESearchResponse(Parcel in) {
        ...
        if( objectsSize > -1) {
            ...
            in.readList(this.objects, ESearchResult.class.getClassLoader());
        }
    }
}
