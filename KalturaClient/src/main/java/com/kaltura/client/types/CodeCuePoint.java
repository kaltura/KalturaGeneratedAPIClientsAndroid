...
public class CodeCuePoint extends CuePoint {
    ...
    public static final Creator<CodeCuePoint> CREATOR = new Creator<CodeCuePoint>() {
        @Override
        public CodeCuePoint createFromParcel(Parcel source) {
            return new CodeCuePoint(source);
        }

        @Override
        public CodeCuePoint[] newArray(int size) {
            return new CodeCuePoint[size];
        }
    };
