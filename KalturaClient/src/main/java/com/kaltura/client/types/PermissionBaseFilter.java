...
public abstract class PermissionBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.friendlyNameLike);
        ...
        dest.writeString(this.dependsOnPermissionNamesMultiLikeOr);
        dest.writeString(this.dependsOnPermissionNamesMultiLikeAnd);
    ...
    public PermissionBaseFilter(Parcel in) {
        ...
        this.dependsOnPermissionNamesMultiLikeOr = in.readString();
        this.dependsOnPermissionNamesMultiLikeAnd = in.readString();
