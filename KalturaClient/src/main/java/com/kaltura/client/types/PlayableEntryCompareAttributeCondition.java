...
public class PlayableEntryCompareAttributeCondition extends SearchComparableAttributeCondition {
    ...
    public static final Creator<PlayableEntryCompareAttributeCondition> CREATOR = new Creator<PlayableEntryCompareAttributeCondition>() {
        @Override
        public PlayableEntryCompareAttributeCondition createFromParcel(Parcel source) {
            return new PlayableEntryCompareAttributeCondition(source);
        }

        @Override
        public PlayableEntryCompareAttributeCondition[] newArray(int size) {
            return new PlayableEntryCompareAttributeCondition[size];
        }
    };
    ...
    public PlayableEntryCompareAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : PlayableEntryCompareAttribute.values()[tmpAttribute];
    }
}
