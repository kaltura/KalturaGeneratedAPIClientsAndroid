...
public class LiveChannelMatchAttributeCondition extends SearchMatchAttributeCondition {
    ...
    public static final Creator<LiveChannelMatchAttributeCondition> CREATOR = new Creator<LiveChannelMatchAttributeCondition>() {
        @Override
        public LiveChannelMatchAttributeCondition createFromParcel(Parcel source) {
            return new LiveChannelMatchAttributeCondition(source);
        }

        @Override
        public LiveChannelMatchAttributeCondition[] newArray(int size) {
            return new LiveChannelMatchAttributeCondition[size];
        }
    };
    ...
    public LiveChannelMatchAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : LiveChannelMatchAttribute.values()[tmpAttribute];
    }
}
