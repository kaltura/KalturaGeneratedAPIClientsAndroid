...
public class HashCondition extends Condition {
    ...
    public static final Creator<HashCondition> CREATOR = new Creator<HashCondition>() {
        @Override
        public HashCondition createFromParcel(Parcel source) {
            return new HashCondition(source);
        }

        @Override
        public HashCondition[] newArray(int size) {
            return new HashCondition[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.hashSecret);
    }

    public HashCondition(Parcel in) {
        super(in);
        this.hashName = in.readString();
        this.hashSecret = in.readString();
    }
}
