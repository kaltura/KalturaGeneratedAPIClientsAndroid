...
public class BulkUploadResultScheduleResource extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultScheduleResource> CREATOR = new Creator<BulkUploadResultScheduleResource>() {
        @Override
        public BulkUploadResultScheduleResource createFromParcel(Parcel source) {
            return new BulkUploadResultScheduleResource(source);
        }

        @Override
        public BulkUploadResultScheduleResource[] newArray(int size) {
            return new BulkUploadResultScheduleResource[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.parentSystemName);
    }

    public BulkUploadResultScheduleResource(Parcel in) {
        super(in);
        ...
        this.parentSystemName = in.readString();
    }
}
