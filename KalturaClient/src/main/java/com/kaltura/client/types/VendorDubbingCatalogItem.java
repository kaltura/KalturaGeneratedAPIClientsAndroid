...
public class VendorDubbingCatalogItem extends VendorCatalogItem {
    ...
    public static final Creator<VendorDubbingCatalogItem> CREATOR = new Creator<VendorDubbingCatalogItem>() {
        @Override
        public VendorDubbingCatalogItem createFromParcel(Parcel source) {
            return new VendorDubbingCatalogItem(source);
        }

        @Override
        public VendorDubbingCatalogItem[] newArray(int size) {
            return new VendorDubbingCatalogItem[size];
        }
    };
    ...
    public VendorDubbingCatalogItem(Parcel in) {
        super(in);
