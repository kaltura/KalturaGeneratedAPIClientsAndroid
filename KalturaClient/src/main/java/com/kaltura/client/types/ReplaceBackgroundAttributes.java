...
public class ReplaceBackgroundAttributes extends MediaCompositionAttributes {
    ...
    public static final Creator<ReplaceBackgroundAttributes> CREATOR = new Creator<ReplaceBackgroundAttributes>() {
        @Override
        public ReplaceBackgroundAttributes createFromParcel(Parcel source) {
            return new ReplaceBackgroundAttributes(source);
        }

        @Override
        public ReplaceBackgroundAttributes[] newArray(int size) {
            return new ReplaceBackgroundAttributes[size];
        }
    };
