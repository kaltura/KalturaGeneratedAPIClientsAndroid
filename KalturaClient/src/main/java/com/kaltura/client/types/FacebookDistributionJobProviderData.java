...
public class FacebookDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<FacebookDistributionJobProviderData> CREATOR = new Creator<FacebookDistributionJobProviderData>() {
        @Override
        public FacebookDistributionJobProviderData createFromParcel(Parcel source) {
            return new FacebookDistributionJobProviderData(source);
        }

        @Override
        public FacebookDistributionJobProviderData[] newArray(int size) {
            return new FacebookDistributionJobProviderData[size];
        }
    };
    ...
    public FacebookDistributionJobProviderData(Parcel in) {
        ...
        if( captionsInfoSize > -1) {
            ...
            in.readList(this.captionsInfo, FacebookCaptionDistributionInfo.class.getClassLoader());
        }
    }
}
