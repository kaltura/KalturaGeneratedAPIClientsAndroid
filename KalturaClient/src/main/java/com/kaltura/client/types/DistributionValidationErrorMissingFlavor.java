...
public class DistributionValidationErrorMissingFlavor extends DistributionValidationError {
    ...
    public static final Creator<DistributionValidationErrorMissingFlavor> CREATOR = new Creator<DistributionValidationErrorMissingFlavor>() {
        @Override
        public DistributionValidationErrorMissingFlavor createFromParcel(Parcel source) {
            return new DistributionValidationErrorMissingFlavor(source);
        }

        @Override
        public DistributionValidationErrorMissingFlavor[] newArray(int size) {
            return new DistributionValidationErrorMissingFlavor[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.flavorParamsId);
    }

    public DistributionValidationErrorMissingFlavor(Parcel in) {
        super(in);
        this.flavorParamsId = in.readString();
    }
}
