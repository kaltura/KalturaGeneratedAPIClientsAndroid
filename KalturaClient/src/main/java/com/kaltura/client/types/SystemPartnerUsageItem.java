...
public class SystemPartnerUsageItem extends ObjectBase {
    ...
    public static final Creator<SystemPartnerUsageItem> CREATOR = new Creator<SystemPartnerUsageItem>() {
        @Override
        public SystemPartnerUsageItem createFromParcel(Parcel source) {
            return new SystemPartnerUsageItem(source);
        }

        @Override
        public SystemPartnerUsageItem[] newArray(int size) {
            return new SystemPartnerUsageItem[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.combinedBandwidthStorage);
        dest.writeValue(this.deletedStorage);
        dest.writeValue(this.transcodingUsage);
    }

    public SystemPartnerUsageItem(Parcel in) {
        super(in);
        ...
        this.combinedBandwidthStorage = (Double)in.readValue(Double.class.getClassLoader());
