...
public class DispatchEventNotificationObjectTask extends ObjectTask {
    ...
    public static final Creator<DispatchEventNotificationObjectTask> CREATOR = new Creator<DispatchEventNotificationObjectTask>() {
        @Override
        public DispatchEventNotificationObjectTask createFromParcel(Parcel source) {
            return new DispatchEventNotificationObjectTask(source);
        }

        @Override
        public DispatchEventNotificationObjectTask[] newArray(int size) {
            return new DispatchEventNotificationObjectTask[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.eventNotificationTemplateId);
    }

    public DispatchEventNotificationObjectTask(Parcel in) {
        super(in);
        this.eventNotificationTemplateId = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
