...
public class ConvertEntryFlavorsObjectTask extends ObjectTask {
    ...
    public static final Creator<ConvertEntryFlavorsObjectTask> CREATOR = new Creator<ConvertEntryFlavorsObjectTask>() {
        @Override
        public ConvertEntryFlavorsObjectTask createFromParcel(Parcel source) {
            return new ConvertEntryFlavorsObjectTask(source);
        }

        @Override
        public ConvertEntryFlavorsObjectTask[] newArray(int size) {
            return new ConvertEntryFlavorsObjectTask[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.reconvert);
    }

    public ConvertEntryFlavorsObjectTask(Parcel in) {
        super(in);
        this.flavorParamsIds = in.readString();
        this.reconvert = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
