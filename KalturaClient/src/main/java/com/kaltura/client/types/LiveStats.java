...
public class LiveStats extends ObjectBase {
    ...
    public static final Creator<LiveStats> CREATOR = new Creator<LiveStats>() {
        @Override
        public LiveStats createFromParcel(Parcel source) {
            return new LiveStats(source);
        }

        @Override
        public LiveStats[] newArray(int size) {
            return new LiveStats[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.audience);
        dest.writeValue(this.dvrAudience);
        dest.writeValue(this.avgBitrate);
        dest.writeValue(this.bufferTime);
        dest.writeValue(this.plays);
        dest.writeValue(this.secondsViewed);
        dest.writeValue(this.startEvent);
        dest.writeValue(this.timestamp);
    }

    public LiveStats(Parcel in) {
        super(in);
        this.audience = (Integer)in.readValue(Integer.class.getClassLoader());
        this.dvrAudience = (Integer)in.readValue(Integer.class.getClassLoader());
        this.avgBitrate = (Double)in.readValue(Double.class.getClassLoader());
        this.bufferTime = (Integer)in.readValue(Integer.class.getClassLoader());
        this.plays = (Integer)in.readValue(Integer.class.getClassLoader());
        this.secondsViewed = (Integer)in.readValue(Integer.class.getClassLoader());
        this.startEvent = (Long)in.readValue(Long.class.getClassLoader());
