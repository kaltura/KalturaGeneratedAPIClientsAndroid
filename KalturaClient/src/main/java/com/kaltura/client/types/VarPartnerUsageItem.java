...
public class VarPartnerUsageItem extends ObjectBase {
    ...
    public static final Creator<VarPartnerUsageItem> CREATOR = new Creator<VarPartnerUsageItem>() {
        @Override
        public VarPartnerUsageItem createFromParcel(Parcel source) {
            return new VarPartnerUsageItem(source);
        }

        @Override
        public VarPartnerUsageItem[] newArray(int size) {
            return new VarPartnerUsageItem[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.partnerCreatedAt);
        dest.writeValue(this.views);
        dest.writeValue(this.plays);
        dest.writeValue(this.entriesCount);
        dest.writeValue(this.totalEntriesCount);
        dest.writeValue(this.videoEntriesCount);
        dest.writeValue(this.imageEntriesCount);
        dest.writeValue(this.audioEntriesCount);
        dest.writeValue(this.mixEntriesCount);
        dest.writeValue(this.bandwidth);
        dest.writeValue(this.totalStorage);
        dest.writeValue(this.storage);
        dest.writeValue(this.deletedStorage);
        dest.writeValue(this.peakStorage);
        dest.writeValue(this.avgStorage);
        dest.writeValue(this.combinedStorageBandwidth);
        dest.writeValue(this.transcodingUsage);
        dest.writeString(this.dateId);
    }

    public VarPartnerUsageItem(Parcel in) {
        super(in);
        ...
        this.partnerCreatedAt = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        this.totalEntriesCount = (Integer)in.readValue(Integer.class.getClassLoader());
        this.videoEntriesCount = (Integer)in.readValue(Integer.class.getClassLoader());
        this.imageEntriesCount = (Integer)in.readValue(Integer.class.getClassLoader());
        this.audioEntriesCount = (Integer)in.readValue(Integer.class.getClassLoader());
        this.mixEntriesCount = (Integer)in.readValue(Integer.class.getClassLoader());
        this.bandwidth = (Double)in.readValue(Double.class.getClassLoader());
        this.totalStorage = (Double)in.readValue(Double.class.getClassLoader());
        this.storage = (Double)in.readValue(Double.class.getClassLoader());
        this.deletedStorage = (Double)in.readValue(Double.class.getClassLoader());
        this.peakStorage = (Double)in.readValue(Double.class.getClassLoader());
        this.avgStorage = (Double)in.readValue(Double.class.getClassLoader());
        this.combinedStorageBandwidth = (Double)in.readValue(Double.class.getClassLoader());
        this.transcodingUsage = (Double)in.readValue(Double.class.getClassLoader());
        this.dateId = in.readString();
    }
}
