...
public class BulkUploadCsvJobData extends BulkUploadJobData {
    ...
    public static final Creator<BulkUploadCsvJobData> CREATOR = new Creator<BulkUploadCsvJobData>() {
        @Override
        public BulkUploadCsvJobData createFromParcel(Parcel source) {
            return new BulkUploadCsvJobData(source);
        }

        @Override
        public BulkUploadCsvJobData[] newArray(int size) {
            return new BulkUploadCsvJobData[size];
        }
    };
