...
public class IpAddressCondition extends MatchCondition {
    ...
    public static final Creator<IpAddressCondition> CREATOR = new Creator<IpAddressCondition>() {
        @Override
        public IpAddressCondition createFromParcel(Parcel source) {
            return new IpAddressCondition(source);
        }

        @Override
        public IpAddressCondition[] newArray(int size) {
            return new IpAddressCondition[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.acceptInternalIps);
        dest.writeString(this.httpHeader);
    }

    public IpAddressCondition(Parcel in) {
        super(in);
        this.acceptInternalIps = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.httpHeader = in.readString();
    }
}
