...
public abstract class CuePointBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.forceStopEqual == null ? -1 : this.forceStopEqual.ordinal());
    ...
    public CuePointBaseFilter(Parcel in) {
        ...
        int tmpForceStopEqual = in.readInt();
        this.forceStopEqual = tmpForceStopEqual == -1 ? null : Boolean.values()[tmpForceStopEqual];
