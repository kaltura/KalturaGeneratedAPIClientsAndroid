...
public class OperationResource extends ContentResource {
    ...
    public static final Creator<OperationResource> CREATOR = new Creator<OperationResource>() {
        @Override
        public OperationResource createFromParcel(Parcel source) {
            return new OperationResource(source);
        }

        @Override
        public OperationResource[] newArray(int size) {
            return new OperationResource[size];
        }
    };
    ...
    public OperationResource(Parcel in) {
        super(in);
