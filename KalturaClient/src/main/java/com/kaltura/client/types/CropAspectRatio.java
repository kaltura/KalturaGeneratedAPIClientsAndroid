...
public class CropAspectRatio extends ObjectBase {
    ...
    public static final Creator<CropAspectRatio> CREATOR = new Creator<CropAspectRatio>() {
        @Override
        public CropAspectRatio createFromParcel(Parcel source) {
            return new CropAspectRatio(source);
        }

        @Override
        public CropAspectRatio[] newArray(int size) {
            return new CropAspectRatio[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.crop);
        dest.writeValue(this.aspectRatio);
    }

    public CropAspectRatio(Parcel in) {
        super(in);
        this.crop = (Boolean)in.readValue(Boolean.class.getClassLoader());
