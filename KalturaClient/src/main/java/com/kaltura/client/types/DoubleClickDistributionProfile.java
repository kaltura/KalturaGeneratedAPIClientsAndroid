...
public class DoubleClickDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<DoubleClickDistributionProfile> CREATOR = new Creator<DoubleClickDistributionProfile>() {
        @Override
        public DoubleClickDistributionProfile createFromParcel(Parcel source) {
            return new DoubleClickDistributionProfile(source);
        }

        @Override
        public DoubleClickDistributionProfile[] newArray(int size) {
            return new DoubleClickDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.cuePointsProvider);
        dest.writeString(this.itemsPerPage);
        dest.writeValue(this.ignoreSchedulingInFeed);
    }

    public DoubleClickDistributionProfile(Parcel in) {
        super(in);
        ...
        this.cuePointsProvider = in.readString();
        this.itemsPerPage = in.readString();
        this.ignoreSchedulingInFeed = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
