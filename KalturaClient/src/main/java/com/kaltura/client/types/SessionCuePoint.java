...
public class SessionCuePoint extends CuePoint {
    ...
    public static final Creator<SessionCuePoint> CREATOR = new Creator<SessionCuePoint>() {
        @Override
        public SessionCuePoint createFromParcel(Parcel source) {
            return new SessionCuePoint(source);
        }

        @Override
        public SessionCuePoint[] newArray(int size) {
            return new SessionCuePoint[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.sessionOwner);
    }

    public SessionCuePoint(Parcel in) {
        super(in);
        this.name = in.readString();
        this.endTime = (Integer)in.readValue(Integer.class.getClassLoader());
        this.duration = (Integer)in.readValue(Integer.class.getClassLoader());
        this.sessionOwner = in.readString();
    }
}
