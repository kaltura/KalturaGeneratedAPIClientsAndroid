...
public class CountryContextField extends StringField {
    ...
    public static final Creator<CountryContextField> CREATOR = new Creator<CountryContextField>() {
        @Override
        public CountryContextField createFromParcel(Parcel source) {
            return new CountryContextField(source);
        }

        @Override
        public CountryContextField[] newArray(int size) {
            return new CountryContextField[size];
        }
    };
    ...
    public CountryContextField(Parcel in) {
        super(in);
