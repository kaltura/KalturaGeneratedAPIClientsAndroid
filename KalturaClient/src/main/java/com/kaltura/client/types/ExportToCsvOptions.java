...
public class ExportToCsvOptions extends ObjectBase {
    ...
    public static final Creator<ExportToCsvOptions> CREATOR = new Creator<ExportToCsvOptions>() {
        @Override
        public ExportToCsvOptions createFromParcel(Parcel source) {
            return new ExportToCsvOptions(source);
        }

        @Override
        public ExportToCsvOptions[] newArray(int size) {
            return new ExportToCsvOptions[size];
        }
    };
