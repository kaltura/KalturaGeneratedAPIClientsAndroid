...
public class EntryCuePointSearchFilter extends SearchItem {
    ...
    public static final Creator<EntryCuePointSearchFilter> CREATOR = new Creator<EntryCuePointSearchFilter>() {
        @Override
        public EntryCuePointSearchFilter createFromParcel(Parcel source) {
            return new EntryCuePointSearchFilter(source);
        }

        @Override
        public EntryCuePointSearchFilter[] newArray(int size) {
            return new EntryCuePointSearchFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.cuePointsFreeText);
        dest.writeString(this.cuePointTypeIn);
        dest.writeValue(this.cuePointSubTypeEqual);
    }

    public EntryCuePointSearchFilter(Parcel in) {
        super(in);
        this.cuePointsFreeText = in.readString();
        this.cuePointTypeIn = in.readString();
        this.cuePointSubTypeEqual = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
