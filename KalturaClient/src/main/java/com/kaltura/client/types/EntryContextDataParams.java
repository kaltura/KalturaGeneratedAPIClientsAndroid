...
public class EntryContextDataParams extends AccessControlScope {
    ...
    public static final Creator<EntryContextDataParams> CREATOR = new Creator<EntryContextDataParams>() {
        @Override
        public EntryContextDataParams createFromParcel(Parcel source) {
            return new EntryContextDataParams(source);
        }

        @Override
        public EntryContextDataParams[] newArray(int size) {
            return new EntryContextDataParams[size];
        }
    };
