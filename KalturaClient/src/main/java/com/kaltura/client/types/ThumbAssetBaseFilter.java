...
public abstract class ThumbAssetBaseFilter extends AssetFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.thumbParamsIdIn);
    ...
    public ThumbAssetBaseFilter(Parcel in) {
        super(in);
        this.thumbParamsIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.thumbParamsIdIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : ThumbAssetStatus.values()[tmpStatusEqual];
