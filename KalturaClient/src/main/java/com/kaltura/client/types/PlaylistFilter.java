...
public class PlaylistFilter extends PlaylistBaseFilter {
    ...
    public static final Creator<PlaylistFilter> CREATOR = new Creator<PlaylistFilter>() {
        @Override
        public PlaylistFilter createFromParcel(Parcel source) {
            return new PlaylistFilter(source);
        }

        @Override
        public PlaylistFilter[] newArray(int size) {
            return new PlaylistFilter[size];
        }
    };
