...
public class ClippingTaskEntryServerNode extends TaskEntryServerNode {
    ...
    public static final Creator<ClippingTaskEntryServerNode> CREATOR = new Creator<ClippingTaskEntryServerNode>() {
        @Override
        public ClippingTaskEntryServerNode createFromParcel(Parcel source) {
            return new ClippingTaskEntryServerNode(source);
        }

        @Override
        public ClippingTaskEntryServerNode[] newArray(int size) {
            return new ClippingTaskEntryServerNode[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.clipAttributes, flags);
        dest.writeString(this.clippedEntryId);
        dest.writeString(this.liveEntryId);
    }

    public ClippingTaskEntryServerNode(Parcel in) {
        super(in);
        this.clipAttributes = in.readParcelable(ClipAttributes.class.getClassLoader());
        this.clippedEntryId = in.readString();
