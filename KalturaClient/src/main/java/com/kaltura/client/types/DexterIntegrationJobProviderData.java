...
public class DexterIntegrationJobProviderData extends IntegrationJobProviderData {
    ...
    public static final Creator<DexterIntegrationJobProviderData> CREATOR = new Creator<DexterIntegrationJobProviderData>() {
        @Override
        public DexterIntegrationJobProviderData createFromParcel(Parcel source) {
            return new DexterIntegrationJobProviderData(source);
        }

        @Override
        public DexterIntegrationJobProviderData[] newArray(int size) {
            return new DexterIntegrationJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.transcriptAssetId);
        dest.writeString(this.entryId);
        dest.writeString(this.voicebaseApiKey);
        dest.writeString(this.voicebaseApiPassword);
    }

    public DexterIntegrationJobProviderData(Parcel in) {
        super(in);
        this.metadataProfileId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.transcriptAssetId = in.readString();
        this.entryId = in.readString();
        this.voicebaseApiKey = in.readString();
        this.voicebaseApiPassword = in.readString();
    }
}
