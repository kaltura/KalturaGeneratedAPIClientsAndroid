...
public abstract class GroupUserBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.groupIdEqual);
        dest.writeString(this.groupIdIn);
    ...
    public GroupUserBaseFilter(Parcel in) {
        super(in);
        this.userIdEqual = in.readString();
        this.userIdIn = in.readString();
        this.groupIdEqual = in.readString();
        this.groupIdIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : GroupUserStatus.values()[tmpStatusEqual];
