...
public class BusinessProcessSignalNotificationTemplate extends BusinessProcessNotificationTemplate {
    ...
    public static final Creator<BusinessProcessSignalNotificationTemplate> CREATOR = new Creator<BusinessProcessSignalNotificationTemplate>() {
        @Override
        public BusinessProcessSignalNotificationTemplate createFromParcel(Parcel source) {
            return new BusinessProcessSignalNotificationTemplate(source);
        }

        @Override
        public BusinessProcessSignalNotificationTemplate[] newArray(int size) {
            return new BusinessProcessSignalNotificationTemplate[size];
        }
    };
    ...
    public BusinessProcessSignalNotificationTemplate(Parcel in) {
        super(in);
