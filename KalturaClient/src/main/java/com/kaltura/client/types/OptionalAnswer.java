...
public class OptionalAnswer extends ObjectBase {
    ...
    public static final Creator<OptionalAnswer> CREATOR = new Creator<OptionalAnswer>() {
        @Override
        public OptionalAnswer createFromParcel(Parcel source) {
            return new OptionalAnswer(source);
        }

        @Override
        public OptionalAnswer[] newArray(int size) {
            return new OptionalAnswer[size];
        }
    };
