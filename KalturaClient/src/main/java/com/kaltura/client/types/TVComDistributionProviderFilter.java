...
public class TVComDistributionProviderFilter extends TVComDistributionProviderBaseFilter {
    ...
    public static final Creator<TVComDistributionProviderFilter> CREATOR = new Creator<TVComDistributionProviderFilter>() {
        @Override
        public TVComDistributionProviderFilter createFromParcel(Parcel source) {
            return new TVComDistributionProviderFilter(source);
        }

        @Override
        public TVComDistributionProviderFilter[] newArray(int size) {
            return new TVComDistributionProviderFilter[size];
        }
    };

    public TVComDistributionProviderFilter(Parcel in) {
        super(in);
    }
}
