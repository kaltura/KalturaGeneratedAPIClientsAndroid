...
public class GenericDistributionProviderAction extends ObjectBase {
    ...
    public static final Creator<GenericDistributionProviderAction> CREATOR = new Creator<GenericDistributionProviderAction>() {
        @Override
        public GenericDistributionProviderAction createFromParcel(Parcel source) {
            return new GenericDistributionProviderAction(source);
        }

        @Override
        public GenericDistributionProviderAction[] newArray(int size) {
            return new GenericDistributionProviderAction[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.genericDistributionProviderId);
        dest.writeInt(this.action == null ? -1 : this.action.ordinal());
        dest.writeInt(this.status == null ? -1 : this.status.ordinal());
        dest.writeInt(this.resultsParser == null ? -1 : this.resultsParser.ordinal());
        ...
        dest.writeString(this.remoteUsername);
        dest.writeString(this.remotePassword);
        dest.writeString(this.editableFields);
        dest.writeString(this.mandatoryFields);
        dest.writeString(this.mrssTransformer);
        dest.writeString(this.mrssValidator);
        dest.writeString(this.resultsTransformer);
    }
    ...
    public GenericDistributionProviderAction(Parcel in) {
        ...
        this.status = tmpStatus == -1 ? null : GenericDistributionProviderStatus.values()[tmpStatus];
        int tmpResultsParser = in.readInt();
        this.resultsParser = tmpResultsParser == -1 ? null : GenericDistributionProviderParser.values()[tmpResultsParser];
        ...
        this.remoteUsername = in.readString();
        this.remotePassword = in.readString();
        this.editableFields = in.readString();
        this.mandatoryFields = in.readString();
        this.mrssTransformer = in.readString();
        this.mrssValidator = in.readString();
        this.resultsTransformer = in.readString();
    }
}
