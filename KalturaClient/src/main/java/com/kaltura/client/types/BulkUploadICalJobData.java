...
public class BulkUploadICalJobData extends BulkUploadScheduleEventJobData {
    ...
    public static final Creator<BulkUploadICalJobData> CREATOR = new Creator<BulkUploadICalJobData>() {
        @Override
        public BulkUploadICalJobData createFromParcel(Parcel source) {
            return new BulkUploadICalJobData(source);
        }

        @Override
        public BulkUploadICalJobData[] newArray(int size) {
            return new BulkUploadICalJobData[size];
        }
    };
    ...
    public BulkUploadICalJobData(Parcel in) {
        super(in);
