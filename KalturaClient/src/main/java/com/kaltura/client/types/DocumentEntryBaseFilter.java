...
public abstract class DocumentEntryBaseFilter extends BaseEntryFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.documentTypeEqual == null ? -1 : this.documentTypeEqual.ordinal());
        dest.writeString(this.documentTypeIn);
        dest.writeString(this.assetParamsIdsMatchOr);
        dest.writeString(this.assetParamsIdsMatchAnd);
    }

    public DocumentEntryBaseFilter(Parcel in) {
        super(in);
        int tmpDocumentTypeEqual = in.readInt();
        this.documentTypeEqual = tmpDocumentTypeEqual == -1 ? null : DocumentType.values()[tmpDocumentTypeEqual];
        this.documentTypeIn = in.readString();
