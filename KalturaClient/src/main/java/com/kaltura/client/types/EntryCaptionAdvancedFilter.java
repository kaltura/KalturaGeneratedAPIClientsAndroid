...
public class EntryCaptionAdvancedFilter extends SearchItem {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.accuracyGreaterThanOrEqual);
        dest.writeValue(this.accuracyLessThanOrEqual);
        dest.writeValue(this.accuracyGreaterThan);
        dest.writeValue(this.accuracyLessThan);
    ...
    public EntryCaptionAdvancedFilter(Parcel in) {
        ...
        this.accuracyGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.accuracyLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.accuracyGreaterThan = (Integer)in.readValue(Integer.class.getClassLoader());
        this.accuracyLessThan = (Integer)in.readValue(Integer.class.getClassLoader());
