...
public class DistributionThumbDimensions extends ObjectBase {
    ...
    public static final Creator<DistributionThumbDimensions> CREATOR = new Creator<DistributionThumbDimensions>() {
        @Override
        public DistributionThumbDimensions createFromParcel(Parcel source) {
            return new DistributionThumbDimensions(source);
        }

        @Override
        public DistributionThumbDimensions[] newArray(int size) {
            return new DistributionThumbDimensions[size];
        }
    };
    ...
    public DistributionThumbDimensions(Parcel in) {
        super(in);
