...
public class BeaconScheduledResourceSearchParams extends BeaconSearchParams {
    ...
    public static final Creator<BeaconScheduledResourceSearchParams> CREATOR = new Creator<BeaconScheduledResourceSearchParams>() {
        @Override
        public BeaconScheduledResourceSearchParams createFromParcel(Parcel source) {
            return new BeaconScheduledResourceSearchParams(source);
        }

        @Override
        public BeaconScheduledResourceSearchParams[] newArray(int size) {
            return new BeaconScheduledResourceSearchParams[size];
        }
    };
    ...
    public BeaconScheduledResourceSearchParams(Parcel in) {
        super(in);
        this.searchOperator = in.readParcelable(BeaconScheduledResourceOperator.class.getClassLoader());
        this.orderBy = in.readParcelable(BeaconSearchScheduledResourceOrderBy.class.getClassLoader());
    }
}
