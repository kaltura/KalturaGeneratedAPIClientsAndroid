...
public class ServerFileResource extends GenericDataCenterContentResource {
    ...
    public static final Creator<ServerFileResource> CREATOR = new Creator<ServerFileResource>() {
        @Override
        public ServerFileResource createFromParcel(Parcel source) {
            return new ServerFileResource(source);
        }

        @Override
        public ServerFileResource[] newArray(int size) {
            return new ServerFileResource[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.keepOriginalFile);
    }

    public ServerFileResource(Parcel in) {
        super(in);
        this.localFilePath = in.readString();
        this.keepOriginalFile = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
