...
public class StringHolder extends ObjectBase {
    ...
    public static final Creator<StringHolder> CREATOR = new Creator<StringHolder>() {
        @Override
        public StringHolder createFromParcel(Parcel source) {
            return new StringHolder(source);
        }
