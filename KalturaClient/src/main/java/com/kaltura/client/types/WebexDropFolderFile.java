...
public class WebexDropFolderFile extends DropFolderFile {
    ...
    public static final Creator<WebexDropFolderFile> CREATOR = new Creator<WebexDropFolderFile>() {
        @Override
        public WebexDropFolderFile createFromParcel(Parcel source) {
            return new WebexDropFolderFile(source);
        }

        @Override
        public WebexDropFolderFile[] newArray(int size) {
            return new WebexDropFolderFile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.recordingId);
    ...
    public WebexDropFolderFile(Parcel in) {
        super(in);
        this.recordingId = (Integer)in.readValue(Integer.class.getClassLoader());
