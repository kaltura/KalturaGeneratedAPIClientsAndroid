...
public class AttUverseDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<AttUverseDistributionProfile> CREATOR = new Creator<AttUverseDistributionProfile>() {
        @Override
        public AttUverseDistributionProfile createFromParcel(Parcel source) {
            return new AttUverseDistributionProfile(source);
        }

        @Override
        public AttUverseDistributionProfile[] newArray(int size) {
            return new AttUverseDistributionProfile[size];
        }
    };
    ...
    public AttUverseDistributionProfile(Parcel in) {
        super(in);
