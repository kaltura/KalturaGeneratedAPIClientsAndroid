...
public class FtpDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<FtpDistributionProfile> CREATOR = new Creator<FtpDistributionProfile>() {
        @Override
        public FtpDistributionProfile createFromParcel(Parcel source) {
            return new FtpDistributionProfile(source);
        }

        @Override
        public FtpDistributionProfile[] newArray(int size) {
            return new FtpDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.disableMetadata);
        dest.writeString(this.metadataXslt);
        dest.writeString(this.metadataFilenameXslt);
        dest.writeString(this.flavorAssetFilenameXslt);
        dest.writeString(this.thumbnailAssetFilenameXslt);
        dest.writeString(this.assetFilenameXslt);
        dest.writeString(this.dataContentFilenameXslt);
        dest.writeString(this.asperaPublicKey);
        dest.writeString(this.asperaPrivateKey);
        dest.writeValue(this.sendMetadataAfterAssets);
    }

    public FtpDistributionProfile(Parcel in) {
        super(in);
        ...
        this.disableMetadata = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.metadataXslt = in.readString();
        this.metadataFilenameXslt = in.readString();
        this.flavorAssetFilenameXslt = in.readString();
        this.thumbnailAssetFilenameXslt = in.readString();
        this.assetFilenameXslt = in.readString();
        this.dataContentFilenameXslt = in.readString();
        this.asperaPublicKey = in.readString();
        this.asperaPrivateKey = in.readString();
        this.sendMetadataAfterAssets = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
