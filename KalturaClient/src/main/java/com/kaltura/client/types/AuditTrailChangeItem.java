...
public class AuditTrailChangeItem extends ObjectBase {
    ...
    public static final Creator<AuditTrailChangeItem> CREATOR = new Creator<AuditTrailChangeItem>() {
        @Override
        public AuditTrailChangeItem createFromParcel(Parcel source) {
            return new AuditTrailChangeItem(source);
        }

        @Override
        public AuditTrailChangeItem[] newArray(int size) {
            return new AuditTrailChangeItem[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.descriptor);
        dest.writeString(this.oldValue);
        dest.writeString(this.newValue);
    }

    public AuditTrailChangeItem(Parcel in) {
        super(in);
        this.descriptor = in.readString();
