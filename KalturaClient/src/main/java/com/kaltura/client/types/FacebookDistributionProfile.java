...
public class FacebookDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<FacebookDistributionProfile> CREATOR = new Creator<FacebookDistributionProfile>() {
        @Override
        public FacebookDistributionProfile createFromParcel(Parcel source) {
            return new FacebookDistributionProfile(source);
        }

        @Override
        public FacebookDistributionProfile[] newArray(int size) {
            return new FacebookDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.pageAccessToken);
        dest.writeString(this.userAccessToken);
        dest.writeString(this.state);
        dest.writeString(this.permissions);
        dest.writeValue(this.reRequestPermissions);
    }

    public FacebookDistributionProfile(Parcel in) {
        super(in);
        this.apiAuthorizeUrl = in.readString();
        this.pageId = in.readString();
        this.pageAccessToken = in.readString();
        this.userAccessToken = in.readString();
        this.state = in.readString();
        this.permissions = in.readString();
        this.reRequestPermissions = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
