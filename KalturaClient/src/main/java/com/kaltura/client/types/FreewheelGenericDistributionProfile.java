...
public class FreewheelGenericDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<FreewheelGenericDistributionProfile> CREATOR = new Creator<FreewheelGenericDistributionProfile>() {
        @Override
        public FreewheelGenericDistributionProfile createFromParcel(Parcel source) {
            return new FreewheelGenericDistributionProfile(source);
        }

        @Override
        public FreewheelGenericDistributionProfile[] newArray(int size) {
            return new FreewheelGenericDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.contentOwner);
        dest.writeString(this.upstreamVideoId);
        dest.writeString(this.upstreamNetworkName);
        dest.writeString(this.upstreamNetworkId);
        dest.writeString(this.categoryId);
        dest.writeValue(this.replaceGroup);
        dest.writeValue(this.replaceAirDates);
    }

    public FreewheelGenericDistributionProfile(Parcel in) {
        super(in);
        this.apikey = in.readString();
        this.email = in.readString();
        this.sftpPass = in.readString();
        this.sftpLogin = in.readString();
        this.contentOwner = in.readString();
        this.upstreamVideoId = in.readString();
        this.upstreamNetworkName = in.readString();
        this.upstreamNetworkId = in.readString();
        this.categoryId = in.readString();
        this.replaceGroup = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.replaceAirDates = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
