...
public class StorageProfileFilter extends StorageProfileBaseFilter {
    ...
    public static final Creator<StorageProfileFilter> CREATOR = new Creator<StorageProfileFilter>() {
        @Override
        public StorageProfileFilter createFromParcel(Parcel source) {
            return new StorageProfileFilter(source);
        }

        @Override
        public StorageProfileFilter[] newArray(int size) {
            return new StorageProfileFilter[size];
        }
    };

    public StorageProfileFilter(Parcel in) {
        super(in);
    }
}
