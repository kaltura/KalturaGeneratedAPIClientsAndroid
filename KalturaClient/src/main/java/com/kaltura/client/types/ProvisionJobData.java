...
public class ProvisionJobData extends JobData {
    ...
    public static final Creator<ProvisionJobData> CREATOR = new Creator<ProvisionJobData>() {
        @Override
        public ProvisionJobData createFromParcel(Parcel source) {
            return new ProvisionJobData(source);
        }

        @Override
        public ProvisionJobData[] newArray(int size) {
            return new ProvisionJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.backupStreamID);
        dest.writeString(this.rtmp);
        dest.writeString(this.encoderIP);
        dest.writeString(this.backupEncoderIP);
        dest.writeString(this.encoderPassword);
        dest.writeString(this.encoderUsername);
        dest.writeValue(this.endDate);
        dest.writeString(this.returnVal);
    ...
    public ProvisionJobData(Parcel in) {
        super(in);
        this.streamID = in.readString();
        this.backupStreamID = in.readString();
        this.rtmp = in.readString();
        this.encoderIP = in.readString();
        this.backupEncoderIP = in.readString();
        this.encoderPassword = in.readString();
        this.encoderUsername = in.readString();
        this.endDate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.returnVal = in.readString();
