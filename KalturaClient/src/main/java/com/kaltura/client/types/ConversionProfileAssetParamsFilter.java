...
public class ConversionProfileAssetParamsFilter extends ConversionProfileAssetParamsBaseFilter {
    ...
    public static final Creator<ConversionProfileAssetParamsFilter> CREATOR = new Creator<ConversionProfileAssetParamsFilter>() {
        @Override
        public ConversionProfileAssetParamsFilter createFromParcel(Parcel source) {
            return new ConversionProfileAssetParamsFilter(source);
        }

        @Override
        public ConversionProfileAssetParamsFilter[] newArray(int size) {
            return new ConversionProfileAssetParamsFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.conversionProfileIdFilter, flags);
        dest.writeParcelable(this.assetParamsIdFilter, flags);
    }

    public ConversionProfileAssetParamsFilter(Parcel in) {
        super(in);
        this.conversionProfileIdFilter = in.readParcelable(ConversionProfileFilter.class.getClassLoader());
        this.assetParamsIdFilter = in.readParcelable(AssetParamsFilter.class.getClassLoader());
    }
}
