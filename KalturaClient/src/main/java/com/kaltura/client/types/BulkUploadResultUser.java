...
public class BulkUploadResultUser extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultUser> CREATOR = new Creator<BulkUploadResultUser>() {
        @Override
        public BulkUploadResultUser createFromParcel(Parcel source) {
            return new BulkUploadResultUser(source);
        }

        @Override
        public BulkUploadResultUser[] newArray(int size) {
            return new BulkUploadResultUser[size];
        }
    };
