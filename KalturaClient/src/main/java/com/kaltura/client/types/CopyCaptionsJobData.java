...
public class CopyCaptionsJobData extends JobData {
    ...
    public static final Creator<CopyCaptionsJobData> CREATOR = new Creator<CopyCaptionsJobData>() {
        @Override
        public CopyCaptionsJobData createFromParcel(Parcel source) {
            return new CopyCaptionsJobData(source);
        }

        @Override
        public CopyCaptionsJobData[] newArray(int size) {
            return new CopyCaptionsJobData[size];
        }
    };
