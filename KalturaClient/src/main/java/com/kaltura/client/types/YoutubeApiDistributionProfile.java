...
public class YoutubeApiDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<YoutubeApiDistributionProfile> CREATOR = new Creator<YoutubeApiDistributionProfile>() {
        @Override
        public YoutubeApiDistributionProfile createFromParcel(Parcel source) {
            return new YoutubeApiDistributionProfile(source);
        }

        @Override
        public YoutubeApiDistributionProfile[] newArray(int size) {
            return new YoutubeApiDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.defaultCategory);
        ...
        dest.writeValue(this.assumeSuccess);
        dest.writeString(this.privacyStatus);
    }

    public YoutubeApiDistributionProfile(Parcel in) {
        super(in);
        this.username = in.readString();
        this.defaultCategory = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        this.assumeSuccess = (Boolean)in.readValue(Boolean.class.getClassLoader());
