...
public class InteractivityDataFilter extends ObjectBase {
    ...
    public static final Creator<InteractivityDataFilter> CREATOR = new Creator<InteractivityDataFilter>() {
        @Override
        public InteractivityDataFilter createFromParcel(Parcel source) {
            return new InteractivityDataFilter(source);
        }

        @Override
        public InteractivityDataFilter[] newArray(int size) {
            return new InteractivityDataFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.rootFilter, flags);
        dest.writeParcelable(this.nodeFilter, flags);
        dest.writeParcelable(this.interactionFilter, flags);
    }

    public InteractivityDataFilter(Parcel in) {
        super(in);
        this.rootFilter = in.readParcelable(InteractivityRootFilter.class.getClassLoader());
        this.nodeFilter = in.readParcelable(InteractivityNodeFilter.class.getClassLoader());
        this.interactionFilter = in.readParcelable(InteractivityInteractionFilter.class.getClassLoader());
    }
}
