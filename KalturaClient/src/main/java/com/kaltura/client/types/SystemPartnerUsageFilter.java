...
public class SystemPartnerUsageFilter extends Filter {
    ...
    public static final Creator<SystemPartnerUsageFilter> CREATOR = new Creator<SystemPartnerUsageFilter>() {
        @Override
        public SystemPartnerUsageFilter createFromParcel(Parcel source) {
            return new SystemPartnerUsageFilter(source);
        }

        @Override
        public SystemPartnerUsageFilter[] newArray(int size) {
            return new SystemPartnerUsageFilter[size];
        }
    };
    ...
    public SystemPartnerUsageFilter(Parcel in) {
        super(in);
