...
public class UrlTokenizerAkamaiRtsp extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerAkamaiRtsp> CREATOR = new Creator<UrlTokenizerAkamaiRtsp>() {
        @Override
        public UrlTokenizerAkamaiRtsp createFromParcel(Parcel source) {
            return new UrlTokenizerAkamaiRtsp(source);
        }

        @Override
        public UrlTokenizerAkamaiRtsp[] newArray(int size) {
            return new UrlTokenizerAkamaiRtsp[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.cpcode);
    }

    public UrlTokenizerAkamaiRtsp(Parcel in) {
        super(in);
        this.host = in.readString();
        this.cpcode = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
