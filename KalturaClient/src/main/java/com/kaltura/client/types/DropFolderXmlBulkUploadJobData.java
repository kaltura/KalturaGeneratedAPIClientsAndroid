...
public class DropFolderXmlBulkUploadJobData extends BulkUploadXmlJobData {
    ...
    public static final Creator<DropFolderXmlBulkUploadJobData> CREATOR = new Creator<DropFolderXmlBulkUploadJobData>() {
        @Override
        public DropFolderXmlBulkUploadJobData createFromParcel(Parcel source) {
            return new DropFolderXmlBulkUploadJobData(source);
        }

        @Override
        public DropFolderXmlBulkUploadJobData[] newArray(int size) {
            return new DropFolderXmlBulkUploadJobData[size];
        }
    };
    ...
    public DropFolderXmlBulkUploadJobData(Parcel in) {
        super(in);
