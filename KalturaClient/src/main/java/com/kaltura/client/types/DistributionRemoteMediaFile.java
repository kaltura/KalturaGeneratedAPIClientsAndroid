...
public class DistributionRemoteMediaFile extends ObjectBase {
    ...
    public static final Creator<DistributionRemoteMediaFile> CREATOR = new Creator<DistributionRemoteMediaFile>() {
        @Override
        public DistributionRemoteMediaFile createFromParcel(Parcel source) {
            return new DistributionRemoteMediaFile(source);
        }

        @Override
        public DistributionRemoteMediaFile[] newArray(int size) {
            return new DistributionRemoteMediaFile[size];
        }
    };
    ...
    public DistributionRemoteMediaFile(Parcel in) {
        super(in);
