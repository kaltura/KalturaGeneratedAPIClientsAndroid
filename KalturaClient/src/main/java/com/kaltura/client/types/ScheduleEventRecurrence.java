...
public class ScheduleEventRecurrence extends ObjectBase {
    ...
    public static final Creator<ScheduleEventRecurrence> CREATOR = new Creator<ScheduleEventRecurrence>() {
        @Override
        public ScheduleEventRecurrence createFromParcel(Parcel source) {
            return new ScheduleEventRecurrence(source);
        }

        @Override
        public ScheduleEventRecurrence[] newArray(int size) {
            return new ScheduleEventRecurrence[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.until);
        dest.writeString(this.timeZone);
        dest.writeValue(this.count);
        dest.writeValue(this.interval);
        dest.writeString(this.bySecond);
        dest.writeString(this.byMinute);
        dest.writeString(this.byHour);
        dest.writeString(this.byDay);
        dest.writeString(this.byMonthDay);
        dest.writeString(this.byYearDay);
        dest.writeString(this.byWeekNumber);
        dest.writeString(this.byMonth);
        dest.writeString(this.byOffset);
        dest.writeInt(this.weekStartDay == null ? -1 : this.weekStartDay.ordinal());
    }

    public ScheduleEventRecurrence(Parcel in) {
        super(in);
        ...
        this.bySecond = in.readString();
        this.byMinute = in.readString();
        this.byHour = in.readString();
        this.byDay = in.readString();
        this.byMonthDay = in.readString();
        this.byYearDay = in.readString();
        this.byWeekNumber = in.readString();
        this.byMonth = in.readString();
        this.byOffset = in.readString();
        int tmpWeekStartDay = in.readInt();
        this.weekStartDay = tmpWeekStartDay == -1 ? null : ScheduleEventRecurrenceDay.values()[tmpWeekStartDay];
    }
}
