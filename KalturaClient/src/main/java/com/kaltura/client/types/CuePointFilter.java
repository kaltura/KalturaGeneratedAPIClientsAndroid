...
public class CuePointFilter extends CuePointBaseFilter {
    ...
    public static final Creator<CuePointFilter> CREATOR = new Creator<CuePointFilter>() {
        @Override
        public CuePointFilter createFromParcel(Parcel source) {
            return new CuePointFilter(source);
        }

        @Override
        public CuePointFilter[] newArray(int size) {
            return new CuePointFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.userIdCurrent);
    }
    ...
    public CuePointFilter(Parcel in) {
        ...
        this.userIdCurrent = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
