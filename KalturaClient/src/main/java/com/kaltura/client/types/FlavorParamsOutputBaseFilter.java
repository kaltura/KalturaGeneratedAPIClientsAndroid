...
public abstract class FlavorParamsOutputBaseFilter extends FlavorParamsFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.flavorParamsIdEqual);
        dest.writeString(this.flavorParamsVersionEqual);
        dest.writeString(this.flavorAssetIdEqual);
        dest.writeString(this.flavorAssetVersionEqual);
    }

    public FlavorParamsOutputBaseFilter(Parcel in) {
        super(in);
        this.flavorParamsIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.flavorParamsVersionEqual = in.readString();
        this.flavorAssetIdEqual = in.readString();
        this.flavorAssetVersionEqual = in.readString();
    }
}
