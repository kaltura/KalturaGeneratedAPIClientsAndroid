...
public class UnicornDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<UnicornDistributionProfile> CREATOR = new Creator<UnicornDistributionProfile>() {
        @Override
        public UnicornDistributionProfile createFromParcel(Parcel source) {
            return new UnicornDistributionProfile(source);
        }

        @Override
        public UnicornDistributionProfile[] newArray(int size) {
            return new UnicornDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.apiHostUrl);
        dest.writeString(this.domainGuid);
        dest.writeString(this.adFreeApplicationGuid);
        dest.writeValue(this.remoteAssetParamsId);
        dest.writeString(this.storageProfileId);
    }

    public UnicornDistributionProfile(Parcel in) {
        super(in);
        this.username = in.readString();
        this.password = in.readString();
        this.domainName = in.readString();
        this.channelGuid = in.readString();
        this.apiHostUrl = in.readString();
        this.domainGuid = in.readString();
        this.adFreeApplicationGuid = in.readString();
        this.remoteAssetParamsId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.storageProfileId = in.readString();
    }
}
