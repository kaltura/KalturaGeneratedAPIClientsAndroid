...
public class IdeticDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<IdeticDistributionJobProviderData> CREATOR = new Creator<IdeticDistributionJobProviderData>() {
        @Override
        public IdeticDistributionJobProviderData createFromParcel(Parcel source) {
            return new IdeticDistributionJobProviderData(source);
        }

        @Override
        public IdeticDistributionJobProviderData[] newArray(int size) {
            return new IdeticDistributionJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.flavorAssetUrl);
    }

    public IdeticDistributionJobProviderData(Parcel in) {
        super(in);
        this.thumbnailUrl = in.readString();
        this.flavorAssetUrl = in.readString();
    }
}
