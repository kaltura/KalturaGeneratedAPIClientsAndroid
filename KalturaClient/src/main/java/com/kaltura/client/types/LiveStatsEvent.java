...
public class LiveStatsEvent extends ObjectBase {
    ...
    public static final Creator<LiveStatsEvent> CREATOR = new Creator<LiveStatsEvent>() {
        @Override
        public LiveStatsEvent createFromParcel(Parcel source) {
            return new LiveStatsEvent(source);
        }

        @Override
        public LiveStatsEvent[] newArray(int size) {
            return new LiveStatsEvent[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.eventIndex);
        ...
        dest.writeInt(this.deliveryType == null ? -1 : this.deliveryType.ordinal());
    }

    public LiveStatsEvent(Parcel in) {
        super(in);
        this.partnerId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.entryId = in.readString();
        int tmpEventType = in.readInt();
        this.eventType = tmpEventType == -1 ? null : LiveStatsEventType.values()[tmpEventType];
        this.sessionId = in.readString();
        this.eventIndex = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        int tmpDeliveryType = in.readInt();
        this.deliveryType = tmpDeliveryType == -1 ? null : PlaybackProtocol.values()[tmpDeliveryType];
    }
}
