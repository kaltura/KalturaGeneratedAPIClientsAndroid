...
public class EntryLiveStats extends LiveStats {
    ...
    public static final Creator<EntryLiveStats> CREATOR = new Creator<EntryLiveStats>() {
        @Override
        public EntryLiveStats createFromParcel(Parcel source) {
            return new EntryLiveStats(source);
        }

        @Override
        public EntryLiveStats[] newArray(int size) {
            return new EntryLiveStats[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.peakAudience);
        dest.writeValue(this.peakDvrAudience);
    }

    public EntryLiveStats(Parcel in) {
        super(in);
        this.entryId = in.readString();
        this.peakAudience = (Integer)in.readValue(Integer.class.getClassLoader());
        this.peakDvrAudience = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
