...
public class MetroPcsDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<MetroPcsDistributionProfile> CREATOR = new Creator<MetroPcsDistributionProfile>() {
        @Override
        public MetroPcsDistributionProfile createFromParcel(Parcel source) {
            return new MetroPcsDistributionProfile(source);
        }

        @Override
        public MetroPcsDistributionProfile[] newArray(int size) {
            return new MetroPcsDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.entitlements);
        dest.writeString(this.rating);
        dest.writeString(this.itemType);
    }

    public MetroPcsDistributionProfile(Parcel in) {
        super(in);
        ...
        this.entitlements = in.readString();
