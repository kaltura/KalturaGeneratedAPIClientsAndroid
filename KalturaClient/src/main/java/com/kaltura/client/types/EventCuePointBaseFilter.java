...
public abstract class EventCuePointBaseFilter extends CuePointFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.eventTypeEqual == null ? -1 : this.eventTypeEqual.ordinal());
        dest.writeString(this.eventTypeIn);
    }

    public EventCuePointBaseFilter(Parcel in) {
        super(in);
        int tmpEventTypeEqual = in.readInt();
        this.eventTypeEqual = tmpEventTypeEqual == -1 ? null : EventType.values()[tmpEventTypeEqual];
