...
public abstract class MetadataBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.metadataProfileIdEqual);
        dest.writeString(this.metadataProfileIdIn);
        dest.writeValue(this.metadataProfileVersionEqual);
        dest.writeValue(this.metadataProfileVersionGreaterThanOrEqual);
        dest.writeValue(this.metadataProfileVersionLessThanOrEqual);
        ...
        dest.writeValue(this.versionGreaterThanOrEqual);
        dest.writeValue(this.versionLessThanOrEqual);
    ...
    public MetadataBaseFilter(Parcel in) {
        super(in);
        this.partnerIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.metadataProfileIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.metadataProfileIdIn = in.readString();
        this.metadataProfileVersionEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.metadataProfileVersionGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.metadataProfileVersionLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
