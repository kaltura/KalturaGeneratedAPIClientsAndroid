...
public class KontikiStorageDeleteJobData extends StorageDeleteJobData {
    ...
    public static final Creator<KontikiStorageDeleteJobData> CREATOR = new Creator<KontikiStorageDeleteJobData>() {
        @Override
        public KontikiStorageDeleteJobData createFromParcel(Parcel source) {
            return new KontikiStorageDeleteJobData(source);
        }

        @Override
        public KontikiStorageDeleteJobData[] newArray(int size) {
            return new KontikiStorageDeleteJobData[size];
        }
    };
    ...
    public KontikiStorageDeleteJobData(Parcel in) {
        super(in);
