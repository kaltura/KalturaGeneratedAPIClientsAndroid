...
public class CaptionAssetItemFilter extends CaptionAssetFilter {
    ...
    public static final Creator<CaptionAssetItemFilter> CREATOR = new Creator<CaptionAssetItemFilter>() {
        @Override
        public CaptionAssetItemFilter createFromParcel(Parcel source) {
            return new CaptionAssetItemFilter(source);
        }

        @Override
        public CaptionAssetItemFilter[] newArray(int size) {
            return new CaptionAssetItemFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.contentLike);
        dest.writeString(this.contentMultiLikeOr);
        dest.writeString(this.contentMultiLikeAnd);
        dest.writeString(this.partnerDescriptionLike);
        dest.writeString(this.partnerDescriptionMultiLikeOr);
        dest.writeString(this.partnerDescriptionMultiLikeAnd);
        dest.writeInt(this.languageEqual == null ? -1 : this.languageEqual.ordinal());
        dest.writeString(this.languageIn);
        ...
        dest.writeValue(this.endTimeGreaterThanOrEqual);
        dest.writeValue(this.endTimeLessThanOrEqual);
    }

    public CaptionAssetItemFilter(Parcel in) {
        super(in);
        this.contentLike = in.readString();
        this.contentMultiLikeOr = in.readString();
        this.contentMultiLikeAnd = in.readString();
        this.partnerDescriptionLike = in.readString();
        this.partnerDescriptionMultiLikeOr = in.readString();
        this.partnerDescriptionMultiLikeAnd = in.readString();
        int tmpLanguageEqual = in.readInt();
        this.languageEqual = tmpLanguageEqual == -1 ? null : Language.values()[tmpLanguageEqual];
        this.languageIn = in.readString();
        ...
        this.endTimeGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
