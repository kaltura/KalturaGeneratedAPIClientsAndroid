...
public class EntryCaptionAssetSearchItem extends SearchItem {
    ...
    public static final Creator<EntryCaptionAssetSearchItem> CREATOR = new Creator<EntryCaptionAssetSearchItem>() {
        @Override
        public EntryCaptionAssetSearchItem createFromParcel(Parcel source) {
            return new EntryCaptionAssetSearchItem(source);
        }

        @Override
        public EntryCaptionAssetSearchItem[] newArray(int size) {
            return new EntryCaptionAssetSearchItem[size];
        }
    };
    ...
    public EntryCaptionAssetSearchItem(Parcel in) {
        super(in);
