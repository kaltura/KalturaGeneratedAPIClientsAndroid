...
public class LiveToVodJobData extends JobData {
    ...
    public static final Creator<LiveToVodJobData> CREATOR = new Creator<LiveToVodJobData>() {
        @Override
        public LiveToVodJobData createFromParcel(Parcel source) {
            return new LiveToVodJobData(source);
        }

        @Override
        public LiveToVodJobData[] newArray(int size) {
            return new LiveToVodJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.totalVodDuration);
        dest.writeValue(this.lastSegmentDuration);
        dest.writeString(this.amfArray);
        dest.writeValue(this.lastCuePointSyncTime);
        dest.writeValue(this.lastSegmentDrift);
    }

    public LiveToVodJobData(Parcel in) {
        super(in);
