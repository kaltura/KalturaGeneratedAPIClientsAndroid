...
public class EntryResource extends ContentResource {
    ...
    public static final Creator<EntryResource> CREATOR = new Creator<EntryResource>() {
        @Override
        public EntryResource createFromParcel(Parcel source) {
            return new EntryResource(source);
        }

        @Override
        public EntryResource[] newArray(int size) {
            return new EntryResource[size];
        }
    };
    ...
    public EntryResource(Parcel in) {
        super(in);
