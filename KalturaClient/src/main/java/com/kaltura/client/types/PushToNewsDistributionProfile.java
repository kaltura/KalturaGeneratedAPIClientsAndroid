...
public class PushToNewsDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<PushToNewsDistributionProfile> CREATOR = new Creator<PushToNewsDistributionProfile>() {
        @Override
        public PushToNewsDistributionProfile createFromParcel(Parcel source) {
            return new PushToNewsDistributionProfile(source);
        }

        @Override
        public PushToNewsDistributionProfile[] newArray(int size) {
            return new PushToNewsDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.namedItem);
        dest.writeString(this.certificateKey);
        dest.writeString(this.bodyXslt);
        dest.writeValue(this.recentNewsTimeInterval);
    }

    public PushToNewsDistributionProfile(Parcel in) {
        super(in);
        ...
        this.namedItem = in.readString();
        this.certificateKey = in.readString();
        this.bodyXslt = in.readString();
        this.recentNewsTimeInterval = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
