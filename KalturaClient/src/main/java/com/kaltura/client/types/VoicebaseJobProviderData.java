...
public class VoicebaseJobProviderData extends IntegrationJobProviderData {
    ...
    public static final Creator<VoicebaseJobProviderData> CREATOR = new Creator<VoicebaseJobProviderData>() {
        @Override
        public VoicebaseJobProviderData createFromParcel(Parcel source) {
            return new VoicebaseJobProviderData(source);
        }

        @Override
        public VoicebaseJobProviderData[] newArray(int size) {
            return new VoicebaseJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.apiPassword);
