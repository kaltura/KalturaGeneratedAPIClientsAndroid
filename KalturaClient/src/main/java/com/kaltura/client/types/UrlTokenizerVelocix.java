...
public class UrlTokenizerVelocix extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerVelocix> CREATOR = new Creator<UrlTokenizerVelocix>() {
        @Override
        public UrlTokenizerVelocix createFromParcel(Parcel source) {
            return new UrlTokenizerVelocix(source);
        }

        @Override
        public UrlTokenizerVelocix[] newArray(int size) {
            return new UrlTokenizerVelocix[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.hdsPaths);
        dest.writeString(this.paramName);
        dest.writeString(this.authPrefix);
    }

    public UrlTokenizerVelocix(Parcel in) {
        super(in);
        this.hdsPaths = in.readString();
        this.paramName = in.readString();
        this.authPrefix = in.readString();
    }
}
