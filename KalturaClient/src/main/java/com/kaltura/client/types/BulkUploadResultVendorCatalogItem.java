...
public class BulkUploadResultVendorCatalogItem extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultVendorCatalogItem> CREATOR = new Creator<BulkUploadResultVendorCatalogItem>() {
        @Override
        public BulkUploadResultVendorCatalogItem createFromParcel(Parcel source) {
            return new BulkUploadResultVendorCatalogItem(source);
        }

        @Override
        public BulkUploadResultVendorCatalogItem[] newArray(int size) {
            return new BulkUploadResultVendorCatalogItem[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.vendorCatalogItemId);
    ...
    public BulkUploadResultVendorCatalogItem(Parcel in) {
        super(in);
        this.vendorCatalogItemId = (Integer)in.readValue(Integer.class.getClassLoader());
