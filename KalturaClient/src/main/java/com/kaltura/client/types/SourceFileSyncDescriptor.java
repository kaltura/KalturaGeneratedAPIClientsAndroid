...
public class SourceFileSyncDescriptor extends FileSyncDescriptor {
    ...
    public static final Creator<SourceFileSyncDescriptor> CREATOR = new Creator<SourceFileSyncDescriptor>() {
        @Override
        public SourceFileSyncDescriptor createFromParcel(Parcel source) {
            return new SourceFileSyncDescriptor(source);
        }

        @Override
        public SourceFileSyncDescriptor[] newArray(int size) {
            return new SourceFileSyncDescriptor[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.actualFileSyncLocalPath);
        dest.writeString(this.assetId);
        dest.writeValue(this.assetParamsId);
    }

    public SourceFileSyncDescriptor(Parcel in) {
        super(in);
        this.actualFileSyncLocalPath = in.readString();
