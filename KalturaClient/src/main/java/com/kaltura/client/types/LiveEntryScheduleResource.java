...
public class LiveEntryScheduleResource extends ScheduleResource {
    ...
    public static final Creator<LiveEntryScheduleResource> CREATOR = new Creator<LiveEntryScheduleResource>() {
        @Override
        public LiveEntryScheduleResource createFromParcel(Parcel source) {
            return new LiveEntryScheduleResource(source);
        }

        @Override
        public LiveEntryScheduleResource[] newArray(int size) {
            return new LiveEntryScheduleResource[size];
        }
    };
    ...
    public LiveEntryScheduleResource(Parcel in) {
        super(in);
