...
public class YouTubeDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<YouTubeDistributionProfile> CREATOR = new Creator<YouTubeDistributionProfile>() {
        @Override
        public YouTubeDistributionProfile createFromParcel(Parcel source) {
            return new YouTubeDistributionProfile(source);
        }

        @Override
        public YouTubeDistributionProfile[] newArray(int size) {
            return new YouTubeDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.feedSpecVersion == null ? -1 : this.feedSpecVersion.ordinal());
        dest.writeString(this.username);
        dest.writeString(this.notificationEmail);
        dest.writeString(this.sftpHost);
        dest.writeValue(this.sftpPort);
        dest.writeString(this.sftpLogin);
        dest.writeString(this.sftpPublicKey);
        dest.writeString(this.sftpPrivateKey);
        dest.writeString(this.sftpBaseDir);
        dest.writeString(this.ownerName);
        dest.writeString(this.defaultCategory);
        dest.writeString(this.allowComments);
        dest.writeString(this.allowEmbedding);
        dest.writeString(this.allowRatings);
        dest.writeString(this.allowResponses);
        dest.writeString(this.commercialPolicy);
        dest.writeString(this.ugcPolicy);
        dest.writeString(this.target);
        dest.writeString(this.adServerPartnerId);
        dest.writeValue(this.enableAdServer);
        dest.writeValue(this.allowPreRollAds);
        dest.writeValue(this.allowPostRollAds);
        dest.writeString(this.strict);
        dest.writeString(this.overrideManualEdits);
        dest.writeString(this.urgentReference);
        dest.writeString(this.allowSyndication);
        dest.writeString(this.hideViewCount);
        dest.writeString(this.allowAdsenseForVideo);
        dest.writeString(this.allowInvideo);
        dest.writeValue(this.allowMidRollAds);
        dest.writeString(this.instreamStandard);
        dest.writeString(this.instreamTrueview);
        dest.writeString(this.claimType);
        dest.writeString(this.blockOutsideOwnership);
        dest.writeString(this.captionAutosync);
        dest.writeValue(this.deleteReference);
        dest.writeValue(this.releaseClaims);
        dest.writeString(this.apiAuthorizeUrl);
        dest.writeString(this.privacyStatus);
        dest.writeString(this.enableContentId);
        dest.writeString(this.thirdPartyAds);
        dest.writeString(this.productListingAds);
        dest.writeString(this.domainWhitelist);
        dest.writeString(this.notifySubscribers);
    }

    public YouTubeDistributionProfile(Parcel in) {
        super(in);
        int tmpFeedSpecVersion = in.readInt();
        this.feedSpecVersion = tmpFeedSpecVersion == -1 ? null : YouTubeDistributionFeedSpecVersion.values()[tmpFeedSpecVersion];
        this.username = in.readString();
        this.notificationEmail = in.readString();
        this.sftpHost = in.readString();
        this.sftpPort = (Integer)in.readValue(Integer.class.getClassLoader());
        this.sftpLogin = in.readString();
        this.sftpPublicKey = in.readString();
        this.sftpPrivateKey = in.readString();
        this.sftpBaseDir = in.readString();
        this.ownerName = in.readString();
        this.defaultCategory = in.readString();
        this.allowComments = in.readString();
        this.allowEmbedding = in.readString();
        this.allowRatings = in.readString();
        this.allowResponses = in.readString();
        this.commercialPolicy = in.readString();
        this.ugcPolicy = in.readString();
        this.target = in.readString();
        this.adServerPartnerId = in.readString();
        this.enableAdServer = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.allowPreRollAds = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.allowPostRollAds = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.strict = in.readString();
        this.overrideManualEdits = in.readString();
        this.urgentReference = in.readString();
        this.allowSyndication = in.readString();
        this.hideViewCount = in.readString();
        this.allowAdsenseForVideo = in.readString();
        this.allowInvideo = in.readString();
        this.allowMidRollAds = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.instreamStandard = in.readString();
        this.instreamTrueview = in.readString();
        this.claimType = in.readString();
        this.blockOutsideOwnership = in.readString();
        this.captionAutosync = in.readString();
        this.deleteReference = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.releaseClaims = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.apiAuthorizeUrl = in.readString();
        this.privacyStatus = in.readString();
        this.enableContentId = in.readString();
        this.thirdPartyAds = in.readString();
        this.productListingAds = in.readString();
        this.domainWhitelist = in.readString();
        this.notifySubscribers = in.readString();
    }
}
