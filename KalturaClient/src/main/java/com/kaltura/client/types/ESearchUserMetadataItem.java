...
public class ESearchUserMetadataItem extends ESearchAbstractUserItem {
    ...
    public static final Creator<ESearchUserMetadataItem> CREATOR = new Creator<ESearchUserMetadataItem>() {
        @Override
        public ESearchUserMetadataItem createFromParcel(Parcel source) {
            return new ESearchUserMetadataItem(source);
        }

        @Override
        public ESearchUserMetadataItem[] newArray(int size) {
            return new ESearchUserMetadataItem[size];
        }
    };
    ...
    public ESearchUserMetadataItem(Parcel in) {
        super(in);
