...
public class MetroPcsDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<MetroPcsDistributionJobProviderData> CREATOR = new Creator<MetroPcsDistributionJobProviderData>() {
        @Override
        public MetroPcsDistributionJobProviderData createFromParcel(Parcel source) {
            return new MetroPcsDistributionJobProviderData(source);
        }

        @Override
        public MetroPcsDistributionJobProviderData[] newArray(int size) {
            return new MetroPcsDistributionJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.assetLocalPaths);
        dest.writeString(this.thumbUrls);
    }

    public MetroPcsDistributionJobProviderData(Parcel in) {
        super(in);
        this.assetLocalPaths = in.readString();
