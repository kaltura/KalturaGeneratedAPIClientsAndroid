...
public class UrlTokenizerAkamaiSecureHd extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerAkamaiSecureHd> CREATOR = new Creator<UrlTokenizerAkamaiSecureHd>() {
        @Override
        public UrlTokenizerAkamaiSecureHd createFromParcel(Parcel source) {
            return new UrlTokenizerAkamaiSecureHd(source);
        }

        @Override
        public UrlTokenizerAkamaiSecureHd[] newArray(int size) {
            return new UrlTokenizerAkamaiSecureHd[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.aclPostfix);
        dest.writeString(this.customPostfixes);
        dest.writeString(this.useCookieHosts);
        dest.writeString(this.rootDir);
    }

    public UrlTokenizerAkamaiSecureHd(Parcel in) {
        super(in);
        this.paramName = in.readString();
        this.aclPostfix = in.readString();
        this.customPostfixes = in.readString();
        this.useCookieHosts = in.readString();
