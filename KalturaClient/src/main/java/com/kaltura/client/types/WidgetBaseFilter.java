...
public abstract class WidgetBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.sourceWidgetIdEqual);
        dest.writeString(this.rootWidgetIdEqual);
        dest.writeValue(this.partnerIdEqual);
        dest.writeString(this.entryIdEqual);
        dest.writeValue(this.uiConfIdEqual);
        ...
        dest.writeString(this.partnerDataLike);
    }

    public WidgetBaseFilter(Parcel in) {
        super(in);
        this.idEqual = in.readString();
        this.idIn = in.readString();
        this.sourceWidgetIdEqual = in.readString();
        this.rootWidgetIdEqual = in.readString();
        this.partnerIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.entryIdEqual = in.readString();
        this.uiConfIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        this.partnerDataLike = in.readString();
    }
}
