...
public class FileSyncResource extends ContentResource {
    ...
    public static final Creator<FileSyncResource> CREATOR = new Creator<FileSyncResource>() {
        @Override
        public FileSyncResource createFromParcel(Parcel source) {
            return new FileSyncResource(source);
        }

        @Override
        public FileSyncResource[] newArray(int size) {
            return new FileSyncResource[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.fileSyncObjectType);
    ...
    public FileSyncResource(Parcel in) {
        super(in);
        this.fileSyncObjectType = (Integer)in.readValue(Integer.class.getClassLoader());
