...
public class LiveStreamPushPublishConfiguration extends ObjectBase {
    ...
    public static final Creator<LiveStreamPushPublishConfiguration> CREATOR = new Creator<LiveStreamPushPublishConfiguration>() {
        @Override
        public LiveStreamPushPublishConfiguration createFromParcel(Parcel source) {
            return new LiveStreamPushPublishConfiguration(source);
        }

        @Override
        public LiveStreamPushPublishConfiguration[] newArray(int size) {
            return new LiveStreamPushPublishConfiguration[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.backupPublishUrl);
        dest.writeString(this.port);
    }

    public LiveStreamPushPublishConfiguration(Parcel in) {
        super(in);
        this.publishUrl = in.readString();
        this.backupPublishUrl = in.readString();
