...
public class FacebookCaptionDistributionInfo extends ObjectBase {
    ...
    public static final Creator<FacebookCaptionDistributionInfo> CREATOR = new Creator<FacebookCaptionDistributionInfo>() {
        @Override
        public FacebookCaptionDistributionInfo createFromParcel(Parcel source) {
            return new FacebookCaptionDistributionInfo(source);
        }

        @Override
        public FacebookCaptionDistributionInfo[] newArray(int size) {
            return new FacebookCaptionDistributionInfo[size];
        }
    };
    ...
    public FacebookCaptionDistributionInfo(Parcel in) {
        super(in);
