...
public class MoveCategoryEntriesJobData extends JobData {
    ...
    public static final Creator<MoveCategoryEntriesJobData> CREATOR = new Creator<MoveCategoryEntriesJobData>() {
        @Override
        public MoveCategoryEntriesJobData createFromParcel(Parcel source) {
            return new MoveCategoryEntriesJobData(source);
        }

        @Override
        public MoveCategoryEntriesJobData[] newArray(int size) {
            return new MoveCategoryEntriesJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.srcCategoryId);
        dest.writeValue(this.destCategoryId);
        dest.writeValue(this.lastMovedCategoryId);
        dest.writeValue(this.lastMovedCategoryPageIndex);
        dest.writeValue(this.lastMovedCategoryEntryPageIndex);
        dest.writeValue(this.moveFromChildren);
        dest.writeString(this.destCategoryFullIds);
    }

    public MoveCategoryEntriesJobData(Parcel in) {
        super(in);
        this.srcCategoryId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.destCategoryId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lastMovedCategoryId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lastMovedCategoryPageIndex = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lastMovedCategoryEntryPageIndex = (Integer)in.readValue(Integer.class.getClassLoader());
        this.moveFromChildren = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.destCategoryFullIds = in.readString();
    }
}
