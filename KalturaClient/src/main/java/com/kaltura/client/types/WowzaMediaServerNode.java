...
public class WowzaMediaServerNode extends MediaServerNode {
    ...
    public static final Creator<WowzaMediaServerNode> CREATOR = new Creator<WowzaMediaServerNode>() {
        @Override
        public WowzaMediaServerNode createFromParcel(Parcel source) {
            return new WowzaMediaServerNode(source);
        }

        @Override
        public WowzaMediaServerNode[] newArray(int size) {
            return new WowzaMediaServerNode[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.appPrefix);
        dest.writeString(this.transcoder);
        dest.writeValue(this.GPUID);
        dest.writeValue(this.liveServicePort);
        dest.writeString(this.liveServiceProtocol);
        dest.writeString(this.liveServiceInternalDomain);
    }

    public WowzaMediaServerNode(Parcel in) {
        super(in);
        this.appPrefix = in.readString();
        this.transcoder = in.readString();
        this.GPUID = (Integer)in.readValue(Integer.class.getClassLoader());
        this.liveServicePort = (Integer)in.readValue(Integer.class.getClassLoader());
        this.liveServiceProtocol = in.readString();
        this.liveServiceInternalDomain = in.readString();
    }
}
