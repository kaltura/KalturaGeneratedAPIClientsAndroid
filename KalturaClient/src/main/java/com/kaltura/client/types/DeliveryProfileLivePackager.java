...
public class DeliveryProfileLivePackager extends DeliveryProfile {
    ...
    public static final Creator<DeliveryProfileLivePackager> CREATOR = new Creator<DeliveryProfileLivePackager>() {
        @Override
        public DeliveryProfileLivePackager createFromParcel(Parcel source) {
            return new DeliveryProfileLivePackager(source);
        }

        @Override
        public DeliveryProfileLivePackager[] newArray(int size) {
            return new DeliveryProfileLivePackager[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.livePackagerSigningDomain);
    }

    public DeliveryProfileLivePackager(Parcel in) {
        super(in);
        this.livePackagerSigningDomain = in.readString();
    }
}
