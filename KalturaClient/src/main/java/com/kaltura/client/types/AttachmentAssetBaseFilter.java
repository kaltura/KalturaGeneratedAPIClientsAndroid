...
public abstract class AttachmentAssetBaseFilter extends AssetFilter {
    ...
    public AttachmentAssetBaseFilter(Parcel in) {
        super(in);
        int tmpFormatEqual = in.readInt();
        this.formatEqual = tmpFormatEqual == -1 ? null : AttachmentType.values()[tmpFormatEqual];
        this.formatIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : AttachmentAssetStatus.values()[tmpStatusEqual];
