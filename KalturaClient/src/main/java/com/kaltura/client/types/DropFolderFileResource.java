...
public class DropFolderFileResource extends GenericDataCenterContentResource {
    ...
    public static final Creator<DropFolderFileResource> CREATOR = new Creator<DropFolderFileResource>() {
        @Override
        public DropFolderFileResource createFromParcel(Parcel source) {
            return new DropFolderFileResource(source);
        }

        @Override
        public DropFolderFileResource[] newArray(int size) {
            return new DropFolderFileResource[size];
        }
    };
    ...
    public DropFolderFileResource(Parcel in) {
        super(in);
