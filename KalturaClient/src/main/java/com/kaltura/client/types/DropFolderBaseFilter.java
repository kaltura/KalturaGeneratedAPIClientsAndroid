...
public abstract class DropFolderBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.conversionProfileIdIn);
        dest.writeValue(this.dcEqual);
        dest.writeString(this.dcIn);
        dest.writeString(this.pathEqual);
        dest.writeString(this.pathLike);
        dest.writeInt(this.fileHandlerTypeEqual == null ? -1 : this.fileHandlerTypeEqual.ordinal());
        dest.writeString(this.fileHandlerTypeIn);
        dest.writeString(this.fileNamePatternsLike);
        dest.writeString(this.fileNamePatternsMultiLikeOr);
        dest.writeString(this.fileNamePatternsMultiLikeAnd);
    ...
    public DropFolderBaseFilter(Parcel in) {
        super(in);
        ...
        this.typeEqual = tmpTypeEqual == -1 ? null : DropFolderType.values()[tmpTypeEqual];
        this.typeIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : DropFolderStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        this.conversionProfileIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.conversionProfileIdIn = in.readString();
        this.dcEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.dcIn = in.readString();
        this.pathEqual = in.readString();
        this.pathLike = in.readString();
        int tmpFileHandlerTypeEqual = in.readInt();
        this.fileHandlerTypeEqual = tmpFileHandlerTypeEqual == -1 ? null : DropFolderFileHandlerType.values()[tmpFileHandlerTypeEqual];
        this.fileHandlerTypeIn = in.readString();
        this.fileNamePatternsLike = in.readString();
        this.fileNamePatternsMultiLikeOr = in.readString();
        this.fileNamePatternsMultiLikeAnd = in.readString();
        ...
        this.errorCodeEqual = tmpErrorCodeEqual == -1 ? null : DropFolderErrorCode.values()[tmpErrorCodeEqual];
