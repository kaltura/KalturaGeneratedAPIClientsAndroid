...
public class ExtractMediaJobData extends ConvartableJobData {
    ...
    public static final Creator<ExtractMediaJobData> CREATOR = new Creator<ExtractMediaJobData>() {
        @Override
        public ExtractMediaJobData createFromParcel(Parcel source) {
            return new ExtractMediaJobData(source);
        }

        @Override
        public ExtractMediaJobData[] newArray(int size) {
            return new ExtractMediaJobData[size];
        }
    };
