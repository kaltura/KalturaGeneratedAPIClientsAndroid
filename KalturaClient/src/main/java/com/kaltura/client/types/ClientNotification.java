...
public class ClientNotification extends ObjectBase {
    ...
    public static final Creator<ClientNotification> CREATOR = new Creator<ClientNotification>() {
        @Override
        public ClientNotification createFromParcel(Parcel source) {
            return new ClientNotification(source);
        }

        @Override
        public ClientNotification[] newArray(int size) {
            return new ClientNotification[size];
        }
    };
    ...
    public ClientNotification(Parcel in) {
        super(in);
