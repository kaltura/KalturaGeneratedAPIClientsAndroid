...
public class ThumbParamsOutputFilter extends ThumbParamsOutputBaseFilter {
    ...
    public static final Creator<ThumbParamsOutputFilter> CREATOR = new Creator<ThumbParamsOutputFilter>() {
        @Override
        public ThumbParamsOutputFilter createFromParcel(Parcel source) {
            return new ThumbParamsOutputFilter(source);
        }

        @Override
        public ThumbParamsOutputFilter[] newArray(int size) {
            return new ThumbParamsOutputFilter[size];
        }
    };

    public ThumbParamsOutputFilter(Parcel in) {
        super(in);
    }
}
