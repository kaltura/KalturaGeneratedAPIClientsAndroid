...
public class AttUverseDistributionProviderFilter extends AttUverseDistributionProviderBaseFilter {
    ...
    public static final Creator<AttUverseDistributionProviderFilter> CREATOR = new Creator<AttUverseDistributionProviderFilter>() {
        @Override
        public AttUverseDistributionProviderFilter createFromParcel(Parcel source) {
            return new AttUverseDistributionProviderFilter(source);
        }

        @Override
        public AttUverseDistributionProviderFilter[] newArray(int size) {
            return new AttUverseDistributionProviderFilter[size];
        }
    };

    public AttUverseDistributionProviderFilter(Parcel in) {
        super(in);
    }
}
