...
public class WidevineFlavorAsset extends FlavorAsset {
    ...
    public static final Creator<WidevineFlavorAsset> CREATOR = new Creator<WidevineFlavorAsset>() {
        @Override
        public WidevineFlavorAsset createFromParcel(Parcel source) {
            return new WidevineFlavorAsset(source);
        }

        @Override
        public WidevineFlavorAsset[] newArray(int size) {
            return new WidevineFlavorAsset[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.widevineDistributionStartDate);
        dest.writeValue(this.widevineDistributionEndDate);
        dest.writeValue(this.widevineAssetId);
    }

    public WidevineFlavorAsset(Parcel in) {
        super(in);
        this.widevineDistributionStartDate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.widevineDistributionEndDate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.widevineAssetId = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
