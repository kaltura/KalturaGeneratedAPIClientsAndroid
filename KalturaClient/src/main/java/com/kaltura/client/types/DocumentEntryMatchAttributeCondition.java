...
public class DocumentEntryMatchAttributeCondition extends SearchMatchAttributeCondition {
    ...
    public static final Creator<DocumentEntryMatchAttributeCondition> CREATOR = new Creator<DocumentEntryMatchAttributeCondition>() {
        @Override
        public DocumentEntryMatchAttributeCondition createFromParcel(Parcel source) {
            return new DocumentEntryMatchAttributeCondition(source);
        }

        @Override
        public DocumentEntryMatchAttributeCondition[] newArray(int size) {
            return new DocumentEntryMatchAttributeCondition[size];
        }
    };
    ...
    public DocumentEntryMatchAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : DocumentEntryMatchAttribute.values()[tmpAttribute];
    }
}
