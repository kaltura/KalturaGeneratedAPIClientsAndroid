...
public class QuizVendorTaskData extends LocalizedVendorTaskData {
    ...
    public static final Creator<QuizVendorTaskData> CREATOR = new Creator<QuizVendorTaskData>() {
        @Override
        public QuizVendorTaskData createFromParcel(Parcel source) {
            return new QuizVendorTaskData(source);
        }

        @Override
        public QuizVendorTaskData[] newArray(int size) {
            return new QuizVendorTaskData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.questionsType);
    ...
    public QuizVendorTaskData(Parcel in) {
        ...
        this.questionsType = in.readString();
