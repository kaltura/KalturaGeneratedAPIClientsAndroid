...
public class ESearchCaptionItemData extends ESearchItemData {
    ...
    public static final Creator<ESearchCaptionItemData> CREATOR = new Creator<ESearchCaptionItemData>() {
        @Override
        public ESearchCaptionItemData createFromParcel(Parcel source) {
            return new ESearchCaptionItemData(source);
        }

        @Override
        public ESearchCaptionItemData[] newArray(int size) {
            return new ESearchCaptionItemData[size];
        }
    };
    ...
    public ESearchCaptionItemData(Parcel in) {
        ...
        this.startsAt = (Integer)in.readValue(Integer.class.getClassLoader());
