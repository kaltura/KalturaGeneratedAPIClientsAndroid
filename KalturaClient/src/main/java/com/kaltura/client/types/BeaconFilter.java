...
public class BeaconFilter extends BeaconBaseFilter {
    ...
    public static final Creator<BeaconFilter> CREATOR = new Creator<BeaconFilter>() {
        @Override
        public BeaconFilter createFromParcel(Parcel source) {
            return new BeaconFilter(source);
        }

        @Override
        public BeaconFilter[] newArray(int size) {
            return new BeaconFilter[size];
        }
    };
