...
public class BulkUploadEntryData extends BulkUploadObjectData {
    ...
    public static final Creator<BulkUploadEntryData> CREATOR = new Creator<BulkUploadEntryData>() {
        @Override
        public BulkUploadEntryData createFromParcel(Parcel source) {
            return new BulkUploadEntryData(source);
        }

        @Override
        public BulkUploadEntryData[] newArray(int size) {
            return new BulkUploadEntryData[size];
        }
    };
