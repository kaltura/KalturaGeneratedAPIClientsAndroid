...
public abstract class VendorCatalogItemBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.vendorPartnerIdEqual);
        dest.writeString(this.vendorPartnerIdIn);
    ...
    public VendorCatalogItemBaseFilter(Parcel in) {
        super(in);
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : VendorCatalogItemStatus.values()[tmpStatusEqual];
