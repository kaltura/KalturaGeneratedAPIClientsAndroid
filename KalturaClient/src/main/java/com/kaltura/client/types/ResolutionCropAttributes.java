...
public class ResolutionCropAttributes extends DimensionsAttributes {
    ...
    public static final Creator<ResolutionCropAttributes> CREATOR = new Creator<ResolutionCropAttributes>() {
        @Override
        public ResolutionCropAttributes createFromParcel(Parcel source) {
            return new ResolutionCropAttributes(source);
        }

        @Override
        public ResolutionCropAttributes[] newArray(int size) {
            return new ResolutionCropAttributes[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.targetWidth);
        dest.writeValue(this.targetHeight);
    }

    public ResolutionCropAttributes(Parcel in) {
        super(in);
        this.targetWidth = (Integer)in.readValue(Integer.class.getClassLoader());
        this.targetHeight = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
