...
public class SshUrlResource extends UrlResource {
    ...
    public static final Creator<SshUrlResource> CREATOR = new Creator<SshUrlResource>() {
        @Override
        public SshUrlResource createFromParcel(Parcel source) {
            return new SshUrlResource(source);
        }

        @Override
        public SshUrlResource[] newArray(int size) {
            return new SshUrlResource[size];
        }
    };
    ...
    public SshUrlResource(Parcel in) {
        super(in);
        this.privateKey = in.readString();
        this.publicKey = in.readString();
        this.keyPassphrase = in.readString();
    }
}
