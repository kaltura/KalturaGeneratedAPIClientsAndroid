...
public class WidevineFlavorParamsOutput extends FlavorParamsOutput {
    ...
    public static final Creator<WidevineFlavorParamsOutput> CREATOR = new Creator<WidevineFlavorParamsOutput>() {
        @Override
        public WidevineFlavorParamsOutput createFromParcel(Parcel source) {
            return new WidevineFlavorParamsOutput(source);
        }

        @Override
        public WidevineFlavorParamsOutput[] newArray(int size) {
            return new WidevineFlavorParamsOutput[size];
        }
    };
    ...
    public WidevineFlavorParamsOutput(Parcel in) {
        super(in);
