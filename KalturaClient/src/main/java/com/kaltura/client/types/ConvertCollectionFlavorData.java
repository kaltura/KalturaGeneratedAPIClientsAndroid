...
public class ConvertCollectionFlavorData extends ObjectBase {
    ...
    public static final Creator<ConvertCollectionFlavorData> CREATOR = new Creator<ConvertCollectionFlavorData>() {
        @Override
        public ConvertCollectionFlavorData createFromParcel(Parcel source) {
            return new ConvertCollectionFlavorData(source);
        }

        @Override
        public ConvertCollectionFlavorData[] newArray(int size) {
            return new ConvertCollectionFlavorData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.readyBehavior);
        dest.writeValue(this.videoBitrate);
        dest.writeValue(this.audioBitrate);
        dest.writeString(this.destFileSyncLocalPath);
        dest.writeString(this.destFileSyncRemoteUrl);
    }

    public ConvertCollectionFlavorData(Parcel in) {
        super(in);
        this.flavorAssetId = in.readString();
        this.flavorParamsOutputId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.readyBehavior = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        this.destFileSyncLocalPath = in.readString();
        this.destFileSyncRemoteUrl = in.readString();
    }
}
