...
public class PushToNewsDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<PushToNewsDistributionJobProviderData> CREATOR = new Creator<PushToNewsDistributionJobProviderData>() {
        @Override
        public PushToNewsDistributionJobProviderData createFromParcel(Parcel source) {
            return new PushToNewsDistributionJobProviderData(source);
        }

        @Override
        public PushToNewsDistributionJobProviderData[] newArray(int size) {
            return new PushToNewsDistributionJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.bodyParamContent);
    }

    public PushToNewsDistributionJobProviderData(Parcel in) {
        super(in);
        this.currentVersion = (Integer)in.readValue(Integer.class.getClassLoader());
        this.bodyParamContent = in.readString();
    }
}
