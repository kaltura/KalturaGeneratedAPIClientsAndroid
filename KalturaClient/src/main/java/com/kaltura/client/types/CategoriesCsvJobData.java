...
public class CategoriesCsvJobData extends MappedObjectsCsvJobData {
    ...
    public static final Creator<CategoriesCsvJobData> CREATOR = new Creator<CategoriesCsvJobData>() {
        @Override
        public CategoriesCsvJobData createFromParcel(Parcel source) {
            return new CategoriesCsvJobData(source);
        }

        @Override
        public CategoriesCsvJobData[] newArray(int size) {
            return new CategoriesCsvJobData[size];
        }
    };
    ...
    public CategoriesCsvJobData(Parcel in) {
        super(in);
        this.filter = in.readParcelable(CategoryFilter.class.getClassLoader());
    }
}
