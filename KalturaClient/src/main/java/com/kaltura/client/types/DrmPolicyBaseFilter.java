...
public abstract class DrmPolicyBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.systemNameLike);
        dest.writeInt(this.providerEqual == null ? -1 : this.providerEqual.ordinal());
        dest.writeString(this.providerIn);
        dest.writeInt(this.statusEqual == null ? -1 : this.statusEqual.ordinal());
        dest.writeString(this.statusIn);
        dest.writeInt(this.scenarioEqual == null ? -1 : this.scenarioEqual.ordinal());
        dest.writeString(this.scenarioIn);
    }

    public DrmPolicyBaseFilter(Parcel in) {
        super(in);
        ...
        this.systemNameLike = in.readString();
        int tmpProviderEqual = in.readInt();
        this.providerEqual = tmpProviderEqual == -1 ? null : DrmProviderType.values()[tmpProviderEqual];
        this.providerIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : DrmPolicyStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpScenarioEqual = in.readInt();
        this.scenarioEqual = tmpScenarioEqual == -1 ? null : DrmLicenseScenario.values()[tmpScenarioEqual];
        this.scenarioIn = in.readString();
    }
}
