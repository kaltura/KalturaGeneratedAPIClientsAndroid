...
public class ForensicWatermarkAdvancedFilter extends SearchItem {
    ...
    public static final Creator<ForensicWatermarkAdvancedFilter> CREATOR = new Creator<ForensicWatermarkAdvancedFilter>() {
        @Override
        public ForensicWatermarkAdvancedFilter createFromParcel(Parcel source) {
            return new ForensicWatermarkAdvancedFilter(source);
        }

        @Override
        public ForensicWatermarkAdvancedFilter[] newArray(int size) {
            return new ForensicWatermarkAdvancedFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.watermarkId);
    }

    public ForensicWatermarkAdvancedFilter(Parcel in) {
        super(in);
        this.watermarkId = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
