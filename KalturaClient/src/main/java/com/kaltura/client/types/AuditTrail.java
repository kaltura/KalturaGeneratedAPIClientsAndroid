...
public class AuditTrail extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.parsedAt);
        dest.writeInt(this.status == null ? -1 : this.status.ordinal());
        dest.writeInt(this.auditObjectType == null ? -1 : this.auditObjectType.ordinal());
        dest.writeString(this.objectId);
        dest.writeString(this.relatedObjectId);
        dest.writeInt(this.relatedObjectType == null ? -1 : this.relatedObjectType.ordinal());
        dest.writeString(this.entryId);
        dest.writeValue(this.masterPartnerId);
    ...
    public AuditTrail(Parcel in) {
        super(in);
        this.id = (Integer)in.readValue(Integer.class.getClassLoader());
        this.createdAt = (Integer)in.readValue(Integer.class.getClassLoader());
        this.parsedAt = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpStatus = in.readInt();
        this.status = tmpStatus == -1 ? null : AuditTrailStatus.values()[tmpStatus];
        int tmpAuditObjectType = in.readInt();
        this.auditObjectType = tmpAuditObjectType == -1 ? null : AuditTrailObjectType.values()[tmpAuditObjectType];
        this.objectId = in.readString();
        this.relatedObjectId = in.readString();
        int tmpRelatedObjectType = in.readInt();
        this.relatedObjectType = tmpRelatedObjectType == -1 ? null : AuditTrailObjectType.values()[tmpRelatedObjectType];
        this.entryId = in.readString();
        this.masterPartnerId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.partnerId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.requestId = in.readString();
        this.userId = in.readString();
        int tmpAction = in.readInt();
        this.action = tmpAction == -1 ? null : AuditTrailAction.values()[tmpAction];
        this.data = in.readParcelable(AuditTrailInfo.class.getClassLoader());
        this.ks = in.readString();
        int tmpContext = in.readInt();
        this.context = tmpContext == -1 ? null : AuditTrailContext.values()[tmpContext];
        this.entryPoint = in.readString();
