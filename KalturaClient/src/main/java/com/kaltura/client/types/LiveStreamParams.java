...
public class LiveStreamParams extends ObjectBase {
    ...
    public static final Creator<LiveStreamParams> CREATOR = new Creator<LiveStreamParams>() {
        @Override
        public LiveStreamParams createFromParcel(Parcel source) {
            return new LiveStreamParams(source);
        }

        @Override
        public LiveStreamParams[] newArray(int size) {
            return new LiveStreamParams[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.flavorId);
        dest.writeValue(this.width);
        dest.writeValue(this.height);
        dest.writeString(this.codec);
        dest.writeValue(this.frameRate);
        dest.writeValue(this.keyFrameInterval);
        dest.writeString(this.language);
    }

    public LiveStreamParams(Parcel in) {
        super(in);
        this.bitrate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.flavorId = in.readString();
        this.width = (Integer)in.readValue(Integer.class.getClassLoader());
        this.height = (Integer)in.readValue(Integer.class.getClassLoader());
        this.codec = in.readString();
        this.frameRate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.keyFrameInterval = (Double)in.readValue(Double.class.getClassLoader());
