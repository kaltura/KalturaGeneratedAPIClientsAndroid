...
public class GeoTimeLiveStats extends EntryLiveStats {
    ...
    public static final Creator<GeoTimeLiveStats> CREATOR = new Creator<GeoTimeLiveStats>() {
        @Override
        public GeoTimeLiveStats createFromParcel(Parcel source) {
            return new GeoTimeLiveStats(source);
        }

        @Override
        public GeoTimeLiveStats[] newArray(int size) {
            return new GeoTimeLiveStats[size];
        }
    };
    ...
    public GeoTimeLiveStats(Parcel in) {
        super(in);
        this.city = in.readParcelable(Coordinate.class.getClassLoader());
        this.country = in.readParcelable(Coordinate.class.getClassLoader());
    }
}
