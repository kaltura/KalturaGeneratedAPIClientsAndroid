...
public class PodcastDistributionJobProviderData extends DistributionJobProviderData {
    ...
    public static final Creator<PodcastDistributionJobProviderData> CREATOR = new Creator<PodcastDistributionJobProviderData>() {
        @Override
        public PodcastDistributionJobProviderData createFromParcel(Parcel source) {
            return new PodcastDistributionJobProviderData(source);
        }

        @Override
        public PodcastDistributionJobProviderData[] newArray(int size) {
            return new PodcastDistributionJobProviderData[size];
        }
    };
    ...
    public PodcastDistributionJobProviderData(Parcel in) {
        super(in);
