...
public class VendorAlignmentCatalogItem extends VendorCatalogItem {
    ...
    public static final Creator<VendorAlignmentCatalogItem> CREATOR = new Creator<VendorAlignmentCatalogItem>() {
        @Override
        public VendorAlignmentCatalogItem createFromParcel(Parcel source) {
            return new VendorAlignmentCatalogItem(source);
        }

        @Override
        public VendorAlignmentCatalogItem[] newArray(int size) {
            return new VendorAlignmentCatalogItem[size];
        }
    };
