...
public class LiveEntryArchiveJobData extends JobData {
    ...
    public static final Creator<LiveEntryArchiveJobData> CREATOR = new Creator<LiveEntryArchiveJobData>() {
        @Override
        public LiveEntryArchiveJobData createFromParcel(Parcel source) {
            return new LiveEntryArchiveJobData(source);
        }

        @Override
        public LiveEntryArchiveJobData[] newArray(int size) {
            return new LiveEntryArchiveJobData[size];
        }
    };
