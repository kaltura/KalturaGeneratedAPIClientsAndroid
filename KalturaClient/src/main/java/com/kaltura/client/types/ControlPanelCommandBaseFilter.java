...
public abstract class ControlPanelCommandBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.createdByIdEqual);
        dest.writeInt(this.typeEqual == null ? -1 : this.typeEqual.ordinal());
        dest.writeString(this.typeIn);
        dest.writeInt(this.targetTypeEqual == null ? -1 : this.targetTypeEqual.ordinal());
        dest.writeString(this.targetTypeIn);
        dest.writeInt(this.statusEqual == null ? -1 : this.statusEqual.ordinal());
        dest.writeString(this.statusIn);
    }

    public ControlPanelCommandBaseFilter(Parcel in) {
        super(in);
        ...
        this.createdByIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpTypeEqual = in.readInt();
        this.typeEqual = tmpTypeEqual == -1 ? null : ControlPanelCommandType.values()[tmpTypeEqual];
        this.typeIn = in.readString();
        int tmpTargetTypeEqual = in.readInt();
        this.targetTypeEqual = tmpTargetTypeEqual == -1 ? null : ControlPanelCommandTargetType.values()[tmpTargetTypeEqual];
        this.targetTypeIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : ControlPanelCommandStatus.values()[tmpStatusEqual];
