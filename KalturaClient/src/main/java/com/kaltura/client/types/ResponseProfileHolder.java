...
public class ResponseProfileHolder extends BaseResponseProfile {
    ...
    public static final Creator<ResponseProfileHolder> CREATOR = new Creator<ResponseProfileHolder>() {
        @Override
        public ResponseProfileHolder createFromParcel(Parcel source) {
            return new ResponseProfileHolder(source);
        }

        @Override
        public ResponseProfileHolder[] newArray(int size) {
            return new ResponseProfileHolder[size];
        }
    };
    ...
    public ResponseProfileHolder(Parcel in) {
        super(in);
