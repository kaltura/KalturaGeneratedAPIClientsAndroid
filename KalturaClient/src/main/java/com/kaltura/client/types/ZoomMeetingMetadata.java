...
public class ZoomMeetingMetadata extends ObjectBase {
    ...
    public static final Creator<ZoomMeetingMetadata> CREATOR = new Creator<ZoomMeetingMetadata>() {
        @Override
        public ZoomMeetingMetadata createFromParcel(Parcel source) {
            return new ZoomMeetingMetadata(source);
        }

        @Override
        public ZoomMeetingMetadata[] newArray(int size) {
            return new ZoomMeetingMetadata[size];
        }
    };
    ...
    public ZoomMeetingMetadata(Parcel in) {
        super(in);
