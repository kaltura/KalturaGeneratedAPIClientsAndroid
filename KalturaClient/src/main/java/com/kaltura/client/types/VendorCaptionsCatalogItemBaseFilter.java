...
public abstract class VendorCaptionsCatalogItemBaseFilter extends VendorCatalogItemFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.sourceLanguageIn);
        dest.writeInt(this.outputFormatEqual == null ? -1 : this.outputFormatEqual.ordinal());
        dest.writeString(this.outputFormatIn);
    }

    public VendorCaptionsCatalogItemBaseFilter(Parcel in) {
        super(in);
        ...
        this.sourceLanguageIn = in.readString();
        int tmpOutputFormatEqual = in.readInt();
        this.outputFormatEqual = tmpOutputFormatEqual == -1 ? null : VendorCatalogItemOutputFormat.values()[tmpOutputFormatEqual];
        this.outputFormatIn = in.readString();
    }
}
