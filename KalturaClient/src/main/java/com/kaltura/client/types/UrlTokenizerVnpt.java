...
public class UrlTokenizerVnpt extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerVnpt> CREATOR = new Creator<UrlTokenizerVnpt>() {
        @Override
        public UrlTokenizerVnpt createFromParcel(Parcel source) {
            return new UrlTokenizerVnpt(source);
        }

        @Override
        public UrlTokenizerVnpt[] newArray(int size) {
            return new UrlTokenizerVnpt[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.tokenizationFormat);
        dest.writeValue(this.shouldIncludeClientIp);
    }

    public UrlTokenizerVnpt(Parcel in) {
        super(in);
        this.tokenizationFormat = (Integer)in.readValue(Integer.class.getClassLoader());
        this.shouldIncludeClientIp = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
