...
public class ESearchCategoryOperator extends ESearchCategoryBaseItem {
    ...
    public static final Creator<ESearchCategoryOperator> CREATOR = new Creator<ESearchCategoryOperator>() {
        @Override
        public ESearchCategoryOperator createFromParcel(Parcel source) {
            return new ESearchCategoryOperator(source);
        }

        @Override
        public ESearchCategoryOperator[] newArray(int size) {
            return new ESearchCategoryOperator[size];
        }
    };
    ...
    public ESearchCategoryOperator(Parcel in) {
        super(in);
        ...
        if( searchItemsSize > -1) {
            ...
            in.readList(this.searchItems, ESearchCategoryBaseItem.class.getClassLoader());
        }
    }
}
