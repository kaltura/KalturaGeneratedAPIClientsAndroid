...
public class EntryScheduleEventFilter extends EntryScheduleEventBaseFilter {
    ...
    public static final Creator<EntryScheduleEventFilter> CREATOR = new Creator<EntryScheduleEventFilter>() {
        @Override
        public EntryScheduleEventFilter createFromParcel(Parcel source) {
            return new EntryScheduleEventFilter(source);
        }

        @Override
        public EntryScheduleEventFilter[] newArray(int size) {
            return new EntryScheduleEventFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.parentCategoryIdsLike);
        dest.writeString(this.parentCategoryIdsMultiLikeOr);
        dest.writeString(this.parentCategoryIdsMultiLikeAnd);
    }

    public EntryScheduleEventFilter(Parcel in) {
        super(in);
        this.parentCategoryIdsLike = in.readString();
        this.parentCategoryIdsMultiLikeOr = in.readString();
        this.parentCategoryIdsMultiLikeAnd = in.readString();
    }
}
