...
public class ZoomDropFolder extends DropFolder {
	...
	private Integer lastHandledMeetingTime;
	...
	public Integer getLastHandledMeetingTime(){
		return this.lastHandledMeetingTime;
	}
	public void setLastHandledMeetingTime(Integer lastHandledMeetingTime){
	...
	public ZoomDropFolder(JsonObject jsonObject) throws APIException {
		...
		lastHandledMeetingTime = GsonParser.parseInt(jsonObject.get("lastHandledMeetingTime"));
    ...
    public static final Creator<ZoomDropFolder> CREATOR = new Creator<ZoomDropFolder>() {
        @Override
        public ZoomDropFolder createFromParcel(Parcel source) {
            return new ZoomDropFolder(source);
        }

        @Override
        public ZoomDropFolder[] newArray(int size) {
            return new ZoomDropFolder[size];
        }
    };
    ...
    public ZoomDropFolder(Parcel in) {
        ...
        this.lastHandledMeetingTime = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
