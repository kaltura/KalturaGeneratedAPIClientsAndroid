...
public abstract class DropFolderFileBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.dropFolderIdIn);
        dest.writeString(this.fileNameEqual);
        dest.writeString(this.fileNameIn);
        dest.writeString(this.fileNameLike);
        ...
        dest.writeString(this.parsedSlugEqual);
        dest.writeString(this.parsedSlugIn);
        dest.writeString(this.parsedSlugLike);
        dest.writeString(this.parsedFlavorEqual);
        dest.writeString(this.parsedFlavorIn);
        dest.writeString(this.parsedFlavorLike);
        dest.writeValue(this.leadDropFolderFileIdEqual);
        dest.writeValue(this.deletedDropFolderFileIdEqual);
        dest.writeString(this.entryIdEqual);
        dest.writeInt(this.errorCodeEqual == null ? -1 : this.errorCodeEqual.ordinal());
    ...
    public DropFolderFileBaseFilter(Parcel in) {
        super(in);
        ...
        this.dropFolderIdIn = in.readString();
        this.fileNameEqual = in.readString();
        this.fileNameIn = in.readString();
        this.fileNameLike = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : DropFolderFileStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        this.statusNotIn = in.readString();
        this.parsedSlugEqual = in.readString();
        this.parsedSlugIn = in.readString();
        this.parsedSlugLike = in.readString();
        this.parsedFlavorEqual = in.readString();
        this.parsedFlavorIn = in.readString();
        this.parsedFlavorLike = in.readString();
        this.leadDropFolderFileIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.deletedDropFolderFileIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.entryIdEqual = in.readString();
        int tmpErrorCodeEqual = in.readInt();
        this.errorCodeEqual = tmpErrorCodeEqual == -1 ? null : DropFolderFileErrorCode.values()[tmpErrorCodeEqual];
