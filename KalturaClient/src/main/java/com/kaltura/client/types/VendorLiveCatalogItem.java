...
public class VendorLiveCatalogItem extends VendorCaptionsCatalogItem {
    ...
    public static final Creator<VendorLiveCatalogItem> CREATOR = new Creator<VendorLiveCatalogItem>() {
        @Override
        public VendorLiveCatalogItem createFromParcel(Parcel source) {
            return new VendorLiveCatalogItem(source);
        }

        @Override
        public VendorLiveCatalogItem[] newArray(int size) {
            return new VendorLiveCatalogItem[size];
        }
    };
    ...
    public VendorLiveCatalogItem(Parcel in) {
        super(in);
