...
public class UrlTokenizerAkamaiHttp extends UrlTokenizer {
    ...
    public static final Creator<UrlTokenizerAkamaiHttp> CREATOR = new Creator<UrlTokenizerAkamaiHttp>() {
        @Override
        public UrlTokenizerAkamaiHttp createFromParcel(Parcel source) {
            return new UrlTokenizerAkamaiHttp(source);
        }

        @Override
        public UrlTokenizerAkamaiHttp[] newArray(int size) {
            return new UrlTokenizerAkamaiHttp[size];
        }
    };
    ...
    public UrlTokenizerAkamaiHttp(Parcel in) {
        super(in);
