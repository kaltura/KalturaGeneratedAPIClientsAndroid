...
public abstract class UserAppRoleBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.appGuidEqual);
        dest.writeString(this.appGuidIn);
        dest.writeString(this.userRoleIdEqual);
    ...
    public UserAppRoleBaseFilter(Parcel in) {
        super(in);
        this.appGuidEqual = in.readString();
        this.appGuidIn = in.readString();
        this.userRoleIdEqual = in.readString();
