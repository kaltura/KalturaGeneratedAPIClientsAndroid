...
public class PreviewRestriction extends SessionRestriction {
    ...
    public static final Creator<PreviewRestriction> CREATOR = new Creator<PreviewRestriction>() {
        @Override
        public PreviewRestriction createFromParcel(Parcel source) {
            return new PreviewRestriction(source);
        }

        @Override
        public PreviewRestriction[] newArray(int size) {
            return new PreviewRestriction[size];
        }
    };
    ...
    public PreviewRestriction(Parcel in) {
        super(in);
