...
public class BulkUploadResultEntry extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultEntry> CREATOR = new Creator<BulkUploadResultEntry>() {
        @Override
        public BulkUploadResultEntry createFromParcel(Parcel source) {
            return new BulkUploadResultEntry(source);
        }

        @Override
        public BulkUploadResultEntry[] newArray(int size) {
            return new BulkUploadResultEntry[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.accessControlProfileId);
        dest.writeString(this.category);
        dest.writeValue(this.scheduleStartDate);
        dest.writeValue(this.scheduleEndDate);
        dest.writeValue(this.entryStatus);
        dest.writeString(this.thumbnailUrl);
        dest.writeValue(this.thumbnailSaved);
        dest.writeString(this.sshPrivateKey);
        dest.writeString(this.sshPublicKey);
        dest.writeString(this.sshKeyPassphrase);
    ...
    public BulkUploadResultEntry(Parcel in) {
        super(in);
        ...
        this.accessControlProfileId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.category = in.readString();
        this.scheduleStartDate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.scheduleEndDate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.entryStatus = (Integer)in.readValue(Integer.class.getClassLoader());
        this.thumbnailUrl = in.readString();
        this.thumbnailSaved = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.sshPrivateKey = in.readString();
        this.sshPublicKey = in.readString();
        this.sshKeyPassphrase = in.readString();
