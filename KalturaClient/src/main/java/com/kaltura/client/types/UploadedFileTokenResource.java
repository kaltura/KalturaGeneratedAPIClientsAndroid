...
public class UploadedFileTokenResource extends GenericDataCenterContentResource {
    ...
    public static final Creator<UploadedFileTokenResource> CREATOR = new Creator<UploadedFileTokenResource>() {
        @Override
        public UploadedFileTokenResource createFromParcel(Parcel source) {
            return new UploadedFileTokenResource(source);
        }

        @Override
        public UploadedFileTokenResource[] newArray(int size) {
            return new UploadedFileTokenResource[size];
        }
    };
    ...
    public UploadedFileTokenResource(Parcel in) {
        super(in);
