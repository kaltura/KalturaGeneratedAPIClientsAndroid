...
public abstract class AssetBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.sizeGreaterThanOrEqual);
        dest.writeValue(this.sizeLessThanOrEqual);
        ...
        dest.writeValue(this.deletedAtGreaterThanOrEqual);
        dest.writeValue(this.deletedAtLessThanOrEqual);
    }

    public AssetBaseFilter(Parcel in) {
        super(in);
        ...
        this.sizeGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.sizeLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
