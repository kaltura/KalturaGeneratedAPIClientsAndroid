...
public class KeyValueExtended extends KeyValue {
    ...
    public static final Creator<KeyValueExtended> CREATOR = new Creator<KeyValueExtended>() {
        @Override
        public KeyValueExtended createFromParcel(Parcel source) {
            return new KeyValueExtended(source);
        }

        @Override
        public KeyValueExtended[] newArray(int size) {
            return new KeyValueExtended[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.predefinedFormat);
    }

    public KeyValueExtended(Parcel in) {
        super(in);
        this.predefinedFormat = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
