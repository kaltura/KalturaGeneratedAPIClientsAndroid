...
public abstract class FileSyncBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.fileObjectTypeEqual == null ? -1 : this.fileObjectTypeEqual.ordinal());
        dest.writeString(this.fileObjectTypeIn);
        dest.writeString(this.objectIdEqual);
        dest.writeString(this.objectIdIn);
        dest.writeString(this.versionEqual);
        dest.writeString(this.versionIn);
        dest.writeValue(this.objectSubTypeEqual);
        dest.writeString(this.objectSubTypeIn);
        dest.writeString(this.dcEqual);
        dest.writeString(this.dcIn);
        dest.writeValue(this.originalEqual);
        ...
        dest.writeValue(this.readyAtGreaterThanOrEqual);
        dest.writeValue(this.readyAtLessThanOrEqual);
        dest.writeValue(this.syncTimeGreaterThanOrEqual);
        dest.writeValue(this.syncTimeLessThanOrEqual);
        dest.writeInt(this.statusEqual == null ? -1 : this.statusEqual.ordinal());
        dest.writeString(this.statusIn);
        dest.writeInt(this.fileTypeEqual == null ? -1 : this.fileTypeEqual.ordinal());
        dest.writeString(this.fileTypeIn);
        dest.writeValue(this.linkedIdEqual);
        dest.writeValue(this.linkCountGreaterThanOrEqual);
        dest.writeValue(this.linkCountLessThanOrEqual);
        dest.writeValue(this.fileSizeGreaterThanOrEqual);
        dest.writeValue(this.fileSizeLessThanOrEqual);
    }

    public FileSyncBaseFilter(Parcel in) {
        super(in);
        this.partnerIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpFileObjectTypeEqual = in.readInt();
        this.fileObjectTypeEqual = tmpFileObjectTypeEqual == -1 ? null : FileSyncObjectType.values()[tmpFileObjectTypeEqual];
        this.fileObjectTypeIn = in.readString();
        this.objectIdEqual = in.readString();
        this.objectIdIn = in.readString();
        this.versionEqual = in.readString();
        this.versionIn = in.readString();
        this.objectSubTypeEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.objectSubTypeIn = in.readString();
        this.dcEqual = in.readString();
        this.dcIn = in.readString();
        this.originalEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        this.readyAtGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.readyAtLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.syncTimeGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.syncTimeLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : FileSyncStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpFileTypeEqual = in.readInt();
        this.fileTypeEqual = tmpFileTypeEqual == -1 ? null : FileSyncType.values()[tmpFileTypeEqual];
        this.fileTypeIn = in.readString();
        this.linkedIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.linkCountGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.linkCountLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.fileSizeGreaterThanOrEqual = (Double)in.readValue(Double.class.getClassLoader());
        this.fileSizeLessThanOrEqual = (Double)in.readValue(Double.class.getClassLoader());
    }
}
