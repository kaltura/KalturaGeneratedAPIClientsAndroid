...
public class OverlayAttributes extends MediaCompositionAttributes {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.marginsPercentage, flags);
        dest.writeParcelable(this.overlayScaleAttribute, flags);
    ...
    public OverlayAttributes(Parcel in) {
        ...
        this.marginsPercentage = in.readParcelable(DimensionsPercentage.class.getClassLoader());
        this.overlayScaleAttribute = in.readParcelable(OverlayScaleAttribute.class.getClassLoader());
