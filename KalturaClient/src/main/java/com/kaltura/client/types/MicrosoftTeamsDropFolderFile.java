...
public class MicrosoftTeamsDropFolderFile extends DropFolderFile {
    ...
    public static final Creator<MicrosoftTeamsDropFolderFile> CREATOR = new Creator<MicrosoftTeamsDropFolderFile>() {
        @Override
        public MicrosoftTeamsDropFolderFile createFromParcel(Parcel source) {
            return new MicrosoftTeamsDropFolderFile(source);
        }

        @Override
        public MicrosoftTeamsDropFolderFile[] newArray(int size) {
            return new MicrosoftTeamsDropFolderFile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.additionalUserIds);
        dest.writeString(this.description);
        dest.writeString(this.targetCategoryIds);
        dest.writeString(this.name);
        dest.writeString(this.contentUrl);
    }

    public MicrosoftTeamsDropFolderFile(Parcel in) {
        super(in);
        this.remoteId = in.readString();
        this.ownerId = in.readString();
        this.additionalUserIds = in.readString();
        this.description = in.readString();
        this.targetCategoryIds = in.readString();
