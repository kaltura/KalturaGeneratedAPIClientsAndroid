...
public abstract class BaseSyndicationFeed extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.allowEmbed);
        dest.writeValue(this.playerUiconfId);
        dest.writeValue(this.flavorParamId);
        dest.writeValue(this.transcodeExistingContent);
        dest.writeValue(this.addToDefaultConversionProfile);
        dest.writeString(this.categories);
        dest.writeValue(this.storageId);
        dest.writeInt(this.entriesOrderBy == null ? -1 : this.entriesOrderBy.ordinal());
        ...
        dest.writeString(this.feedContentTypeHeader);
    }

    public BaseSyndicationFeed(Parcel in) {
        super(in);
        ...
        this.status = tmpStatus == -1 ? null : SyndicationFeedStatus.values()[tmpStatus];
        ...
        this.transcodeExistingContent = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.addToDefaultConversionProfile = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.categories = in.readString();
        this.storageId = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpEntriesOrderBy = in.readInt();
