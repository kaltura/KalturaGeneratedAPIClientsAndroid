...
public class ConcatAttributes extends OperationAttributes {
    ...
    public static final Creator<ConcatAttributes> CREATOR = new Creator<ConcatAttributes>() {
        @Override
        public ConcatAttributes createFromParcel(Parcel source) {
            return new ConcatAttributes(source);
        }

        @Override
        public ConcatAttributes[] newArray(int size) {
            return new ConcatAttributes[size];
        }
    };
    ...
    public ConcatAttributes(Parcel in) {
        super(in);
        this.resource = in.readParcelable(DataCenterContentResource.class.getClassLoader());
    }
}
