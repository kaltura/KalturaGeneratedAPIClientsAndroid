...
public class EndUserReportInputFilter extends ReportInputFilter {
    ...
    public static final Creator<EndUserReportInputFilter> CREATOR = new Creator<EndUserReportInputFilter>() {
        @Override
        public EndUserReportInputFilter createFromParcel(Parcel source) {
            return new EndUserReportInputFilter(source);
        }

        @Override
        public EndUserReportInputFilter[] newArray(int size) {
            return new EndUserReportInputFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.ancestorPlaybackContext);
    }

    public EndUserReportInputFilter(Parcel in) {
        super(in);
        this.application = in.readString();
        this.userIds = in.readString();
        this.playbackContext = in.readString();
        this.ancestorPlaybackContext = in.readString();
    }
}
