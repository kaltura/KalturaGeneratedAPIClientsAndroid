...
public class SynacorHboDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<SynacorHboDistributionProfile> CREATOR = new Creator<SynacorHboDistributionProfile>() {
        @Override
        public SynacorHboDistributionProfile createFromParcel(Parcel source) {
            return new SynacorHboDistributionProfile(source);
        }

        @Override
        public SynacorHboDistributionProfile[] newArray(int size) {
            return new SynacorHboDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.feedSubtitle);
        dest.writeString(this.feedLink);
        dest.writeString(this.feedAuthorName);
    }

    public SynacorHboDistributionProfile(Parcel in) {
        super(in);
        this.feedUrl = in.readString();
        this.feedTitle = in.readString();
        this.feedSubtitle = in.readString();
        this.feedLink = in.readString();
        this.feedAuthorName = in.readString();
    }
}
