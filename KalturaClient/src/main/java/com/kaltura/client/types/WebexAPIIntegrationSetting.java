...
public class WebexAPIIntegrationSetting extends IntegrationSetting {
    ...
    public static final Creator<WebexAPIIntegrationSetting> CREATOR = new Creator<WebexAPIIntegrationSetting>() {
        @Override
        public WebexAPIIntegrationSetting createFromParcel(Parcel source) {
            return new WebexAPIIntegrationSetting(source);
        }

        @Override
        public WebexAPIIntegrationSetting[] newArray(int size) {
            return new WebexAPIIntegrationSetting[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.webexCategory);
        dest.writeValue(this.enableRecordingUpload);
        dest.writeValue(this.enableTranscription);
        dest.writeInt(this.userMatchingMode == null ? -1 : this.userMatchingMode.ordinal());
        dest.writeString(this.userPostfix);
        dest.writeString(this.webexAccountDescription);
    ...
    public WebexAPIIntegrationSetting(Parcel in) {
        super(in);
        this.webexCategory = in.readString();
        this.enableRecordingUpload = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.enableTranscription = (Boolean)in.readValue(Boolean.class.getClassLoader());
        int tmpUserMatchingMode = in.readInt();
        this.userMatchingMode = tmpUserMatchingMode == -1 ? null : WebexAPIUsersMatching.values()[tmpUserMatchingMode];
        this.userPostfix = in.readString();
        this.webexAccountDescription = in.readString();
        int tmpGroupParticipationType = in.readInt();
        this.groupParticipationType = tmpGroupParticipationType == -1 ? null : WebexAPIGroupParticipationType.values()[tmpGroupParticipationType];
