...
public class TranslationVendorTaskData extends VendorTaskDataCaptionAsset {
    ...
    public static final Creator<TranslationVendorTaskData> CREATOR = new Creator<TranslationVendorTaskData>() {
        @Override
        public TranslationVendorTaskData createFromParcel(Parcel source) {
            return new TranslationVendorTaskData(source);
        }

        @Override
        public TranslationVendorTaskData[] newArray(int size) {
            return new TranslationVendorTaskData[size];
        }
    };

    public TranslationVendorTaskData(Parcel in) {
        super(in);
    }
}
