...
public class VendorSignLanguageCatalogItemFilter extends VendorDubbingCatalogItemBaseFilter {
    ...
    public static final Creator<VendorSignLanguageCatalogItemFilter> CREATOR = new Creator<VendorSignLanguageCatalogItemFilter>() {
        @Override
        public VendorSignLanguageCatalogItemFilter createFromParcel(Parcel source) {
            return new VendorSignLanguageCatalogItemFilter(source);
        }

        @Override
        public VendorSignLanguageCatalogItemFilter[] newArray(int size) {
            return new VendorSignLanguageCatalogItemFilter[size];
        }
    };

    public VendorSignLanguageCatalogItemFilter(Parcel in) {
        super(in);
    }
}
