...
public class BulkUploadFilterJobData extends BulkUploadJobData {
    ...
    public static final Creator<BulkUploadFilterJobData> CREATOR = new Creator<BulkUploadFilterJobData>() {
        @Override
        public BulkUploadFilterJobData createFromParcel(Parcel source) {
            return new BulkUploadFilterJobData(source);
        }

        @Override
        public BulkUploadFilterJobData[] newArray(int size) {
            return new BulkUploadFilterJobData[size];
        }
    };
    ...
    public BulkUploadFilterJobData(Parcel in) {
        super(in);
