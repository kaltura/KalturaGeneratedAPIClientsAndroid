...
public abstract class BulkUploadBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.uploadedOnGreaterThanOrEqual);
        dest.writeValue(this.uploadedOnLessThanOrEqual);
        ...
        dest.writeInt(this.bulkUploadObjectTypeEqual == null ? -1 : this.bulkUploadObjectTypeEqual.ordinal());
        dest.writeString(this.bulkUploadObjectTypeIn);
    }
    ...
    public BulkUploadBaseFilter(Parcel in) {
        ...
        int tmpBulkUploadObjectTypeEqual = in.readInt();
        this.bulkUploadObjectTypeEqual = tmpBulkUploadObjectTypeEqual == -1 ? null : BulkUploadObjectType.values()[tmpBulkUploadObjectTypeEqual];
        this.bulkUploadObjectTypeIn = in.readString();
    }
}
