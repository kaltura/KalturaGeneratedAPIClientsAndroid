...
public class DeliveryProfileRtmp extends DeliveryProfile {
    ...
    public static final Creator<DeliveryProfileRtmp> CREATOR = new Creator<DeliveryProfileRtmp>() {
        @Override
        public DeliveryProfileRtmp createFromParcel(Parcel source) {
            return new DeliveryProfileRtmp(source);
        }

        @Override
        public DeliveryProfileRtmp[] newArray(int size) {
            return new DeliveryProfileRtmp[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.enforceRtmpe);
        dest.writeString(this.prefix);
    }

    public DeliveryProfileRtmp(Parcel in) {
        super(in);
        this.enforceRtmpe = (Boolean)in.readValue(Boolean.class.getClassLoader());
