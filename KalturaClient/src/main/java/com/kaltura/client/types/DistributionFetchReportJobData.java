...
public class DistributionFetchReportJobData extends DistributionJobData {
    ...
    public static final Creator<DistributionFetchReportJobData> CREATOR = new Creator<DistributionFetchReportJobData>() {
        @Override
        public DistributionFetchReportJobData createFromParcel(Parcel source) {
            return new DistributionFetchReportJobData(source);
        }

        @Override
        public DistributionFetchReportJobData[] newArray(int size) {
            return new DistributionFetchReportJobData[size];
        }
    };
    ...
    public DistributionFetchReportJobData(Parcel in) {
        super(in);
