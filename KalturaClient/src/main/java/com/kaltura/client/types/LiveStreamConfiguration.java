...
public class LiveStreamConfiguration extends ObjectBase {
    ...
    public static final Creator<LiveStreamConfiguration> CREATOR = new Creator<LiveStreamConfiguration>() {
        @Override
        public LiveStreamConfiguration createFromParcel(Parcel source) {
            return new LiveStreamConfiguration(source);
        }

        @Override
        public LiveStreamConfiguration[] newArray(int size) {
            return new LiveStreamConfiguration[size];
        }
    };
    ...
    public LiveStreamConfiguration(Parcel in) {
        super(in);
        int tmpProtocol = in.readInt();
        this.protocol = tmpProtocol == -1 ? null : PlaybackProtocol.values()[tmpProtocol];
        this.url = in.readString();
        this.publishUrl = in.readString();
        this.backupUrl = in.readString();
