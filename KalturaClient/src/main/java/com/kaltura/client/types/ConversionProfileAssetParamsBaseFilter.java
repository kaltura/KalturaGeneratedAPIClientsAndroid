...
public abstract class ConversionProfileAssetParamsBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.assetParamsIdEqual);
        dest.writeString(this.assetParamsIdIn);
        dest.writeInt(this.readyBehaviorEqual == null ? -1 : this.readyBehaviorEqual.ordinal());
        dest.writeString(this.readyBehaviorIn);
        dest.writeInt(this.originEqual == null ? -1 : this.originEqual.ordinal());
        dest.writeString(this.originIn);
        dest.writeString(this.systemNameEqual);
        dest.writeString(this.systemNameIn);
    }

    public ConversionProfileAssetParamsBaseFilter(Parcel in) {
        super(in);
        this.conversionProfileIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.conversionProfileIdIn = in.readString();
        this.assetParamsIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.assetParamsIdIn = in.readString();
        int tmpReadyBehaviorEqual = in.readInt();
        this.readyBehaviorEqual = tmpReadyBehaviorEqual == -1 ? null : FlavorReadyBehaviorType.values()[tmpReadyBehaviorEqual];
        this.readyBehaviorIn = in.readString();
        int tmpOriginEqual = in.readInt();
        this.originEqual = tmpOriginEqual == -1 ? null : AssetParamsOrigin.values()[tmpOriginEqual];
