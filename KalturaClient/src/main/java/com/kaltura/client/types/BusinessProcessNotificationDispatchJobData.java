...
public class BusinessProcessNotificationDispatchJobData extends EventNotificationDispatchJobData {
    ...
    public static final Creator<BusinessProcessNotificationDispatchJobData> CREATOR = new Creator<BusinessProcessNotificationDispatchJobData>() {
        @Override
        public BusinessProcessNotificationDispatchJobData createFromParcel(Parcel source) {
            return new BusinessProcessNotificationDispatchJobData(source);
        }

        @Override
        public BusinessProcessNotificationDispatchJobData[] newArray(int size) {
            return new BusinessProcessNotificationDispatchJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.server, flags);
        dest.writeString(this.caseId);
    }

    public BusinessProcessNotificationDispatchJobData(Parcel in) {
        super(in);
        this.server = in.readParcelable(BusinessProcessServer.class.getClassLoader());
