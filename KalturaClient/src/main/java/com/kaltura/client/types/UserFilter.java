...
public class UserFilter extends UserBaseFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.firstNameOrLastNameStartsWith);
        dest.writeString(this.permissionNamesMultiLikeOr);
        dest.writeString(this.permissionNamesMultiLikeAnd);
    }
    ...
    public UserFilter(Parcel in) {
        ...
        this.firstNameOrLastNameStartsWith = in.readString();
        this.permissionNamesMultiLikeOr = in.readString();
        this.permissionNamesMultiLikeAnd = in.readString();
    }
}
