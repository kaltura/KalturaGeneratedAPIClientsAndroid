...
public class FlavorParamsOutput extends FlavorParams {
    ...
    public static final Creator<FlavorParamsOutput> CREATOR = new Creator<FlavorParamsOutput>() {
        @Override
        public FlavorParamsOutput createFromParcel(Parcel source) {
            return new FlavorParamsOutput(source);
        }

        @Override
        public FlavorParamsOutput[] newArray(int size) {
            return new FlavorParamsOutput[size];
        }
    };
