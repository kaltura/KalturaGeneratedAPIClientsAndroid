...
public class DropFolder extends ObjectBase {
    ...
    public static final Creator<DropFolder> CREATOR = new Creator<DropFolder>() {
        @Override
        public DropFolder createFromParcel(Parcel source) {
            return new DropFolder(source);
        }

        @Override
        public DropFolder[] newArray(int size) {
            return new DropFolder[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.fileSizeCheckInterval);
        dest.writeInt(this.fileDeletePolicy == null ? -1 : this.fileDeletePolicy.ordinal());
        dest.writeString(this.fileDeleteRegex);
        dest.writeValue(this.autoFileDeleteDays);
        dest.writeInt(this.fileHandlerType == null ? -1 : this.fileHandlerType.ordinal());
        dest.writeString(this.fileNamePatterns);
        dest.writeParcelable(this.fileHandlerConfig, flags);
        dest.writeString(this.tags);
        dest.writeInt(this.errorCode == null ? -1 : this.errorCode.ordinal());
        dest.writeString(this.errorDescription);
        dest.writeString(this.ignoreFileNamePatterns);
        dest.writeValue(this.createdAt);
        dest.writeValue(this.updatedAt);
        dest.writeValue(this.lastAccessedAt);
        dest.writeValue(this.incremental);
        dest.writeValue(this.lastFileTimestamp);
        dest.writeValue(this.metadataProfileId);
        dest.writeString(this.categoriesMetadataFieldName);
        dest.writeValue(this.enforceEntitlement);
        dest.writeValue(this.shouldValidateKS);
    }

    public DropFolder(Parcel in) {
        super(in);
        ...
        this.status = tmpStatus == -1 ? null : DropFolderStatus.values()[tmpStatus];
        ...
        this.fileSizeCheckInterval = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpFileDeletePolicy = in.readInt();
        this.fileDeletePolicy = tmpFileDeletePolicy == -1 ? null : DropFolderFileDeletePolicy.values()[tmpFileDeletePolicy];
        this.fileDeleteRegex = in.readString();
        this.autoFileDeleteDays = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpFileHandlerType = in.readInt();
        this.fileHandlerType = tmpFileHandlerType == -1 ? null : DropFolderFileHandlerType.values()[tmpFileHandlerType];
        this.fileNamePatterns = in.readString();
        this.fileHandlerConfig = in.readParcelable(DropFolderFileHandlerConfig.class.getClassLoader());
        ...
        this.categoriesMetadataFieldName = in.readString();
        this.enforceEntitlement = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.shouldValidateKS = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
