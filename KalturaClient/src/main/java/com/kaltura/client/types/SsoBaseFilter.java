...
public abstract class SsoBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.applicationTypeEqual);
        dest.writeValue(this.partnerIdEqual);
        dest.writeString(this.domainEqual);
        ...
        dest.writeString(this.redirectUrlEqual);
    }

    public SsoBaseFilter(Parcel in) {
        super(in);
        this.idEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.idIn = in.readString();
        this.applicationTypeEqual = in.readString();
        this.partnerIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.domainEqual = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : SsoStatus.values()[tmpStatusEqual];
        ...
        this.redirectUrlEqual = in.readString();
    }
}
