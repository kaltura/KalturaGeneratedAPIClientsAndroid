...
public class DocumentFlavorParamsOutput extends FlavorParamsOutput {
    ...
    public static final Creator<DocumentFlavorParamsOutput> CREATOR = new Creator<DocumentFlavorParamsOutput>() {
        @Override
        public DocumentFlavorParamsOutput createFromParcel(Parcel source) {
            return new DocumentFlavorParamsOutput(source);
        }

        @Override
        public DocumentFlavorParamsOutput[] newArray(int size) {
            return new DocumentFlavorParamsOutput[size];
        }
    };

    public DocumentFlavorParamsOutput(Parcel in) {
        super(in);
    }
}
