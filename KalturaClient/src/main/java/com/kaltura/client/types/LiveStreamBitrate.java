...
public class LiveStreamBitrate extends ObjectBase {
    ...
    public static final Creator<LiveStreamBitrate> CREATOR = new Creator<LiveStreamBitrate>() {
        @Override
        public LiveStreamBitrate createFromParcel(Parcel source) {
            return new LiveStreamBitrate(source);
        }

        @Override
        public LiveStreamBitrate[] newArray(int size) {
            return new LiveStreamBitrate[size];
        }
    };
    ...
    public LiveStreamBitrate(Parcel in) {
        super(in);
