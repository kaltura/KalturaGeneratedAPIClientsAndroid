...
public class AssetServeOptions extends ObjectBase {
    ...
    public static final Creator<AssetServeOptions> CREATOR = new Creator<AssetServeOptions>() {
        @Override
        public AssetServeOptions createFromParcel(Parcel source) {
            return new AssetServeOptions(source);
        }

        @Override
        public AssetServeOptions[] newArray(int size) {
            return new AssetServeOptions[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.download);
        dest.writeString(this.referrer);
    }

    public AssetServeOptions(Parcel in) {
        super(in);
        this.download = (Boolean)in.readValue(Boolean.class.getClassLoader());
