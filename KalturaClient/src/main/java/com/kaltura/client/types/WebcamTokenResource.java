...
public class WebcamTokenResource extends DataCenterContentResource {
    ...
    public static final Creator<WebcamTokenResource> CREATOR = new Creator<WebcamTokenResource>() {
        @Override
        public WebcamTokenResource createFromParcel(Parcel source) {
            return new WebcamTokenResource(source);
        }

        @Override
        public WebcamTokenResource[] newArray(int size) {
            return new WebcamTokenResource[size];
        }
    };
    ...
    public WebcamTokenResource(Parcel in) {
        super(in);
