...
public class FeedItemInfo extends ObjectBase {
    ...
    public static final Creator<FeedItemInfo> CREATOR = new Creator<FeedItemInfo>() {
        @Override
        public FeedItemInfo createFromParcel(Parcel source) {
            return new FeedItemInfo(source);
        }

        @Override
        public FeedItemInfo[] newArray(int size) {
            return new FeedItemInfo[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.itemXPath);
        dest.writeString(this.itemPublishDateXPath);
        dest.writeString(this.itemUniqueIdentifierXPath);
        dest.writeString(this.itemContentFileSizeXPath);
        dest.writeString(this.itemContentUrlXPath);
        dest.writeString(this.itemContentBitrateXPath);
        dest.writeString(this.itemHashXPath);
        dest.writeString(this.itemContentXpath);
        dest.writeString(this.contentBitrateAttributeName);
    }

    public FeedItemInfo(Parcel in) {
        super(in);
        this.itemXPath = in.readString();
        this.itemPublishDateXPath = in.readString();
        this.itemUniqueIdentifierXPath = in.readString();
        this.itemContentFileSizeXPath = in.readString();
        this.itemContentUrlXPath = in.readString();
        this.itemContentBitrateXPath = in.readString();
        this.itemHashXPath = in.readString();
        this.itemContentXpath = in.readString();
        this.contentBitrateAttributeName = in.readString();
    }
}
