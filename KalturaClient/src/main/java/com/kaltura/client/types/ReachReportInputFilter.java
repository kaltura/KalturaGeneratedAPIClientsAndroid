...
public class ReachReportInputFilter extends ReportInputFilter {
    ...
    public static final Creator<ReachReportInputFilter> CREATOR = new Creator<ReachReportInputFilter>() {
        @Override
        public ReachReportInputFilter createFromParcel(Parcel source) {
            return new ReachReportInputFilter(source);
        }

        @Override
        public ReachReportInputFilter[] newArray(int size) {
            return new ReachReportInputFilter[size];
        }
    };
    ...
    public ReachReportInputFilter(Parcel in) {
        super(in);
