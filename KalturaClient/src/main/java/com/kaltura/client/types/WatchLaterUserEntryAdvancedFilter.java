...
public class WatchLaterUserEntryAdvancedFilter extends SearchItem {
    ...
    public static final Creator<WatchLaterUserEntryAdvancedFilter> CREATOR = new Creator<WatchLaterUserEntryAdvancedFilter>() {
        @Override
        public WatchLaterUserEntryAdvancedFilter createFromParcel(Parcel source) {
            return new WatchLaterUserEntryAdvancedFilter(source);
        }

        @Override
        public WatchLaterUserEntryAdvancedFilter[] newArray(int size) {
            return new WatchLaterUserEntryAdvancedFilter[size];
        }
    };
    ...
    public WatchLaterUserEntryAdvancedFilter(Parcel in) {
        super(in);
