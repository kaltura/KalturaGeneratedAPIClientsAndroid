...
public class ModerationVendorTaskData extends VendorTaskData {
    ...
    public static final Creator<ModerationVendorTaskData> CREATOR = new Creator<ModerationVendorTaskData>() {
        @Override
        public ModerationVendorTaskData createFromParcel(Parcel source) {
            return new ModerationVendorTaskData(source);
        }

        @Override
        public ModerationVendorTaskData[] newArray(int size) {
            return new ModerationVendorTaskData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.ruleIds);
        dest.writeString(this.policyIds);
        dest.writeString(this.categoryIds);
        dest.writeString(this.moderationOutputJson);
    }

    public ModerationVendorTaskData(Parcel in) {
        super(in);
        this.ruleIds = in.readString();
        this.policyIds = in.readString();
        this.categoryIds = in.readString();
        this.moderationOutputJson = in.readString();
    }
}
