...
public class CopyPartnerJobData extends JobData {
    ...
    public static final Creator<CopyPartnerJobData> CREATOR = new Creator<CopyPartnerJobData>() {
        @Override
        public CopyPartnerJobData createFromParcel(Parcel source) {
            return new CopyPartnerJobData(source);
        }

        @Override
        public CopyPartnerJobData[] newArray(int size) {
            return new CopyPartnerJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.fromPartnerId);
        dest.writeValue(this.toPartnerId);
    }

    public CopyPartnerJobData(Parcel in) {
        super(in);
        this.fromPartnerId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.toPartnerId = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
