...
public class MeetingScheduleEventFilter extends MeetingScheduleEventBaseFilter {
    ...
    public static final Creator<MeetingScheduleEventFilter> CREATOR = new Creator<MeetingScheduleEventFilter>() {
        @Override
        public MeetingScheduleEventFilter createFromParcel(Parcel source) {
            return new MeetingScheduleEventFilter(source);
        }

        @Override
        public MeetingScheduleEventFilter[] newArray(int size) {
            return new MeetingScheduleEventFilter[size];
        }
    };

    public MeetingScheduleEventFilter(Parcel in) {
        super(in);
    }
}
