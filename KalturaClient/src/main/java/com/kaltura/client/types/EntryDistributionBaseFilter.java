...
public abstract class EntryDistributionBaseFilter extends RelatedFilter {
    ...
    public EntryDistributionBaseFilter(Parcel in) {
        ...
        this.submittedAtGreaterThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        this.submittedAtLessThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        ...
        this.sunriseGreaterThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        this.sunriseLessThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        this.sunsetGreaterThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        this.sunsetLessThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
    }
}
