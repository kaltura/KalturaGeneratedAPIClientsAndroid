...
public abstract class EntryDistributionBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.submittedAtGreaterThanOrEqual);
        dest.writeValue(this.submittedAtLessThanOrEqual);
        dest.writeString(this.entryIdEqual);
        dest.writeString(this.entryIdIn);
        dest.writeValue(this.distributionProfileIdEqual);
        dest.writeString(this.distributionProfileIdIn);
        dest.writeInt(this.statusEqual == null ? -1 : this.statusEqual.ordinal());
        dest.writeString(this.statusIn);
        dest.writeInt(this.dirtyStatusEqual == null ? -1 : this.dirtyStatusEqual.ordinal());
        dest.writeString(this.dirtyStatusIn);
        dest.writeValue(this.sunriseGreaterThanOrEqual);
        dest.writeValue(this.sunriseLessThanOrEqual);
        dest.writeValue(this.sunsetGreaterThanOrEqual);
        dest.writeValue(this.sunsetLessThanOrEqual);
    }

    public EntryDistributionBaseFilter(Parcel in) {
        super(in);
        ...
        this.submittedAtGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.submittedAtLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.entryIdEqual = in.readString();
        this.entryIdIn = in.readString();
        this.distributionProfileIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.distributionProfileIdIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : EntryDistributionStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpDirtyStatusEqual = in.readInt();
        this.dirtyStatusEqual = tmpDirtyStatusEqual == -1 ? null : EntryDistributionFlag.values()[tmpDirtyStatusEqual];
        this.dirtyStatusIn = in.readString();
        this.sunriseGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.sunriseLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.sunsetGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.sunsetLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
