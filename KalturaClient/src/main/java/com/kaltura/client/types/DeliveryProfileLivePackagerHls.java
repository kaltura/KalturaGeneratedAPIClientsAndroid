...
public class DeliveryProfileLivePackagerHls extends DeliveryProfileLivePackager {
    ...
    public static final Creator<DeliveryProfileLivePackagerHls> CREATOR = new Creator<DeliveryProfileLivePackagerHls>() {
        @Override
        public DeliveryProfileLivePackagerHls createFromParcel(Parcel source) {
            return new DeliveryProfileLivePackagerHls(source);
        }

        @Override
        public DeliveryProfileLivePackagerHls[] newArray(int size) {
            return new DeliveryProfileLivePackagerHls[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.disableExtraAttributes);
        dest.writeValue(this.forceProxy);
    }

    public DeliveryProfileLivePackagerHls(Parcel in) {
        super(in);
        this.disableExtraAttributes = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.forceProxy = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
