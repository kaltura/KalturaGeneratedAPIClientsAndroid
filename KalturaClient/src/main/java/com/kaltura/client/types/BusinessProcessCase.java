...
public class BusinessProcessCase extends ObjectBase {
    ...
    public static final Creator<BusinessProcessCase> CREATOR = new Creator<BusinessProcessCase>() {
        @Override
        public BusinessProcessCase createFromParcel(Parcel source) {
            return new BusinessProcessCase(source);
        }

        @Override
        public BusinessProcessCase[] newArray(int size) {
            return new BusinessProcessCase[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.businessProcessStartNotificationTemplateId);
        dest.writeValue(this.suspended);
        dest.writeString(this.activityId);
    }

    public BusinessProcessCase(Parcel in) {
        super(in);
        this.id = in.readString();
        this.businessProcessId = in.readString();
        this.businessProcessStartNotificationTemplateId = (Integer)in.readValue(Integer.class.getClassLoader());
