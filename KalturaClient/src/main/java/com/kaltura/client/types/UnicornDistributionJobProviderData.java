...
public class UnicornDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<UnicornDistributionJobProviderData> CREATOR = new Creator<UnicornDistributionJobProviderData>() {
        @Override
        public UnicornDistributionJobProviderData createFromParcel(Parcel source) {
            return new UnicornDistributionJobProviderData(source);
        }

        @Override
        public UnicornDistributionJobProviderData[] newArray(int size) {
            return new UnicornDistributionJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.catalogGuid);
        dest.writeString(this.title);
        dest.writeValue(this.mediaChanged);
        dest.writeString(this.flavorAssetVersion);
        dest.writeString(this.notificationBaseUrl);
    }

    public UnicornDistributionJobProviderData(Parcel in) {
        super(in);
        this.catalogGuid = in.readString();
        this.title = in.readString();
        this.mediaChanged = (Boolean)in.readValue(Boolean.class.getClassLoader());
        this.flavorAssetVersion = in.readString();
        this.notificationBaseUrl = in.readString();
    }
}
