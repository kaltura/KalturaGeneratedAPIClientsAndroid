...
public class LiveStreamScheduleEventFilter extends LiveStreamScheduleEventBaseFilter {
    ...
    public static final Creator<LiveStreamScheduleEventFilter> CREATOR = new Creator<LiveStreamScheduleEventFilter>() {
        @Override
        public LiveStreamScheduleEventFilter createFromParcel(Parcel source) {
            return new LiveStreamScheduleEventFilter(source);
        }

        @Override
        public LiveStreamScheduleEventFilter[] newArray(int size) {
            return new LiveStreamScheduleEventFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.sourceEntryIdEqual);
    }

    public LiveStreamScheduleEventFilter(Parcel in) {
        super(in);
        this.sourceEntryIdEqual = in.readString();
    }
}
