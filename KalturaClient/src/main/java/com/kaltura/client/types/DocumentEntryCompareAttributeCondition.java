...
public class DocumentEntryCompareAttributeCondition extends SearchComparableAttributeCondition {
    ...
    public static final Creator<DocumentEntryCompareAttributeCondition> CREATOR = new Creator<DocumentEntryCompareAttributeCondition>() {
        @Override
        public DocumentEntryCompareAttributeCondition createFromParcel(Parcel source) {
            return new DocumentEntryCompareAttributeCondition(source);
        }

        @Override
        public DocumentEntryCompareAttributeCondition[] newArray(int size) {
            return new DocumentEntryCompareAttributeCondition[size];
        }
    };
    ...
    public DocumentEntryCompareAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : DocumentEntryCompareAttribute.values()[tmpAttribute];
    }
}
