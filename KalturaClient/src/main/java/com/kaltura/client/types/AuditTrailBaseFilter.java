...
public abstract class AuditTrailBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.parsedAtGreaterThanOrEqual);
        dest.writeValue(this.parsedAtLessThanOrEqual);
        dest.writeInt(this.statusEqual == null ? -1 : this.statusEqual.ordinal());
        dest.writeString(this.statusIn);
        dest.writeInt(this.auditObjectTypeEqual == null ? -1 : this.auditObjectTypeEqual.ordinal());
        dest.writeString(this.auditObjectTypeIn);
        dest.writeString(this.objectIdEqual);
        dest.writeString(this.objectIdIn);
        dest.writeString(this.relatedObjectIdEqual);
        dest.writeString(this.relatedObjectIdIn);
        dest.writeInt(this.relatedObjectTypeEqual == null ? -1 : this.relatedObjectTypeEqual.ordinal());
        dest.writeString(this.relatedObjectTypeIn);
        dest.writeString(this.entryIdEqual);
        dest.writeString(this.entryIdIn);
        dest.writeValue(this.masterPartnerIdEqual);
        dest.writeString(this.masterPartnerIdIn);
        dest.writeValue(this.partnerIdEqual);
        dest.writeString(this.partnerIdIn);
        dest.writeString(this.requestIdEqual);
        dest.writeString(this.requestIdIn);
        dest.writeString(this.userIdEqual);
        dest.writeString(this.userIdIn);
        dest.writeInt(this.actionEqual == null ? -1 : this.actionEqual.ordinal());
        dest.writeString(this.actionIn);
        dest.writeString(this.ksEqual);
        dest.writeInt(this.contextEqual == null ? -1 : this.contextEqual.ordinal());
        dest.writeString(this.contextIn);
        dest.writeString(this.entryPointEqual);
        dest.writeString(this.entryPointIn);
        dest.writeString(this.serverNameEqual);
        dest.writeString(this.serverNameIn);
        dest.writeString(this.ipAddressEqual);
        dest.writeString(this.ipAddressIn);
        dest.writeString(this.clientTagEqual);
    }

    public AuditTrailBaseFilter(Parcel in) {
        super(in);
        ...
        this.parsedAtGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.parsedAtLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : AuditTrailStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpAuditObjectTypeEqual = in.readInt();
        this.auditObjectTypeEqual = tmpAuditObjectTypeEqual == -1 ? null : AuditTrailObjectType.values()[tmpAuditObjectTypeEqual];
        this.auditObjectTypeIn = in.readString();
        this.objectIdEqual = in.readString();
        this.objectIdIn = in.readString();
        this.relatedObjectIdEqual = in.readString();
        this.relatedObjectIdIn = in.readString();
        int tmpRelatedObjectTypeEqual = in.readInt();
        this.relatedObjectTypeEqual = tmpRelatedObjectTypeEqual == -1 ? null : AuditTrailObjectType.values()[tmpRelatedObjectTypeEqual];
        this.relatedObjectTypeIn = in.readString();
        this.entryIdEqual = in.readString();
        this.entryIdIn = in.readString();
        this.masterPartnerIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.masterPartnerIdIn = in.readString();
        this.partnerIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.partnerIdIn = in.readString();
        this.requestIdEqual = in.readString();
        this.requestIdIn = in.readString();
        this.userIdEqual = in.readString();
        this.userIdIn = in.readString();
        int tmpActionEqual = in.readInt();
        this.actionEqual = tmpActionEqual == -1 ? null : AuditTrailAction.values()[tmpActionEqual];
        this.actionIn = in.readString();
        this.ksEqual = in.readString();
        int tmpContextEqual = in.readInt();
        this.contextEqual = tmpContextEqual == -1 ? null : AuditTrailContext.values()[tmpContextEqual];
        this.contextIn = in.readString();
        this.entryPointEqual = in.readString();
        this.entryPointIn = in.readString();
        this.serverNameEqual = in.readString();
        this.serverNameIn = in.readString();
        this.ipAddressEqual = in.readString();
        this.ipAddressIn = in.readString();
        this.clientTagEqual = in.readString();
    }
}
