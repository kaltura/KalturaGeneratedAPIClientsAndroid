...
public class LocationScheduleResource extends ScheduleResource {
    ...
    public static final Creator<LocationScheduleResource> CREATOR = new Creator<LocationScheduleResource>() {
        @Override
        public LocationScheduleResource createFromParcel(Parcel source) {
            return new LocationScheduleResource(source);
        }

        @Override
        public LocationScheduleResource[] newArray(int size) {
            return new LocationScheduleResource[size];
        }
    };

    public LocationScheduleResource(Parcel in) {
        super(in);
    }
}
