...
public class BulkUploadResultScheduleEvent extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultScheduleEvent> CREATOR = new Creator<BulkUploadResultScheduleEvent>() {
        @Override
        public BulkUploadResultScheduleEvent createFromParcel(Parcel source) {
            return new BulkUploadResultScheduleEvent(source);
        }

        @Override
        public BulkUploadResultScheduleEvent[] newArray(int size) {
            return new BulkUploadResultScheduleEvent[size];
        }
    };
