...
public class ESearchRange extends ObjectBase {
    ...
    public static final Creator<ESearchRange> CREATOR = new Creator<ESearchRange>() {
        @Override
        public ESearchRange createFromParcel(Parcel source) {
            return new ESearchRange(source);
        }

        @Override
        public ESearchRange[] newArray(int size) {
            return new ESearchRange[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.greaterThanOrEqual);
        dest.writeValue(this.lessThanOrEqual);
        dest.writeValue(this.greaterThan);
        dest.writeValue(this.lessThan);
    }

    public ESearchRange(Parcel in) {
        super(in);
        this.greaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.greaterThan = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lessThan = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
