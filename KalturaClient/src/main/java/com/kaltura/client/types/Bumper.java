...
public class Bumper extends ObjectBase {
    ...
    public static final Creator<Bumper> CREATOR = new Creator<Bumper>() {
        @Override
        public Bumper createFromParcel(Parcel source) {
            return new Bumper(source);
        }

        @Override
        public Bumper[] newArray(int size) {
            return new Bumper[size];
        }
    };
