...
public class SwfFlavorParamsOutput extends FlavorParamsOutput {
    ...
    public static final Creator<SwfFlavorParamsOutput> CREATOR = new Creator<SwfFlavorParamsOutput>() {
        @Override
        public SwfFlavorParamsOutput createFromParcel(Parcel source) {
            return new SwfFlavorParamsOutput(source);
        }

        @Override
        public SwfFlavorParamsOutput[] newArray(int size) {
            return new SwfFlavorParamsOutput[size];
        }
    };
    ...
    public SwfFlavorParamsOutput(Parcel in) {
        super(in);
