...
public class BatchJobFilterExt extends BatchJobFilter {
    ...
    public static final Creator<BatchJobFilterExt> CREATOR = new Creator<BatchJobFilterExt>() {
        @Override
        public BatchJobFilterExt createFromParcel(Parcel source) {
            return new BatchJobFilterExt(source);
        }

        @Override
        public BatchJobFilterExt[] newArray(int size) {
            return new BatchJobFilterExt[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.jobTypeAndSubTypeIn);
    }

    public BatchJobFilterExt(Parcel in) {
        super(in);
        this.jobTypeAndSubTypeIn = in.readString();
    }
}
