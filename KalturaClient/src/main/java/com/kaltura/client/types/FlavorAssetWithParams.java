...
public class FlavorAssetWithParams extends ObjectBase {
    ...
    public static final Creator<FlavorAssetWithParams> CREATOR = new Creator<FlavorAssetWithParams>() {
        @Override
        public FlavorAssetWithParams createFromParcel(Parcel source) {
            return new FlavorAssetWithParams(source);
        }

        @Override
        public FlavorAssetWithParams[] newArray(int size) {
            return new FlavorAssetWithParams[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.flavorAsset, flags);
        dest.writeParcelable(this.flavorParams, flags);
        dest.writeString(this.entryId);
    }

    public FlavorAssetWithParams(Parcel in) {
        super(in);
        this.flavorAsset = in.readParcelable(FlavorAsset.class.getClassLoader());
        this.flavorParams = in.readParcelable(FlavorParams.class.getClassLoader());
