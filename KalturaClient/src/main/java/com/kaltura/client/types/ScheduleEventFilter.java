...
public class ScheduleEventFilter extends ScheduleEventBaseFilter {
    ...
    public static final Creator<ScheduleEventFilter> CREATOR = new Creator<ScheduleEventFilter>() {
        @Override
        public ScheduleEventFilter createFromParcel(Parcel source) {
            return new ScheduleEventFilter(source);
        }

        @Override
        public ScheduleEventFilter[] newArray(int size) {
            return new ScheduleEventFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.resourceIdsLike);
        dest.writeString(this.resourceIdsMultiLikeOr);
        dest.writeString(this.resourceIdsMultiLikeAnd);
        dest.writeString(this.parentResourceIdsLike);
        dest.writeString(this.parentResourceIdsMultiLikeOr);
        dest.writeString(this.parentResourceIdsMultiLikeAnd);
        dest.writeString(this.templateEntryCategoriesIdsMultiLikeAnd);
        dest.writeString(this.templateEntryCategoriesIdsMultiLikeOr);
        dest.writeString(this.resourceSystemNamesMultiLikeOr);
        dest.writeString(this.templateEntryCategoriesIdsLike);
        dest.writeString(this.resourceSystemNamesMultiLikeAnd);
        dest.writeString(this.resourceSystemNamesLike);
        dest.writeString(this.resourceIdEqual);
    }

    public ScheduleEventFilter(Parcel in) {
        super(in);
        this.resourceIdsLike = in.readString();
        this.resourceIdsMultiLikeOr = in.readString();
        this.resourceIdsMultiLikeAnd = in.readString();
        this.parentResourceIdsLike = in.readString();
        this.parentResourceIdsMultiLikeOr = in.readString();
        this.parentResourceIdsMultiLikeAnd = in.readString();
        this.templateEntryCategoriesIdsMultiLikeAnd = in.readString();
        this.templateEntryCategoriesIdsMultiLikeOr = in.readString();
        this.resourceSystemNamesMultiLikeOr = in.readString();
        this.templateEntryCategoriesIdsLike = in.readString();
        this.resourceSystemNamesMultiLikeAnd = in.readString();
        this.resourceSystemNamesLike = in.readString();
        this.resourceIdEqual = in.readString();
    }
}
