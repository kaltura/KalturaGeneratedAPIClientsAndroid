...
public class ThumbParamsOutput extends ThumbParams {
    ...
    public static final Creator<ThumbParamsOutput> CREATOR = new Creator<ThumbParamsOutput>() {
        @Override
        public ThumbParamsOutput createFromParcel(Parcel source) {
            return new ThumbParamsOutput(source);
        }

        @Override
        public ThumbParamsOutput[] newArray(int size) {
            return new ThumbParamsOutput[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.thumbParamsVersion);
        dest.writeString(this.thumbAssetId);
        dest.writeString(this.thumbAssetVersion);
        dest.writeValue(this.rotate);
    }

    public ThumbParamsOutput(Parcel in) {
        super(in);
        this.thumbParamsId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.thumbParamsVersion = in.readString();
        this.thumbAssetId = in.readString();
        this.thumbAssetVersion = in.readString();
