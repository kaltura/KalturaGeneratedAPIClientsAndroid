...
public class PlayReadyDigitalAudioOPIdHolder extends ObjectBase {
    ...
    public static final Creator<PlayReadyDigitalAudioOPIdHolder> CREATOR = new Creator<PlayReadyDigitalAudioOPIdHolder>() {
        @Override
        public PlayReadyDigitalAudioOPIdHolder createFromParcel(Parcel source) {
            return new PlayReadyDigitalAudioOPIdHolder(source);
        }

        @Override
        public PlayReadyDigitalAudioOPIdHolder[] newArray(int size) {
            return new PlayReadyDigitalAudioOPIdHolder[size];
        }
    };
    ...
    public PlayReadyDigitalAudioOPIdHolder(Parcel in) {
        super(in);
        int tmpType = in.readInt();
        this.type = tmpType == -1 ? null : PlayReadyDigitalAudioOPId.values()[tmpType];
    }
}
