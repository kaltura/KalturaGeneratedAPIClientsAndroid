...
public class PlayReadyProfileFilter extends PlayReadyProfileBaseFilter {
    ...
    public static final Creator<PlayReadyProfileFilter> CREATOR = new Creator<PlayReadyProfileFilter>() {
        @Override
        public PlayReadyProfileFilter createFromParcel(Parcel source) {
            return new PlayReadyProfileFilter(source);
        }

        @Override
        public PlayReadyProfileFilter[] newArray(int size) {
            return new PlayReadyProfileFilter[size];
        }
    };

    public PlayReadyProfileFilter(Parcel in) {
        super(in);
    }
}
