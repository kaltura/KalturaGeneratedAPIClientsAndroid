...
public abstract class ServerNodeBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.heartbeatTimeGreaterThanOrEqual);
        dest.writeValue(this.heartbeatTimeLessThanOrEqual);
        dest.writeString(this.nameEqual);
        dest.writeString(this.nameIn);
        dest.writeString(this.systemNameEqual);
        dest.writeString(this.systemNameIn);
        dest.writeString(this.hostNameLike);
        dest.writeString(this.hostNameMultiLikeOr);
        dest.writeString(this.hostNameMultiLikeAnd);
    ...
    public ServerNodeBaseFilter(Parcel in) {
        ...
        this.heartbeatTimeGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.heartbeatTimeLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.nameEqual = in.readString();
        this.nameIn = in.readString();
        this.systemNameEqual = in.readString();
        this.systemNameIn = in.readString();
        this.hostNameLike = in.readString();
        this.hostNameMultiLikeOr = in.readString();
        this.hostNameMultiLikeAnd = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : ServerNodeStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpTypeEqual = in.readInt();
        this.typeEqual = tmpTypeEqual == -1 ? null : ServerNodeType.values()[tmpTypeEqual];
