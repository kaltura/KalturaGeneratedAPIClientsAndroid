...
public abstract class FileAssetBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.fileAssetObjectTypeEqual == null ? -1 : this.fileAssetObjectTypeEqual.ordinal());
    ...
    public FileAssetBaseFilter(Parcel in) {
        super(in);
        ...
        int tmpFileAssetObjectTypeEqual = in.readInt();
        this.fileAssetObjectTypeEqual = tmpFileAssetObjectTypeEqual == -1 ? null : FileAssetObjectType.values()[tmpFileAssetObjectTypeEqual];
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : FileAssetStatus.values()[tmpStatusEqual];
