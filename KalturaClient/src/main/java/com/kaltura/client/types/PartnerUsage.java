...
public class PartnerUsage extends ObjectBase {
    ...
    public static final Creator<PartnerUsage> CREATOR = new Creator<PartnerUsage>() {
        @Override
        public PartnerUsage createFromParcel(Parcel source) {
            return new PartnerUsage(source);
        }

        @Override
        public PartnerUsage[] newArray(int size) {
            return new PartnerUsage[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.hostingGB);
        dest.writeValue(this.Percent);
        dest.writeValue(this.packageBW);
        dest.writeValue(this.usageGB);
        dest.writeValue(this.reachedLimitDate);
        dest.writeString(this.usageGraph);
    }

    public PartnerUsage(Parcel in) {
        super(in);
        this.hostingGB = (Double)in.readValue(Double.class.getClassLoader());
        this.Percent = (Double)in.readValue(Double.class.getClassLoader());
        this.packageBW = (Integer)in.readValue(Integer.class.getClassLoader());
        this.usageGB = (Double)in.readValue(Double.class.getClassLoader());
        this.reachedLimitDate = (Integer)in.readValue(Integer.class.getClassLoader());
        this.usageGraph = in.readString();
    }
}
