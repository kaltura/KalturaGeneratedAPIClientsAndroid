...
public abstract class BatchJobBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.partnerIdNotIn);
        ...
        dest.writeValue(this.executionAttemptsGreaterThanOrEqual);
        dest.writeValue(this.executionAttemptsLessThanOrEqual);
        dest.writeValue(this.lockVersionGreaterThanOrEqual);
        dest.writeValue(this.lockVersionLessThanOrEqual);
        dest.writeString(this.entryIdEqual);
        dest.writeInt(this.jobTypeEqual == null ? -1 : this.jobTypeEqual.ordinal());
        dest.writeString(this.jobTypeIn);
        dest.writeString(this.jobTypeNotIn);
        dest.writeValue(this.jobSubTypeEqual);
        dest.writeString(this.jobSubTypeIn);
        dest.writeString(this.jobSubTypeNotIn);
        ...
        dest.writeValue(this.priorityGreaterThanOrEqual);
        dest.writeValue(this.priorityLessThanOrEqual);
        dest.writeValue(this.priorityEqual);
        dest.writeString(this.priorityIn);
        dest.writeString(this.priorityNotIn);
        dest.writeValue(this.batchVersionGreaterThanOrEqual);
        dest.writeValue(this.batchVersionLessThanOrEqual);
        dest.writeValue(this.batchVersionEqual);
        dest.writeValue(this.queueTimeGreaterThanOrEqual);
        dest.writeValue(this.queueTimeLessThanOrEqual);
        dest.writeValue(this.finishTimeGreaterThanOrEqual);
        dest.writeValue(this.finishTimeLessThanOrEqual);
        dest.writeInt(this.errTypeEqual == null ? -1 : this.errTypeEqual.ordinal());
        dest.writeString(this.errTypeIn);
        dest.writeString(this.errTypeNotIn);
        dest.writeValue(this.errNumberEqual);
        dest.writeString(this.errNumberIn);
        dest.writeString(this.errNumberNotIn);
        dest.writeValue(this.estimatedEffortLessThan);
        dest.writeValue(this.estimatedEffortGreaterThan);
        dest.writeValue(this.urgencyLessThanOrEqual);
        dest.writeValue(this.urgencyGreaterThanOrEqual);
    }

    public BatchJobBaseFilter(Parcel in) {
        super(in);
        this.idEqual = (Long)in.readValue(Long.class.getClassLoader());
        this.idGreaterThanOrEqual = (Long)in.readValue(Long.class.getClassLoader());
        this.partnerIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.partnerIdIn = in.readString();
        this.partnerIdNotIn = in.readString();
        ...
        this.executionAttemptsGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.executionAttemptsLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lockVersionGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.lockVersionLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.entryIdEqual = in.readString();
        int tmpJobTypeEqual = in.readInt();
        this.jobTypeEqual = tmpJobTypeEqual == -1 ? null : BatchJobType.values()[tmpJobTypeEqual];
        this.jobTypeIn = in.readString();
        this.jobTypeNotIn = in.readString();
        this.jobSubTypeEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.jobSubTypeIn = in.readString();
        this.jobSubTypeNotIn = in.readString();
        ...
        this.priorityGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.priorityLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.priorityEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.priorityIn = in.readString();
        this.priorityNotIn = in.readString();
        this.batchVersionGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.batchVersionLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.batchVersionEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        int tmpErrTypeEqual = in.readInt();
        this.errTypeEqual = tmpErrTypeEqual == -1 ? null : BatchJobErrorTypes.values()[tmpErrTypeEqual];
        this.errTypeIn = in.readString();
        this.errTypeNotIn = in.readString();
        this.errNumberEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.errNumberIn = in.readString();
        this.errNumberNotIn = in.readString();
        this.estimatedEffortLessThan = (Integer)in.readValue(Integer.class.getClassLoader());
        this.estimatedEffortGreaterThan = (Integer)in.readValue(Integer.class.getClassLoader());
        this.urgencyLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.urgencyGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
