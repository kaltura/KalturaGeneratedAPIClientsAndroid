...
public abstract class CategoryBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.parentIdIn);
        dest.writeValue(this.depthEqual);
        dest.writeString(this.fullNameEqual);
        dest.writeString(this.fullNameStartsWith);
        dest.writeString(this.fullNameIn);
        dest.writeString(this.fullIdsEqual);
        dest.writeString(this.fullIdsStartsWith);
        dest.writeString(this.fullIdsMatchOr);
        ...
        dest.writeInt(this.appearInListEqual == null ? -1 : this.appearInListEqual.ordinal());
        dest.writeInt(this.privacyEqual == null ? -1 : this.privacyEqual.ordinal());
        dest.writeString(this.privacyIn);
        ...
        dest.writeInt(this.referenceIdEmpty == null ? -1 : this.referenceIdEmpty.ordinal());
        ...
        dest.writeValue(this.pendingMembersCountGreaterThanOrEqual);
        dest.writeValue(this.pendingMembersCountLessThanOrEqual);
        ...
        dest.writeValue(this.inheritedParentIdEqual);
        dest.writeString(this.inheritedParentIdIn);
        dest.writeValue(this.partnerSortValueGreaterThanOrEqual);
        dest.writeValue(this.partnerSortValueLessThanOrEqual);
        dest.writeString(this.aggregationCategoriesMultiLikeOr);
        dest.writeString(this.aggregationCategoriesMultiLikeAnd);
    }

    public CategoryBaseFilter(Parcel in) {
        super(in);
        ...
        this.parentIdIn = in.readString();
        this.depthEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.fullNameEqual = in.readString();
        this.fullNameStartsWith = in.readString();
        this.fullNameIn = in.readString();
        this.fullIdsEqual = in.readString();
        this.fullIdsStartsWith = in.readString();
        this.fullIdsMatchOr = in.readString();
        ...
        int tmpAppearInListEqual = in.readInt();
        this.appearInListEqual = tmpAppearInListEqual == -1 ? null : AppearInListType.values()[tmpAppearInListEqual];
        int tmpPrivacyEqual = in.readInt();
        this.privacyEqual = tmpPrivacyEqual == -1 ? null : PrivacyType.values()[tmpPrivacyEqual];
        this.privacyIn = in.readString();
        int tmpInheritanceTypeEqual = in.readInt();
        ...
        int tmpReferenceIdEmpty = in.readInt();
        this.referenceIdEmpty = tmpReferenceIdEmpty == -1 ? null : Boolean.values()[tmpReferenceIdEmpty];
        ...
        this.membersCountLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.pendingMembersCountGreaterThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.pendingMembersCountLessThanOrEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.privacyContextEqual = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : CategoryStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        this.inheritedParentIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.inheritedParentIdIn = in.readString();
        ...
        this.aggregationCategoriesMultiLikeOr = in.readString();
        this.aggregationCategoriesMultiLikeAnd = in.readString();
    }
}
