...
public class CategoryUser extends ObjectBase {
    ...
    public static final Creator<CategoryUser> CREATOR = new Creator<CategoryUser>() {
        @Override
        public CategoryUser createFromParcel(Parcel source) {
            return new CategoryUser(source);
        }

        @Override
        public CategoryUser[] newArray(int size) {
            return new CategoryUser[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.updateMethod == null ? -1 : this.updateMethod.ordinal());
        dest.writeString(this.categoryFullIds);
        dest.writeString(this.permissionNames);
    }

    public CategoryUser(Parcel in) {
        super(in);
