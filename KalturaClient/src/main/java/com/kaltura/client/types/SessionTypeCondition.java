...
public class SessionTypeCondition extends Condition {
    ...
    public static final Creator<SessionTypeCondition> CREATOR = new Creator<SessionTypeCondition>() {
        @Override
        public SessionTypeCondition createFromParcel(Parcel source) {
            return new SessionTypeCondition(source);
        }

        @Override
        public SessionTypeCondition[] newArray(int size) {
            return new SessionTypeCondition[size];
        }
    };
    ...
    public SessionTypeCondition(Parcel in) {
        super(in);
