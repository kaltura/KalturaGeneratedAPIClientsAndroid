...
public class VendorCatalogItemFilter extends VendorCatalogItemBaseFilter {
    ...
    public static final Creator<VendorCatalogItemFilter> CREATOR = new Creator<VendorCatalogItemFilter>() {
        @Override
        public VendorCatalogItemFilter createFromParcel(Parcel source) {
            return new VendorCatalogItemFilter(source);
        }

        @Override
        public VendorCatalogItemFilter[] newArray(int size) {
            return new VendorCatalogItemFilter[size];
        }
    };
