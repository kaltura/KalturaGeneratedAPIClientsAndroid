...
public class DeliveryProfileHttp extends DeliveryProfile {
    ...
    public static final Creator<DeliveryProfileHttp> CREATOR = new Creator<DeliveryProfileHttp>() {
        @Override
        public DeliveryProfileHttp createFromParcel(Parcel source) {
            return new DeliveryProfileHttp(source);
        }

        @Override
        public DeliveryProfileHttp[] newArray(int size) {
            return new DeliveryProfileHttp[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.maxSize);
    }

    public DeliveryProfileHttp(Parcel in) {
        super(in);
        this.maxSize = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
