...
public class UserEntryFilter extends UserEntryBaseFilter {
    ...
    public static final Creator<UserEntryFilter> CREATOR = new Creator<UserEntryFilter>() {
        @Override
        public UserEntryFilter createFromParcel(Parcel source) {
            return new UserEntryFilter(source);
        }

        @Override
        public UserEntryFilter[] newArray(int size) {
            return new UserEntryFilter[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.isAnonymous == null ? -1 : this.isAnonymous.ordinal());
    ...
    public UserEntryFilter(Parcel in) {
        ...
        int tmpIsAnonymous = in.readInt();
        this.isAnonymous = tmpIsAnonymous == -1 ? null : Boolean.values()[tmpIsAnonymous];
