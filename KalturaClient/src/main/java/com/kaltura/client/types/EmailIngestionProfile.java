...
public class EmailIngestionProfile extends ObjectBase {
    ...
    public static final Creator<EmailIngestionProfile> CREATOR = new Creator<EmailIngestionProfile>() {
        @Override
        public EmailIngestionProfile createFromParcel(Parcel source) {
            return new EmailIngestionProfile(source);
        }

        @Override
        public EmailIngestionProfile[] newArray(int size) {
            return new EmailIngestionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.conversionProfile2Id);
        ...
        dest.writeString(this.defaultTags);
        dest.writeString(this.defaultAdminTags);
        dest.writeValue(this.maxAttachmentSizeKbytes);
        dest.writeValue(this.maxAttachmentsPerMail);
    }

    public EmailIngestionProfile(Parcel in) {
        super(in);
        this.id = (Integer)in.readValue(Integer.class.getClassLoader());
        this.name = in.readString();
        this.description = in.readString();
        this.emailAddress = in.readString();
        this.mailboxId = in.readString();
        this.partnerId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.conversionProfile2Id = (Integer)in.readValue(Integer.class.getClassLoader());
        ...
        this.status = tmpStatus == -1 ? null : EmailIngestionProfileStatus.values()[tmpStatus];
        this.createdAt = in.readString();
        this.defaultCategory = in.readString();
        this.defaultUserId = in.readString();
        this.defaultTags = in.readString();
        this.defaultAdminTags = in.readString();
        this.maxAttachmentSizeKbytes = (Integer)in.readValue(Integer.class.getClassLoader());
        this.maxAttachmentsPerMail = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
