...
public class ImageFlavorParamsOutput extends FlavorParamsOutput {
    ...
    public static final Creator<ImageFlavorParamsOutput> CREATOR = new Creator<ImageFlavorParamsOutput>() {
        @Override
        public ImageFlavorParamsOutput createFromParcel(Parcel source) {
            return new ImageFlavorParamsOutput(source);
        }

        @Override
        public ImageFlavorParamsOutput[] newArray(int size) {
            return new ImageFlavorParamsOutput[size];
        }
    };
    ...
    public ImageFlavorParamsOutput(Parcel in) {
        super(in);
