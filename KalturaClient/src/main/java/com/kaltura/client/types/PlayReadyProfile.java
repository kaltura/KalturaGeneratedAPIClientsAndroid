...
public class PlayReadyProfile extends DrmProfile {
    ...
    public static final Creator<PlayReadyProfile> CREATOR = new Creator<PlayReadyProfile>() {
        @Override
        public PlayReadyProfile createFromParcel(Parcel source) {
            return new PlayReadyProfile(source);
        }

        @Override
        public PlayReadyProfile[] newArray(int size) {
            return new PlayReadyProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.keySeed);
    }

    public PlayReadyProfile(Parcel in) {
        super(in);
        this.keySeed = in.readString();
    }
}
