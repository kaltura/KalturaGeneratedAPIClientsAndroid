...
public class LiveReportExportParams extends ObjectBase {
    ...
    public static final Creator<LiveReportExportParams> CREATOR = new Creator<LiveReportExportParams>() {
        @Override
        public LiveReportExportParams createFromParcel(Parcel source) {
            return new LiveReportExportParams(source);
        }

        @Override
        public LiveReportExportParams[] newArray(int size) {
            return new LiveReportExportParams[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.recpientEmail);
        dest.writeValue(this.timeZoneOffset);
        dest.writeString(this.applicationUrlTemplate);
    }

    public LiveReportExportParams(Parcel in) {
        super(in);
        this.entryIds = in.readString();
        this.recpientEmail = in.readString();
        this.timeZoneOffset = (Integer)in.readValue(Integer.class.getClassLoader());
        this.applicationUrlTemplate = in.readString();
    }
}
