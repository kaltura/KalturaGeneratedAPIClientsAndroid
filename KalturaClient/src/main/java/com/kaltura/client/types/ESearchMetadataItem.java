...
public class ESearchMetadataItem extends ESearchItem {
    ...
    public static final Creator<ESearchMetadataItem> CREATOR = new Creator<ESearchMetadataItem>() {
        @Override
        public ESearchMetadataItem createFromParcel(Parcel source) {
            return new ESearchMetadataItem(source);
        }

        @Override
        public ESearchMetadataItem[] newArray(int size) {
            return new ESearchMetadataItem[size];
        }
    };
    ...
    public ESearchMetadataItem(Parcel in) {
        super(in);
