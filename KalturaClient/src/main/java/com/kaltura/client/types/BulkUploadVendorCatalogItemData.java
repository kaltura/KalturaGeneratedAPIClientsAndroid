...
public class BulkUploadVendorCatalogItemData extends BulkUploadObjectData {
    ...
    public static final Creator<BulkUploadVendorCatalogItemData> CREATOR = new Creator<BulkUploadVendorCatalogItemData>() {
        @Override
        public BulkUploadVendorCatalogItemData createFromParcel(Parcel source) {
            return new BulkUploadVendorCatalogItemData(source);
        }

        @Override
        public BulkUploadVendorCatalogItemData[] newArray(int size) {
            return new BulkUploadVendorCatalogItemData[size];
        }
    };

    public BulkUploadVendorCatalogItemData(Parcel in) {
        super(in);
    }
}
