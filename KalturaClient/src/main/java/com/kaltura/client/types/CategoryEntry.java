...
public class CategoryEntry extends ObjectBase {
    ...
    public static final Creator<CategoryEntry> CREATOR = new Creator<CategoryEntry>() {
        @Override
        public CategoryEntry createFromParcel(Parcel source) {
            return new CategoryEntry(source);
        }

        @Override
        public CategoryEntry[] newArray(int size) {
            return new CategoryEntry[size];
        }
    };
    ...
    public CategoryEntry(Parcel in) {
        super(in);
        ...
        this.creatorUserId = in.readString();
    }
}
