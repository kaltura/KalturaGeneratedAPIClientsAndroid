...
public class BatchHistoryData extends ObjectBase {
    ...
    public static final Creator<BatchHistoryData> CREATOR = new Creator<BatchHistoryData>() {
        @Override
        public BatchHistoryData createFromParcel(Parcel source) {
            return new BatchHistoryData(source);
        }

        @Override
        public BatchHistoryData[] newArray(int size) {
            return new BatchHistoryData[size];
        }
    };
    ...
    public BatchHistoryData(Parcel in) {
        ...
        this.errType = (Integer)in.readValue(Integer.class.getClassLoader());
