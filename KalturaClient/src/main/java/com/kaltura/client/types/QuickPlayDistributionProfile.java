...
public class QuickPlayDistributionProfile extends ConfigurableDistributionProfile {
    ...
    public static final Creator<QuickPlayDistributionProfile> CREATOR = new Creator<QuickPlayDistributionProfile>() {
        @Override
        public QuickPlayDistributionProfile createFromParcel(Parcel source) {
            return new QuickPlayDistributionProfile(source);
        }

        @Override
        public QuickPlayDistributionProfile[] newArray(int size) {
            return new QuickPlayDistributionProfile[size];
        }
    };
