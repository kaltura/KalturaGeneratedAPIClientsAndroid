...
public class StreamContainer extends ObjectBase {
    ...
    public static final Creator<StreamContainer> CREATOR = new Creator<StreamContainer>() {
        @Override
        public StreamContainer createFromParcel(Parcel source) {
            return new StreamContainer(source);
        }

        @Override
        public StreamContainer[] newArray(int size) {
            return new StreamContainer[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.channelIndex);
        dest.writeString(this.label);
        dest.writeString(this.channelLayout);
    }
    ...
    public StreamContainer(Parcel in) {
        ...
        this.channelIndex = (Integer)in.readValue(Integer.class.getClassLoader());
        this.label = in.readString();
        this.channelLayout = in.readString();
    }
}
