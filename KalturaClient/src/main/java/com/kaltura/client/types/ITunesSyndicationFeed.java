...
public class ITunesSyndicationFeed extends BaseSyndicationFeed {
    ...
    public static final Creator<ITunesSyndicationFeed> CREATOR = new Creator<ITunesSyndicationFeed>() {
        @Override
        public ITunesSyndicationFeed createFromParcel(Parcel source) {
            return new ITunesSyndicationFeed(source);
        }

        @Override
        public ITunesSyndicationFeed[] newArray(int size) {
            return new ITunesSyndicationFeed[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.feedLandingPage);
        ...
        dest.writeInt(this.enforceOrder == null ? -1 : this.enforceOrder.ordinal());
    }
    ...
    public ITunesSyndicationFeed(Parcel in) {
        ...
        this.feedLandingPage = in.readString();
        this.ownerName = in.readString();
        this.ownerEmail = in.readString();
        this.feedImageUrl = in.readString();
        int tmpCategory = in.readInt();
        this.category = tmpCategory == -1 ? null : ITunesSyndicationFeedCategories.values()[tmpCategory];
        ...
        int tmpEnforceOrder = in.readInt();
        this.enforceOrder = tmpEnforceOrder == -1 ? null : Boolean.values()[tmpEnforceOrder];
    }
}
