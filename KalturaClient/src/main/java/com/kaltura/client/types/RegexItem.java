...
public class RegexItem extends ObjectBase {
    ...
    public static final Creator<RegexItem> CREATOR = new Creator<RegexItem>() {
        @Override
        public RegexItem createFromParcel(Parcel source) {
            return new RegexItem(source);
        }

        @Override
        public RegexItem[] newArray(int size) {
            return new RegexItem[size];
        }
    };
