...
public class PlayReadyAnalogVideoOPIdHolder extends ObjectBase {
    ...
    public static final Creator<PlayReadyAnalogVideoOPIdHolder> CREATOR = new Creator<PlayReadyAnalogVideoOPIdHolder>() {
        @Override
        public PlayReadyAnalogVideoOPIdHolder createFromParcel(Parcel source) {
            return new PlayReadyAnalogVideoOPIdHolder(source);
        }

        @Override
        public PlayReadyAnalogVideoOPIdHolder[] newArray(int size) {
            return new PlayReadyAnalogVideoOPIdHolder[size];
        }
    };
    ...
    public PlayReadyAnalogVideoOPIdHolder(Parcel in) {
        super(in);
        int tmpType = in.readInt();
        this.type = tmpType == -1 ? null : PlayReadyAnalogVideoOPId.values()[tmpType];
    }
}
