...
public abstract class GenericDistributionProviderActionBaseFilter extends Filter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.genericDistributionProviderIdEqual);
        dest.writeString(this.genericDistributionProviderIdIn);
        dest.writeInt(this.actionEqual == null ? -1 : this.actionEqual.ordinal());
        dest.writeString(this.actionIn);
    }

    public GenericDistributionProviderActionBaseFilter(Parcel in) {
        super(in);
        ...
        this.genericDistributionProviderIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.genericDistributionProviderIdIn = in.readString();
        int tmpActionEqual = in.readInt();
        this.actionEqual = tmpActionEqual == -1 ? null : DistributionAction.values()[tmpActionEqual];
