...
public class ParseCaptionAssetJobData extends JobData {
    ...
    public static final Creator<ParseCaptionAssetJobData> CREATOR = new Creator<ParseCaptionAssetJobData>() {
        @Override
        public ParseCaptionAssetJobData createFromParcel(Parcel source) {
            return new ParseCaptionAssetJobData(source);
        }

        @Override
        public ParseCaptionAssetJobData[] newArray(int size) {
            return new ParseCaptionAssetJobData[size];
        }
    };
    ...
    public ParseCaptionAssetJobData(Parcel in) {
        super(in);
