...
public class GenericSyndicationFeed extends BaseSyndicationFeed {
    ...
    public static final Creator<GenericSyndicationFeed> CREATOR = new Creator<GenericSyndicationFeed>() {
        @Override
        public GenericSyndicationFeed createFromParcel(Parcel source) {
            return new GenericSyndicationFeed(source);
        }

        @Override
        public GenericSyndicationFeed[] newArray(int size) {
            return new GenericSyndicationFeed[size];
        }
    };
    ...
    public GenericSyndicationFeed(Parcel in) {
        super(in);
