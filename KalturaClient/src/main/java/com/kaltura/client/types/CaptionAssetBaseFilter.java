...
public abstract class CaptionAssetBaseFilter extends AssetFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.captionParamsIdEqual);
        dest.writeString(this.captionParamsIdIn);
        dest.writeInt(this.formatEqual == null ? -1 : this.formatEqual.ordinal());
        dest.writeString(this.formatIn);
    ...
    public CaptionAssetBaseFilter(Parcel in) {
        super(in);
        this.captionParamsIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.captionParamsIdIn = in.readString();
        int tmpFormatEqual = in.readInt();
        this.formatEqual = tmpFormatEqual == -1 ? null : CaptionType.values()[tmpFormatEqual];
        this.formatIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : CaptionAssetStatus.values()[tmpStatusEqual];
