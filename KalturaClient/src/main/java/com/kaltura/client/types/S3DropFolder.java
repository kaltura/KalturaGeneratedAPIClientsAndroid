...
public class S3DropFolder extends DropFolder {
    ...
    public static final Creator<S3DropFolder> CREATOR = new Creator<S3DropFolder>() {
        @Override
        public S3DropFolder createFromParcel(Parcel source) {
            return new S3DropFolder(source);
        }

        @Override
        public S3DropFolder[] newArray(int size) {
            return new S3DropFolder[size];
        }
    };
