...
public class CategoryUserProviderFilter extends Filter {
    ...
    public static final Creator<CategoryUserProviderFilter> CREATOR = new Creator<CategoryUserProviderFilter>() {
        @Override
        public CategoryUserProviderFilter createFromParcel(Parcel source) {
            return new CategoryUserProviderFilter(source);
        }

        @Override
        public CategoryUserProviderFilter[] newArray(int size) {
            return new CategoryUserProviderFilter[size];
        }
    };
    ...
    public CategoryUserProviderFilter(Parcel in) {
        super(in);
