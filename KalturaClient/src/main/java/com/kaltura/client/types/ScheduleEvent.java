...
public abstract class ScheduleEvent extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.recurrenceType == null ? -1 : this.recurrenceType.ordinal());
    ...
    public ScheduleEvent(Parcel in) {
        ...
        this.status = tmpStatus == -1 ? null : ScheduleEventStatus.values()[tmpStatus];
        ...
        this.geoLongitude = (Double)in.readValue(Double.class.getClassLoader());
        ...
        int tmpRecurrenceType = in.readInt();
        this.recurrenceType = tmpRecurrenceType == -1 ? null : ScheduleEventRecurrenceType.values()[tmpRecurrenceType];
        ...
        this.recurrence = in.readParcelable(ScheduleEventRecurrence.class.getClassLoader());
    }
}
