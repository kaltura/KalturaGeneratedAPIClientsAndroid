...
public class MetadataSearchItem extends SearchOperator {
    ...
    public static final Creator<MetadataSearchItem> CREATOR = new Creator<MetadataSearchItem>() {
        @Override
        public MetadataSearchItem createFromParcel(Parcel source) {
            return new MetadataSearchItem(source);
        }

        @Override
        public MetadataSearchItem[] newArray(int size) {
            return new MetadataSearchItem[size];
        }
    };
    ...
    public MetadataSearchItem(Parcel in) {
        super(in);
