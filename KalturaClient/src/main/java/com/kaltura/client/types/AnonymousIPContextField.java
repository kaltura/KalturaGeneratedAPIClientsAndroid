...
public class AnonymousIPContextField extends StringField {
    ...
    public static final Creator<AnonymousIPContextField> CREATOR = new Creator<AnonymousIPContextField>() {
        @Override
        public AnonymousIPContextField createFromParcel(Parcel source) {
            return new AnonymousIPContextField(source);
        }

        @Override
        public AnonymousIPContextField[] newArray(int size) {
            return new AnonymousIPContextField[size];
        }
    };
    ...
    public AnonymousIPContextField(Parcel in) {
        super(in);
