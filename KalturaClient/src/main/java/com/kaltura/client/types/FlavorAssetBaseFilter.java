...
public abstract class FlavorAssetBaseFilter extends AssetFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.flavorParamsIdIn);
    ...
    public FlavorAssetBaseFilter(Parcel in) {
        super(in);
        this.flavorParamsIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.flavorParamsIdIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : FlavorAssetStatus.values()[tmpStatusEqual];
