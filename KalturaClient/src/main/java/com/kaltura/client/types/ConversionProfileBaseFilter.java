...
public abstract class ConversionProfileBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.defaultEntryIdEqual);
        dest.writeString(this.defaultEntryIdIn);
    }

    public ConversionProfileBaseFilter(Parcel in) {
        super(in);
        this.idEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.idIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : ConversionProfileStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        int tmpTypeEqual = in.readInt();
        this.typeEqual = tmpTypeEqual == -1 ? null : ConversionProfileType.values()[tmpTypeEqual];
        ...
        this.defaultEntryIdEqual = in.readString();
        this.defaultEntryIdIn = in.readString();
    }
}
