...
public class LiveAsset extends FlavorAsset {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.multicastIP);
        dest.writeValue(this.multicastPort);
    }

    public LiveAsset(Parcel in) {
        super(in);
        this.multicastIP = in.readString();
        this.multicastPort = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
