...
public class SearchAuthData extends ObjectBase {
    ...
    public static final Creator<SearchAuthData> CREATOR = new Creator<SearchAuthData>() {
        @Override
        public SearchAuthData createFromParcel(Parcel source) {
            return new SearchAuthData(source);
        }

        @Override
        public SearchAuthData[] newArray(int size) {
            return new SearchAuthData[size];
        }
    };
    ...
    public SearchAuthData(Parcel in) {
        super(in);
