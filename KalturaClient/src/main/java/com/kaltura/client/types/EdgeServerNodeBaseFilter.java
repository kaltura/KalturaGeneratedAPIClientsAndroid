...
public abstract class EdgeServerNodeBaseFilter extends DeliveryServerNodeFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.playbackDomainLike);
        dest.writeString(this.playbackDomainMultiLikeOr);
        dest.writeString(this.playbackDomainMultiLikeAnd);
    }

    public EdgeServerNodeBaseFilter(Parcel in) {
        super(in);
        this.playbackDomainLike = in.readString();
        this.playbackDomainMultiLikeOr = in.readString();
        this.playbackDomainMultiLikeAnd = in.readString();
    }
}
