...
public class CsvAdditionalFieldInfo extends ObjectBase {
    ...
    public static final Creator<CsvAdditionalFieldInfo> CREATOR = new Creator<CsvAdditionalFieldInfo>() {
        @Override
        public CsvAdditionalFieldInfo createFromParcel(Parcel source) {
            return new CsvAdditionalFieldInfo(source);
        }

        @Override
        public CsvAdditionalFieldInfo[] newArray(int size) {
            return new CsvAdditionalFieldInfo[size];
        }
    };
    ...
    public CsvAdditionalFieldInfo(Parcel in) {
        super(in);
