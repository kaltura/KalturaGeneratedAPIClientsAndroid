...
public class ESearchCuePointItem extends ESearchEntryAbstractNestedItem {
    ...
    public static final Creator<ESearchCuePointItem> CREATOR = new Creator<ESearchCuePointItem>() {
        @Override
        public ESearchCuePointItem createFromParcel(Parcel source) {
            return new ESearchCuePointItem(source);
        }

        @Override
        public ESearchCuePointItem[] newArray(int size) {
            return new ESearchCuePointItem[size];
        }
    };
