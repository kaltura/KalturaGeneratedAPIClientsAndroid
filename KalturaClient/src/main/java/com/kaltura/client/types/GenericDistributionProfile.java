...
public class GenericDistributionProfile extends DistributionProfile {
    ...
    public static final Creator<GenericDistributionProfile> CREATOR = new Creator<GenericDistributionProfile>() {
        @Override
        public GenericDistributionProfile createFromParcel(Parcel source) {
            return new GenericDistributionProfile(source);
        }

        @Override
        public GenericDistributionProfile[] newArray(int size) {
            return new GenericDistributionProfile[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.genericProviderId);
        dest.writeParcelable(this.submitAction, flags);
        dest.writeParcelable(this.updateAction, flags);
        dest.writeParcelable(this.deleteAction, flags);
        dest.writeParcelable(this.fetchReportAction, flags);
        dest.writeString(this.updateRequiredEntryFields);
        dest.writeString(this.updateRequiredMetadataXPaths);
    }

    public GenericDistributionProfile(Parcel in) {
        super(in);
        this.genericProviderId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.submitAction = in.readParcelable(GenericDistributionProfileAction.class.getClassLoader());
        this.updateAction = in.readParcelable(GenericDistributionProfileAction.class.getClassLoader());
        this.deleteAction = in.readParcelable(GenericDistributionProfileAction.class.getClassLoader());
        this.fetchReportAction = in.readParcelable(GenericDistributionProfileAction.class.getClassLoader());
        this.updateRequiredEntryFields = in.readString();
        this.updateRequiredMetadataXPaths = in.readString();
    }
}
