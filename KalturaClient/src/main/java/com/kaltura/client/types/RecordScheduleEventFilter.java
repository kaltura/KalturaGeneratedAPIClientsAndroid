...
public class RecordScheduleEventFilter extends RecordScheduleEventBaseFilter {
    ...
    public static final Creator<RecordScheduleEventFilter> CREATOR = new Creator<RecordScheduleEventFilter>() {
        @Override
        public RecordScheduleEventFilter createFromParcel(Parcel source) {
            return new RecordScheduleEventFilter(source);
        }

        @Override
        public RecordScheduleEventFilter[] newArray(int size) {
            return new RecordScheduleEventFilter[size];
        }
    };

    public RecordScheduleEventFilter(Parcel in) {
        super(in);
    }
}
