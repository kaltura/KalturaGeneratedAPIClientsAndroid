...
public class ResponseProfileCacheRecalculateOptions extends ObjectBase {
    ...
    public static final Creator<ResponseProfileCacheRecalculateOptions> CREATOR = new Creator<ResponseProfileCacheRecalculateOptions>() {
        @Override
        public ResponseProfileCacheRecalculateOptions createFromParcel(Parcel source) {
            return new ResponseProfileCacheRecalculateOptions(source);
        }

        @Override
        public ResponseProfileCacheRecalculateOptions[] newArray(int size) {
            return new ResponseProfileCacheRecalculateOptions[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.jobCreatedAt);
        dest.writeValue(this.isFirstLoop);
    }

    public ResponseProfileCacheRecalculateOptions(Parcel in) {
        super(in);
        ...
        this.jobCreatedAt = (Integer)in.readValue(Integer.class.getClassLoader());
        this.isFirstLoop = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
