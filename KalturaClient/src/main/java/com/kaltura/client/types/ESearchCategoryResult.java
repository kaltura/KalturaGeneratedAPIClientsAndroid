...
public class ESearchCategoryResult extends ESearchResult {
    ...
    public static final Creator<ESearchCategoryResult> CREATOR = new Creator<ESearchCategoryResult>() {
        @Override
        public ESearchCategoryResult createFromParcel(Parcel source) {
            return new ESearchCategoryResult(source);
        }

        @Override
        public ESearchCategoryResult[] newArray(int size) {
            return new ESearchCategoryResult[size];
        }
    };
    ...
    public ESearchCategoryResult(Parcel in) {
        super(in);
        this.object = in.readParcelable(Category.class.getClassLoader());
    }
}
