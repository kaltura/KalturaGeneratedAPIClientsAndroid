...
public class EventNotificationParameter extends ObjectBase {
    ...
    public static final Creator<EventNotificationParameter> CREATOR = new Creator<EventNotificationParameter>() {
        @Override
        public EventNotificationParameter createFromParcel(Parcel source) {
            return new EventNotificationParameter(source);
        }

        @Override
        public EventNotificationParameter[] newArray(int size) {
            return new EventNotificationParameter[size];
        }
    };
    ...
    public EventNotificationParameter(Parcel in) {
        super(in);
