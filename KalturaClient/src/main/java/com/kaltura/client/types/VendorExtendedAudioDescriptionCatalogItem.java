...
public class VendorExtendedAudioDescriptionCatalogItem extends VendorCatalogItem {
    ...
    public static final Creator<VendorExtendedAudioDescriptionCatalogItem> CREATOR = new Creator<VendorExtendedAudioDescriptionCatalogItem>() {
        @Override
        public VendorExtendedAudioDescriptionCatalogItem createFromParcel(Parcel source) {
            return new VendorExtendedAudioDescriptionCatalogItem(source);
        }

        @Override
        public VendorExtendedAudioDescriptionCatalogItem[] newArray(int size) {
            return new VendorExtendedAudioDescriptionCatalogItem[size];
        }
    };
    ...
    public VendorExtendedAudioDescriptionCatalogItem(Parcel in) {
        super(in);
