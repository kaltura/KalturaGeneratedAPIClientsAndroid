...
public class PartnerStatistics extends ObjectBase {
    ...
    public static final Creator<PartnerStatistics> CREATOR = new Creator<PartnerStatistics>() {
        @Override
        public PartnerStatistics createFromParcel(Parcel source) {
            return new PartnerStatistics(source);
        }

        @Override
        public PartnerStatistics[] newArray(int size) {
            return new PartnerStatistics[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.packageBandwidthAndStorage);
        dest.writeValue(this.hosting);
        dest.writeValue(this.bandwidth);
        dest.writeValue(this.usage);
        dest.writeValue(this.usagePercent);
        dest.writeValue(this.reachedLimitDate);
    }

    public PartnerStatistics(Parcel in) {
        super(in);
        this.packageBandwidthAndStorage = (Integer)in.readValue(Integer.class.getClassLoader());
        this.hosting = (Double)in.readValue(Double.class.getClassLoader());
        ...
        this.usagePercent = (Double)in.readValue(Double.class.getClassLoader());
        this.reachedLimitDate = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
