...
public class FtpDistributionFile extends ObjectBase {
    ...
    public static final Creator<FtpDistributionFile> CREATOR = new Creator<FtpDistributionFile>() {
        @Override
        public FtpDistributionFile createFromParcel(Parcel source) {
            return new FtpDistributionFile(source);
        }

        @Override
        public FtpDistributionFile[] newArray(int size) {
            return new FtpDistributionFile[size];
        }
    };
    ...
    public FtpDistributionFile(Parcel in) {
        super(in);
