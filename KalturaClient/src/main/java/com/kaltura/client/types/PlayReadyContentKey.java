...
public class PlayReadyContentKey extends ObjectBase {
    ...
    public static final Creator<PlayReadyContentKey> CREATOR = new Creator<PlayReadyContentKey>() {
        @Override
        public PlayReadyContentKey createFromParcel(Parcel source) {
            return new PlayReadyContentKey(source);
        }

        @Override
        public PlayReadyContentKey[] newArray(int size) {
            return new PlayReadyContentKey[size];
        }
    };
    ...
    public PlayReadyContentKey(Parcel in) {
        super(in);
