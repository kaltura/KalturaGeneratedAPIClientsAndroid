...
public class BulkDownloadJobData extends JobData {
    ...
    public static final Creator<BulkDownloadJobData> CREATOR = new Creator<BulkDownloadJobData>() {
        @Override
        public BulkDownloadJobData createFromParcel(Parcel source) {
            return new BulkDownloadJobData(source);
        }

        @Override
        public BulkDownloadJobData[] newArray(int size) {
            return new BulkDownloadJobData[size];
        }
    };
