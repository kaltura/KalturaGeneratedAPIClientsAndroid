...
public class Search extends ObjectBase {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.searchSource == null ? -1 : this.searchSource.ordinal());
    ...
    public Search(Parcel in) {
        ...
        int tmpSearchSource = in.readInt();
        this.searchSource = tmpSearchSource == -1 ? null : SearchProviderType.values()[tmpSearchSource];
