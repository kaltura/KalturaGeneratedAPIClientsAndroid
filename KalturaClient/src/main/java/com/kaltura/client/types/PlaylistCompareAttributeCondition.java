...
public class PlaylistCompareAttributeCondition extends SearchComparableAttributeCondition {
    ...
    public static final Creator<PlaylistCompareAttributeCondition> CREATOR = new Creator<PlaylistCompareAttributeCondition>() {
        @Override
        public PlaylistCompareAttributeCondition createFromParcel(Parcel source) {
            return new PlaylistCompareAttributeCondition(source);
        }

        @Override
        public PlaylistCompareAttributeCondition[] newArray(int size) {
            return new PlaylistCompareAttributeCondition[size];
        }
    };
    ...
    public PlaylistCompareAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : PlaylistCompareAttribute.values()[tmpAttribute];
    }
}
