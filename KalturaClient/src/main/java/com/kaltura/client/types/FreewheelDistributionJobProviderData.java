...
public class FreewheelDistributionJobProviderData extends DistributionJobProviderData {
    ...
    public static final Creator<FreewheelDistributionJobProviderData> CREATOR = new Creator<FreewheelDistributionJobProviderData>() {
        @Override
        public FreewheelDistributionJobProviderData createFromParcel(Parcel source) {
            return new FreewheelDistributionJobProviderData(source);
        }

        @Override
        public FreewheelDistributionJobProviderData[] newArray(int size) {
            return new FreewheelDistributionJobProviderData[size];
        }
    };
    ...
    public FreewheelDistributionJobProviderData(Parcel in) {
        super(in);
        int videoAssetFilePathsSize = in.readInt();
        if( videoAssetFilePathsSize > -1) {
            this.videoAssetFilePaths = new ArrayList<>();
            in.readList(this.videoAssetFilePaths, FreewheelDistributionAssetPath.class.getClassLoader());
        }
