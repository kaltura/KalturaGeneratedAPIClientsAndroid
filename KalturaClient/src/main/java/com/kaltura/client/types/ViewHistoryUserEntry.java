...
public class ViewHistoryUserEntry extends UserEntry {
    ...
    public static final Creator<ViewHistoryUserEntry> CREATOR = new Creator<ViewHistoryUserEntry>() {
        @Override
        public ViewHistoryUserEntry createFromParcel(Parcel source) {
            return new ViewHistoryUserEntry(source);
        }

        @Override
        public ViewHistoryUserEntry[] newArray(int size) {
            return new ViewHistoryUserEntry[size];
        }
    };
