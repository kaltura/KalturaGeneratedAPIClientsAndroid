...
public class GeoDistanceCondition extends MatchCondition {
    ...
    public static final Creator<GeoDistanceCondition> CREATOR = new Creator<GeoDistanceCondition>() {
        @Override
        public GeoDistanceCondition createFromParcel(Parcel source) {
            return new GeoDistanceCondition(source);
        }

        @Override
        public GeoDistanceCondition[] newArray(int size) {
            return new GeoDistanceCondition[size];
        }
    };
    ...
    public GeoDistanceCondition(Parcel in) {
        super(in);
