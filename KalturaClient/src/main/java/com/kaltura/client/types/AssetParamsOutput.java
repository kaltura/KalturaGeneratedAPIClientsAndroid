...
public class AssetParamsOutput extends AssetParams {
    ...
    public static final Creator<AssetParamsOutput> CREATOR = new Creator<AssetParamsOutput>() {
        @Override
        public AssetParamsOutput createFromParcel(Parcel source) {
            return new AssetParamsOutput(source);
        }

        @Override
        public AssetParamsOutput[] newArray(int size) {
            return new AssetParamsOutput[size];
        }
    };
