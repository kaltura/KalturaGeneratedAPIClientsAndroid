...
public abstract class AdCuePointBaseFilter extends CuePointFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.protocolTypeEqual == null ? -1 : this.protocolTypeEqual.ordinal());
        dest.writeString(this.protocolTypeIn);
    ...
    public AdCuePointBaseFilter(Parcel in) {
        super(in);
        int tmpProtocolTypeEqual = in.readInt();
        this.protocolTypeEqual = tmpProtocolTypeEqual == -1 ? null : AdProtocolType.values()[tmpProtocolTypeEqual];
        this.protocolTypeIn = in.readString();
