...
public class DeliveryProfileGenericSilverLight extends DeliveryProfile {
    ...
    public static final Creator<DeliveryProfileGenericSilverLight> CREATOR = new Creator<DeliveryProfileGenericSilverLight>() {
        @Override
        public DeliveryProfileGenericSilverLight createFromParcel(Parcel source) {
            return new DeliveryProfileGenericSilverLight(source);
        }

        @Override
        public DeliveryProfileGenericSilverLight[] newArray(int size) {
            return new DeliveryProfileGenericSilverLight[size];
        }
    };
    ...
    public DeliveryProfileGenericSilverLight(Parcel in) {
        super(in);
