...
public class HttpNotification extends ObjectBase {
    ...
    public static final Creator<HttpNotification> CREATOR = new Creator<HttpNotification>() {
        @Override
        public HttpNotification createFromParcel(Parcel source) {
            return new HttpNotification(source);
        }

        @Override
        public HttpNotification[] newArray(int size) {
            return new HttpNotification[size];
        }
    };
    ...
    public HttpNotification(Parcel in) {
        ...
        this.eventNotificationJobId = (Long)in.readValue(Long.class.getClassLoader());
        this.templateId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.templateName = in.readString();
        this.templateSystemName = in.readString();
