...
public class KontikiStorageExportJobData extends StorageExportJobData {
    ...
    public static final Creator<KontikiStorageExportJobData> CREATOR = new Creator<KontikiStorageExportJobData>() {
        @Override
        public KontikiStorageExportJobData createFromParcel(Parcel source) {
            return new KontikiStorageExportJobData(source);
        }

        @Override
        public KontikiStorageExportJobData[] newArray(int size) {
            return new KontikiStorageExportJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.contentMoid);
        dest.writeString(this.serviceToken);
    }

    public KontikiStorageExportJobData(Parcel in) {
        super(in);
        this.flavorAssetId = in.readString();
        this.contentMoid = in.readString();
        this.serviceToken = in.readString();
    }
}
