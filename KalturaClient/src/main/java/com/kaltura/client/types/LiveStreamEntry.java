...
public class LiveStreamEntry extends LiveEntry {
    ...
    public static final Creator<LiveStreamEntry> CREATOR = new Creator<LiveStreamEntry>() {
        @Override
        public LiveStreamEntry createFromParcel(Parcel source) {
            return new LiveStreamEntry(source);
        }

        @Override
        public LiveStreamEntry[] newArray(int size) {
            return new LiveStreamEntry[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.streamRemoteId);
        dest.writeString(this.streamRemoteBackupId);
        if(this.bitrates != null) {
            dest.writeInt(this.bitrates.size());
            dest.writeList(this.bitrates);
        } else {
            dest.writeInt(-1);
        }
        ...
        dest.writeString(this.primarySrtBroadcastingUrl);
        dest.writeString(this.primarySrtStreamId);
        dest.writeString(this.secondarySrtBroadcastingUrl);
        dest.writeString(this.secondarySrtStreamId);
    ...
    public LiveStreamEntry(Parcel in) {
        super(in);
        this.streamRemoteId = in.readString();
        this.streamRemoteBackupId = in.readString();
        int bitratesSize = in.readInt();
        if( bitratesSize > -1) {
            this.bitrates = new ArrayList<>();
            in.readList(this.bitrates, LiveStreamBitrate.class.getClassLoader());
        }
        ...
        this.primarySrtBroadcastingUrl = in.readString();
        this.primarySrtStreamId = in.readString();
        this.secondarySrtBroadcastingUrl = in.readString();
        this.secondarySrtStreamId = in.readString();
