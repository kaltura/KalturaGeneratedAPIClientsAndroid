...
public class FileSyncDescriptor extends ObjectBase {
    ...
    public static final Creator<FileSyncDescriptor> CREATOR = new Creator<FileSyncDescriptor>() {
        @Override
        public FileSyncDescriptor createFromParcel(Parcel source) {
            return new FileSyncDescriptor(source);
        }

        @Override
        public FileSyncDescriptor[] newArray(int size) {
            return new FileSyncDescriptor[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.fileSyncLocalPath);
        dest.writeString(this.fileEncryptionKey);
        dest.writeString(this.fileSyncRemoteUrl);
        dest.writeValue(this.fileSyncObjectSubType);
    }

    public FileSyncDescriptor(Parcel in) {
        super(in);
        this.fileSyncLocalPath = in.readString();
        this.fileEncryptionKey = in.readString();
        this.fileSyncRemoteUrl = in.readString();
        this.fileSyncObjectSubType = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
