...
public class CropDimensions extends ObjectBase {
    ...
    public static final Creator<CropDimensions> CREATOR = new Creator<CropDimensions>() {
        @Override
        public CropDimensions createFromParcel(Parcel source) {
            return new CropDimensions(source);
        }

        @Override
        public CropDimensions[] newArray(int size) {
            return new CropDimensions[size];
        }
    };
    ...
    public CropDimensions(Parcel in) {
        super(in);
