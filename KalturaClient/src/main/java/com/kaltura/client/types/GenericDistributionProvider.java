...
public class GenericDistributionProvider extends DistributionProvider {
    ...
    public static final Creator<GenericDistributionProvider> CREATOR = new Creator<GenericDistributionProvider>() {
        @Override
        public GenericDistributionProvider createFromParcel(Parcel source) {
            return new GenericDistributionProvider(source);
        }

        @Override
        public GenericDistributionProvider[] newArray(int size) {
            return new GenericDistributionProvider[size];
        }
    };
    ...
    public GenericDistributionProvider(Parcel in) {
        super(in);
