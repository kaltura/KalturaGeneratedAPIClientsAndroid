...
public class ESearchEntryResult extends ESearchResult {
    ...
    public static final Creator<ESearchEntryResult> CREATOR = new Creator<ESearchEntryResult>() {
        @Override
        public ESearchEntryResult createFromParcel(Parcel source) {
            return new ESearchEntryResult(source);
        }

        @Override
        public ESearchEntryResult[] newArray(int size) {
            return new ESearchEntryResult[size];
        }
    };
