...
public class LiveReportExportResponse extends ObjectBase {
    ...
    public static final Creator<LiveReportExportResponse> CREATOR = new Creator<LiveReportExportResponse>() {
        @Override
        public LiveReportExportResponse createFromParcel(Parcel source) {
            return new LiveReportExportResponse(source);
        }

        @Override
        public LiveReportExportResponse[] newArray(int size) {
            return new LiveReportExportResponse[size];
        }
    };
    ...
    public LiveReportExportResponse(Parcel in) {
        super(in);
