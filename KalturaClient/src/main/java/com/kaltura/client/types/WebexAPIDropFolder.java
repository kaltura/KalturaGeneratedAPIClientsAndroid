...
public class WebexAPIDropFolder extends DropFolder {
    ...
    public static final Creator<WebexAPIDropFolder> CREATOR = new Creator<WebexAPIDropFolder>() {
        @Override
        public WebexAPIDropFolder createFromParcel(Parcel source) {
            return new WebexAPIDropFolder(source);
        }

        @Override
        public WebexAPIDropFolder[] newArray(int size) {
            return new WebexAPIDropFolder[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.webexAPIVendorIntegrationId);
        dest.writeParcelable(this.webexAPIVendorIntegration, flags);
    }

    public WebexAPIDropFolder(Parcel in) {
        super(in);
        this.webexAPIVendorIntegrationId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.webexAPIVendorIntegration = in.readParcelable(WebexAPIIntegrationSetting.class.getClassLoader());
    }
}
