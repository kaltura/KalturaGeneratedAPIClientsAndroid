...
public class ClipsVendorTaskData extends LocalizedVendorTaskData {
    ...
    public static final Creator<ClipsVendorTaskData> CREATOR = new Creator<ClipsVendorTaskData>() {
        @Override
        public ClipsVendorTaskData createFromParcel(Parcel source) {
            return new ClipsVendorTaskData(source);
        }

        @Override
        public ClipsVendorTaskData[] newArray(int size) {
            return new ClipsVendorTaskData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.clipsDuration);
        dest.writeString(this.eventSessionContextId);
        dest.writeString(this.instruction);
        dest.writeString(this.clipsOutputJson);
    }

    public ClipsVendorTaskData(Parcel in) {
        super(in);
        this.clipsDuration = (Integer)in.readValue(Integer.class.getClassLoader());
        this.eventSessionContextId = in.readString();
        this.instruction = in.readString();
        this.clipsOutputJson = in.readString();
    }
}
