...
public class ConvertProfileJobData extends JobData {
    ...
    public static final Creator<ConvertProfileJobData> CREATOR = new Creator<ConvertProfileJobData>() {
        @Override
        public ConvertProfileJobData createFromParcel(Parcel source) {
            return new ConvertProfileJobData(source);
        }

        @Override
        public ConvertProfileJobData[] newArray(int size) {
            return new ConvertProfileJobData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.inputFileSyncLocalPath);
        dest.writeValue(this.thumbHeight);
        dest.writeValue(this.thumbBitrate);
    }

    public ConvertProfileJobData(Parcel in) {
        super(in);
        this.inputFileSyncLocalPath = in.readString();
        this.thumbHeight = (Integer)in.readValue(Integer.class.getClassLoader());
        this.thumbBitrate = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
