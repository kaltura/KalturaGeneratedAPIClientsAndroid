...
public class SystemPartnerFilter extends PartnerFilter {
    ...
    public static final Creator<SystemPartnerFilter> CREATOR = new Creator<SystemPartnerFilter>() {
        @Override
        public SystemPartnerFilter createFromParcel(Parcel source) {
            return new SystemPartnerFilter(source);
        }

        @Override
        public SystemPartnerFilter[] newArray(int size) {
            return new SystemPartnerFilter[size];
        }
    };
