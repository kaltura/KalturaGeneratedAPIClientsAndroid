...
public abstract class CodeCuePointBaseFilter extends CuePointFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.codeLike);
        dest.writeString(this.codeMultiLikeOr);
        dest.writeString(this.codeMultiLikeAnd);
        dest.writeString(this.codeEqual);
    ...
    public CodeCuePointBaseFilter(Parcel in) {
        super(in);
        this.codeLike = in.readString();
        this.codeMultiLikeOr = in.readString();
        this.codeMultiLikeAnd = in.readString();
        this.codeEqual = in.readString();
