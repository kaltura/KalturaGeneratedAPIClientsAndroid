...
public abstract class AnswerCuePointBaseFilter extends CuePointFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.quizUserEntryIdEqual);
        dest.writeString(this.quizUserEntryIdIn);
    }

    public AnswerCuePointBaseFilter(Parcel in) {
        super(in);
        this.parentIdEqual = in.readString();
        this.parentIdIn = in.readString();
        this.quizUserEntryIdEqual = in.readString();
        this.quizUserEntryIdIn = in.readString();
    }
}
