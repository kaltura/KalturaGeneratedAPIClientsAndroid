...
public abstract class CategoryUserBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.categoryIdEqual);
        dest.writeString(this.categoryIdIn);
        dest.writeString(this.userIdEqual);
        dest.writeString(this.userIdIn);
        dest.writeInt(this.permissionLevelEqual == null ? -1 : this.permissionLevelEqual.ordinal());
        dest.writeString(this.permissionLevelIn);
        ...
        dest.writeInt(this.updateMethodEqual == null ? -1 : this.updateMethodEqual.ordinal());
        dest.writeString(this.updateMethodIn);
        dest.writeString(this.categoryFullIdsStartsWith);
        dest.writeString(this.categoryFullIdsEqual);
        dest.writeString(this.permissionNamesMatchAnd);
        dest.writeString(this.permissionNamesMatchOr);
        dest.writeString(this.permissionNamesNotContains);
    }

    public CategoryUserBaseFilter(Parcel in) {
        super(in);
        this.categoryIdEqual = (Integer)in.readValue(Integer.class.getClassLoader());
        this.categoryIdIn = in.readString();
        this.userIdEqual = in.readString();
        this.userIdIn = in.readString();
        int tmpPermissionLevelEqual = in.readInt();
        this.permissionLevelEqual = tmpPermissionLevelEqual == -1 ? null : CategoryUserPermissionLevel.values()[tmpPermissionLevelEqual];
        this.permissionLevelIn = in.readString();
        int tmpStatusEqual = in.readInt();
        this.statusEqual = tmpStatusEqual == -1 ? null : CategoryUserStatus.values()[tmpStatusEqual];
        ...
        int tmpUpdateMethodEqual = in.readInt();
        this.updateMethodEqual = tmpUpdateMethodEqual == -1 ? null : UpdateMethodType.values()[tmpUpdateMethodEqual];
        this.updateMethodIn = in.readString();
        this.categoryFullIdsStartsWith = in.readString();
        this.categoryFullIdsEqual = in.readString();
        this.permissionNamesMatchAnd = in.readString();
        this.permissionNamesMatchOr = in.readString();
        this.permissionNamesNotContains = in.readString();
    }
}
