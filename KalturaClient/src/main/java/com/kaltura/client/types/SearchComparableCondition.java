...
public class SearchComparableCondition extends SearchCondition {
    ...
    public static final Creator<SearchComparableCondition> CREATOR = new Creator<SearchComparableCondition>() {
        @Override
        public SearchComparableCondition createFromParcel(Parcel source) {
            return new SearchComparableCondition(source);
        }

        @Override
        public SearchComparableCondition[] newArray(int size) {
            return new SearchComparableCondition[size];
        }
    };
    ...
    public SearchComparableCondition(Parcel in) {
        super(in);
