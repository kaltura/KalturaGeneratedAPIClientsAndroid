...
public class BulkUploadResultCategoryUser extends BulkUploadResult {
    ...
    public static final Creator<BulkUploadResultCategoryUser> CREATOR = new Creator<BulkUploadResultCategoryUser>() {
        @Override
        public BulkUploadResultCategoryUser createFromParcel(Parcel source) {
            return new BulkUploadResultCategoryUser(source);
        }

        @Override
        public BulkUploadResultCategoryUser[] newArray(int size) {
            return new BulkUploadResultCategoryUser[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.categoryReferenceId);
        dest.writeString(this.userId);
        dest.writeValue(this.permissionLevel);
        dest.writeValue(this.updateMethod);
        dest.writeValue(this.requiredObjectStatus);
    }

    public BulkUploadResultCategoryUser(Parcel in) {
        super(in);
        this.categoryId = (Integer)in.readValue(Integer.class.getClassLoader());
        this.categoryReferenceId = in.readString();
        this.userId = in.readString();
        this.permissionLevel = (Integer)in.readValue(Integer.class.getClassLoader());
        this.updateMethod = (Integer)in.readValue(Integer.class.getClassLoader());
        this.requiredObjectStatus = (Integer)in.readValue(Integer.class.getClassLoader());
    }
}
