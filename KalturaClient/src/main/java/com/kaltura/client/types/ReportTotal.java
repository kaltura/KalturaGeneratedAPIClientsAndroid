...
public class ReportTotal extends ObjectBase {
    ...
    public static final Creator<ReportTotal> CREATOR = new Creator<ReportTotal>() {
        @Override
        public ReportTotal createFromParcel(Parcel source) {
            return new ReportTotal(source);
        }

        @Override
        public ReportTotal[] newArray(int size) {
            return new ReportTotal[size];
        }
    };
