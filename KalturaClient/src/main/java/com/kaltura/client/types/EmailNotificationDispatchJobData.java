...
public class EmailNotificationDispatchJobData extends EventNotificationDispatchJobData {
    ...
    public static final Creator<EmailNotificationDispatchJobData> CREATOR = new Creator<EmailNotificationDispatchJobData>() {
        @Override
        public EmailNotificationDispatchJobData createFromParcel(Parcel source) {
            return new EmailNotificationDispatchJobData(source);
        }

        @Override
        public EmailNotificationDispatchJobData[] newArray(int size) {
            return new EmailNotificationDispatchJobData[size];
        }
    };
    ...
    public EmailNotificationDispatchJobData(Parcel in) {
        super(in);
        this.fromEmail = in.readString();
        this.fromName = in.readString();
        this.to = in.readParcelable(EmailNotificationRecipientJobData.class.getClassLoader());
        this.cc = in.readParcelable(EmailNotificationRecipientJobData.class.getClassLoader());
        this.bcc = in.readParcelable(EmailNotificationRecipientJobData.class.getClassLoader());
        this.replyTo = in.readParcelable(EmailNotificationRecipientJobData.class.getClassLoader());
