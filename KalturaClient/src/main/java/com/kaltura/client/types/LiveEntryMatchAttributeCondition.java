...
public class LiveEntryMatchAttributeCondition extends SearchMatchAttributeCondition {
    ...
    public static final Creator<LiveEntryMatchAttributeCondition> CREATOR = new Creator<LiveEntryMatchAttributeCondition>() {
        @Override
        public LiveEntryMatchAttributeCondition createFromParcel(Parcel source) {
            return new LiveEntryMatchAttributeCondition(source);
        }

        @Override
        public LiveEntryMatchAttributeCondition[] newArray(int size) {
            return new LiveEntryMatchAttributeCondition[size];
        }
    };
    ...
    public LiveEntryMatchAttributeCondition(Parcel in) {
        super(in);
        int tmpAttribute = in.readInt();
        this.attribute = tmpAttribute == -1 ? null : LiveEntryMatchAttribute.values()[tmpAttribute];
    }
}
