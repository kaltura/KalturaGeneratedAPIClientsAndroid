...
public class ReportInputBaseFilter extends ObjectBase {
    ...
    public static final Creator<ReportInputBaseFilter> CREATOR = new Creator<ReportInputBaseFilter>() {
        @Override
        public ReportInputBaseFilter createFromParcel(Parcel source) {
            return new ReportInputBaseFilter(source);
        }

        @Override
        public ReportInputBaseFilter[] newArray(int size) {
            return new ReportInputBaseFilter[size];
        }
    };
