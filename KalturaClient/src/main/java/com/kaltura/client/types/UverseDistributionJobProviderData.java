...
public class UverseDistributionJobProviderData extends ConfigurableDistributionJobProviderData {
    ...
    public static final Creator<UverseDistributionJobProviderData> CREATOR = new Creator<UverseDistributionJobProviderData>() {
        @Override
        public UverseDistributionJobProviderData createFromParcel(Parcel source) {
            return new UverseDistributionJobProviderData(source);
        }

        @Override
        public UverseDistributionJobProviderData[] newArray(int size) {
            return new UverseDistributionJobProviderData[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.localAssetFilePath);
        dest.writeString(this.remoteAssetUrl);
        dest.writeString(this.remoteAssetFileName);
    }

    public UverseDistributionJobProviderData(Parcel in) {
        super(in);
        this.localAssetFilePath = in.readString();
        this.remoteAssetUrl = in.readString();
        this.remoteAssetFileName = in.readString();
    }
}
