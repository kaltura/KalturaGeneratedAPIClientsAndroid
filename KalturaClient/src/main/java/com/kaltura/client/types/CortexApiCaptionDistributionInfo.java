...
public class CortexApiCaptionDistributionInfo extends ObjectBase {
    ...
    public static final Creator<CortexApiCaptionDistributionInfo> CREATOR = new Creator<CortexApiCaptionDistributionInfo>() {
        @Override
        public CortexApiCaptionDistributionInfo createFromParcel(Parcel source) {
            return new CortexApiCaptionDistributionInfo(source);
        }

        @Override
        public CortexApiCaptionDistributionInfo[] newArray(int size) {
            return new CortexApiCaptionDistributionInfo[size];
        }
    };
    ...
    public CortexApiCaptionDistributionInfo(Parcel in) {
        super(in);
        ...
        this.action = tmpAction == -1 ? null : CortexApiDistributionCaptionAction.values()[tmpAction];
