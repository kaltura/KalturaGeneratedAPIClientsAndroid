...
public abstract class LiveChannelSegmentBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.channelIdEqual);
        dest.writeString(this.channelIdIn);
        dest.writeValue(this.startTimeGreaterThanOrEqual);
        dest.writeValue(this.startTimeLessThanOrEqual);
    }

    public LiveChannelSegmentBaseFilter(Parcel in) {
        super(in);
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : LiveChannelSegmentStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        this.channelIdEqual = in.readString();
        this.channelIdIn = in.readString();
        this.startTimeGreaterThanOrEqual = (Double)in.readValue(Double.class.getClassLoader());
        this.startTimeLessThanOrEqual = (Double)in.readValue(Double.class.getClassLoader());
    }
}
