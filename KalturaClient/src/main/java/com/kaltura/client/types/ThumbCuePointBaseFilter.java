...
public abstract class ThumbCuePointBaseFilter extends CuePointFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.descriptionMultiLikeOr);
        dest.writeString(this.descriptionMultiLikeAnd);
        dest.writeString(this.titleLike);
        dest.writeString(this.titleMultiLikeOr);
        dest.writeString(this.titleMultiLikeAnd);
        dest.writeInt(this.subTypeEqual == null ? -1 : this.subTypeEqual.ordinal());
        dest.writeString(this.subTypeIn);
    }

    public ThumbCuePointBaseFilter(Parcel in) {
        super(in);
        this.descriptionLike = in.readString();
        this.descriptionMultiLikeOr = in.readString();
        this.descriptionMultiLikeAnd = in.readString();
        this.titleLike = in.readString();
        this.titleMultiLikeOr = in.readString();
        this.titleMultiLikeAnd = in.readString();
        int tmpSubTypeEqual = in.readInt();
        this.subTypeEqual = tmpSubTypeEqual == -1 ? null : ThumbCuePointSubType.values()[tmpSubTypeEqual];
        this.subTypeIn = in.readString();
    }
}
