...
public class LimitFlavorsRestriction extends BaseRestriction {
    ...
    public static final Creator<LimitFlavorsRestriction> CREATOR = new Creator<LimitFlavorsRestriction>() {
        @Override
        public LimitFlavorsRestriction createFromParcel(Parcel source) {
            return new LimitFlavorsRestriction(source);
        }

        @Override
        public LimitFlavorsRestriction[] newArray(int size) {
            return new LimitFlavorsRestriction[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.limitFlavorsRestrictionType == null ? -1 : this.limitFlavorsRestrictionType.ordinal());
        dest.writeString(this.flavorParamsIds);
    }

    public LimitFlavorsRestriction(Parcel in) {
        super(in);
        int tmpLimitFlavorsRestrictionType = in.readInt();
        this.limitFlavorsRestrictionType = tmpLimitFlavorsRestrictionType == -1 ? null : LimitFlavorsRestrictionType.values()[tmpLimitFlavorsRestrictionType];
