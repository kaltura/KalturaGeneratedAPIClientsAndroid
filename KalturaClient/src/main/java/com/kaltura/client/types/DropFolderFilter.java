...
public class DropFolderFilter extends DropFolderBaseFilter {
    ...
    public static final Creator<DropFolderFilter> CREATOR = new Creator<DropFolderFilter>() {
        @Override
        public DropFolderFilter createFromParcel(Parcel source) {
            return new DropFolderFilter(source);
        }

        @Override
        public DropFolderFilter[] newArray(int size) {
            return new DropFolderFilter[size];
        }
    };
