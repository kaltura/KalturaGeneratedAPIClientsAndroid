...
public abstract class CategoryEntryBaseFilter extends RelatedFilter {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.creatorUserIdEqual);
        dest.writeString(this.creatorUserIdIn);
    }

    public CategoryEntryBaseFilter(Parcel in) {
        super(in);
        ...
        this.statusEqual = tmpStatusEqual == -1 ? null : CategoryEntryStatus.values()[tmpStatusEqual];
        this.statusIn = in.readString();
        this.creatorUserIdEqual = in.readString();
        this.creatorUserIdIn = in.readString();
    }
}
