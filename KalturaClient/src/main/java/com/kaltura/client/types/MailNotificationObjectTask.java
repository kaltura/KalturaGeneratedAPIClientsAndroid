...
public class MailNotificationObjectTask extends ObjectTask {
    ...
    public static final Creator<MailNotificationObjectTask> CREATOR = new Creator<MailNotificationObjectTask>() {
        @Override
        public MailNotificationObjectTask createFromParcel(Parcel source) {
            return new MailNotificationObjectTask(source);
        }

        @Override
        public MailNotificationObjectTask[] newArray(int size) {
            return new MailNotificationObjectTask[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeValue(this.sendToUsers);
    }

    public MailNotificationObjectTask(Parcel in) {
        super(in);
        this.mailTo = in.readString();
        this.sender = in.readString();
        this.subject = in.readString();
        this.message = in.readString();
        this.footer = in.readString();
        this.link = in.readString();
        this.sendToUsers = (Boolean)in.readValue(Boolean.class.getClassLoader());
    }
}
