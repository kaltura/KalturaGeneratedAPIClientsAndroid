...
public class ESearchUserResult extends ESearchResult {
    ...
    public static final Creator<ESearchUserResult> CREATOR = new Creator<ESearchUserResult>() {
        @Override
        public ESearchUserResult createFromParcel(Parcel source) {
            return new ESearchUserResult(source);
        }

        @Override
        public ESearchUserResult[] newArray(int size) {
            return new ESearchUserResult[size];
        }
    };
    ...
    public ESearchUserResult(Parcel in) {
        super(in);
        this.object = in.readParcelable(User.class.getClassLoader());
    }
}
