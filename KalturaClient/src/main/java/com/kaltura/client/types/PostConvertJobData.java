...
public class PostConvertJobData extends ConvartableJobData {
    ...
    public static final Creator<PostConvertJobData> CREATOR = new Creator<PostConvertJobData>() {
        @Override
        public PostConvertJobData createFromParcel(Parcel source) {
            return new PostConvertJobData(source);
        }

        @Override
        public PostConvertJobData[] newArray(int size) {
            return new PostConvertJobData[size];
        }
    };
